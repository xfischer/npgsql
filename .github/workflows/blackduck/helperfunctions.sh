...
ExtractWindowsStaging()
{
    ...
    ExecuteCommandWithoutExit "[[ -d c/edb-dotnet/builds.edb/inst/logs ]] && rm -fr c/edb-dotnet/builds.edb/inst/logs"
    ExecuteCommandWithoutExit "[[ -d c/edb-dotnet/builds.edb/inst/regression ]] && rm -fr c/edb-dotnet/builds.edb/inst/regression"
    ExecuteCommandWithoutExit "[[ -d c/edb-dotnet/builds.edb/inst/src ]] && rm -fr c/edb-dotnet/builds.edb/inst/src"
