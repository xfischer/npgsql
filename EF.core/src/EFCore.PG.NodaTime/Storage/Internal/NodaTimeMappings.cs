...
namespace EnterpriseDB.EDBClient.EntityFrameworkCore.PostgreSQL.Storage.Internal
{
    ...
    {
        public TimestampInstantMapping() : base("timestamp", typeof(Instant), EDBDbType.Timestamp) {}
    ...
    public class TimestampLocalDateTimeMapping : NpgsqlTypeMapping
    {
        ...
        public TimestampLocalDateTimeMapping() : base("timestamp", typeof(LocalDateTime), EDBDbType.Timestamp) {}
    ...
    {
        public TimestampTzInstantMapping() : base("timestamp with time zone", typeof(Instant), EDBDbType.TimestampTz) {}
    ...
    public class TimestampTzOffsetDateTimeMapping : NpgsqlTypeMapping
    {
        ...
        public TimestampTzOffsetDateTimeMapping() : base("timestamp with time zone", typeof(OffsetDateTime), EDBDbType.TimestampTz) {}
    ...
    public class DateMapping : NpgsqlTypeMapping
    {
        ...
        public DateMapping() : base("date", typeof(LocalDate), EDBDbType.Date) {}
    ...
    public class TimeTzMapping : NpgsqlTypeMapping
    {
        ...
        public TimeTzMapping() : base("time with time zone", typeof(OffsetTime), EDBDbType.TimeTz) {}
    ...
    public class DurationIntervalMapping : NpgsqlTypeMapping
    {
        ...
        public DurationIntervalMapping() : base("interval", typeof(Duration), EDBDbType.Interval) {}
