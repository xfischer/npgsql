...
namespace EnterpriseDB.EDBClient.EntityFrameworkCore.PostgreSQL.Storage.Internal
{
    public class NpgsqlNodaTimeTypeMappingSourcePlugin : IRelationalTypeMappingSourcePlugin
    {
        ...
        readonly PeriodIntervalMapping _periodInterval = new PeriodIntervalMapping();
        readonly DurationIntervalMapping _durationInterval = new DurationIntervalMapping();

        readonly EDBRangeTypeMapping _timestampLocalDateTimeRange;
        readonly EDBRangeTypeMapping _timestampInstantRange;
        readonly EDBRangeTypeMapping _timestamptzInstantRange;
        readonly EDBRangeTypeMapping _timestamptzZonedDateTimeRange;
        readonly EDBRangeTypeMapping _timestamptzOffsetDateTimeRange;
        ...
        {
            _timestampLocalDateTimeRange = new EDBRangeTypeMapping("tsrange", typeof(EDBRange<LocalDateTime>), _timestampLocalDateTime, sqlGenerationHelper);
            _timestampInstantRange = new EDBRangeTypeMapping("tsrange", typeof(EDBRange<Instant>), _timestampInstant, sqlGenerationHelper);
            _timestamptzInstantRange = new EDBRangeTypeMapping("tstzrange", typeof(EDBRange<Instant>), _timestamptzInstant, sqlGenerationHelper);
            _timestamptzZonedDateTimeRange = new EDBRangeTypeMapping("tstzrange", typeof(EDBRange<ZonedDateTime>), _timestamptzZonedDateTime, sqlGenerationHelper);
            _timestamptzOffsetDateTimeRange = new EDBRangeTypeMapping("tstzrange", typeof(EDBRange<OffsetDateTime>), _timestamptzOffsetDateTime, sqlGenerationHelper);
            _dateRange = new EDBRangeTypeMapping("daterange", typeof(EDBRange<LocalDate>), _date, sqlGenerationHelper);
            ...
            var clrTypeMappings = new Dictionary<Type, RelationalTypeMapping>
            {
                ...
                { typeof(EDBRange<Instant>), _timestampInstantRange },
