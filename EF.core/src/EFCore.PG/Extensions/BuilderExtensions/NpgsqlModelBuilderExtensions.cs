...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class NpgsqlModelBuilderExtensions
    {
        ...
        [NotNull]
        static string GetTypePgName<TEnum>([NotNull] IEDBNameTranslator nameTranslator) where TEnum : struct, Enum
        ...
        [NotNull]
        [ItemNotNull]
        static string[] GetMemberPgNames<TEnum>([NotNull] IEDBNameTranslator nameTranslator) where TEnum : struct, Enum
            => typeof(TEnum)
