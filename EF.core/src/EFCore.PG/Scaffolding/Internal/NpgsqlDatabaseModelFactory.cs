...
namespace EnterpriseDB.EDBClient.EntityFrameworkCore.PostgreSQL.Scaffolding.Internal
{
    ...
    public class NpgsqlDatabaseModelFactory : DatabaseModelFactory
    {
        ...
        static void PopulateGlobalDatabaseInfo(EDBConnection connection, DatabaseModel databaseModel)
        {
...
WHERE
  ...
  {(schemaFilter != null ? $"AND {schemaFilter("nspname")}" : null)}";
        ...
        /// </summary>
        static HashSet<string> GetEnums(EDBConnection connection, DatabaseModel databaseModel)
        {
...
GROUP BY nspname, typname";
        ...
        /// </summary>
        static void GetExtensions(EDBConnection connection, DatabaseModel databaseModel)
        {
