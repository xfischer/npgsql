...
namespace EnterpriseDB.EDBClient.EntityFrameworkCore.PostgreSQL.Storage.Internal.Mapping
{
    ...
    {
        public NpgsqlDateTypeMapping() : base("date", typeof(DateTime), EDBDbType.Date) {}
    ...
    {
        public NpgsqlTimeTypeMapping() : base("time without time zone", typeof(TimeSpan), EDBDbType.Time) {}
