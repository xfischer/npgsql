...
namespace EnterpriseDB.EDBClient.EntityFrameworkCore.PostgreSQL.Storage.Internal.Mapping
{
    public class NpgsqlEnumTypeMapping : RelationalTypeMapping
    {
        ...
        [NotNull] readonly IEDBNameTranslator _nameTranslator;
        ...
        public NpgsqlEnumTypeMapping(
            ...
            [CanBeNull] IEDBNameTranslator nameTranslator = null)
        ...
        protected NpgsqlEnumTypeMapping(
            ...
            [NotNull] ISqlGenerationHelper sqlGenerationHelper,
            [NotNull] IEDBNameTranslator nameTranslator)
            : base(parameters)
        {
            _nameTranslator = nameTranslator;
            _sqlGenerationHelper = sqlGenerationHelper;
        ...
        [NotNull]
        static Dictionary<object, string> CreateValueMapping([NotNull] Type enumType, [NotNull] IEDBNameTranslator nameTranslator)
