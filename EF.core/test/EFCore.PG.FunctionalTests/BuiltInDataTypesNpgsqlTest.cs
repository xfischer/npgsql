...
WHERE m.""TimeSpanAsTime"" = @__timeSpan_0");
        ...
        public virtual void Can_query_using_any_mapped_data_type()
        {
            using (var context = CreateContext())
            {
                context.Set<MappedNullableDataTypes>().Add(
                    new MappedNullableDataTypes
                    {
                        ...
                        NpgsqlPointAsPoint = new EDBPoint(5.2, 3.3),
                        StringAsJsonb = @"{""a"": ""b""}",
                        StringAsJson = @"{""a"": ""b""}",
            ...
            using (var context = CreateContext())
            {
                ...
                // EDBPoint? param27 = new EDBPoint(5.2, 3.3);
                ...
                var param32 = new EDBRange<int>(4, true, 8, false);
                Assert.Same(entity, context.Set<MappedNullableDataTypes>().Single(e => e.Int == 999 && e.EDBRangeAsRange == param32));
        ...
        public virtual void Can_query_using_any_mapped_data_types_with_nulls()
        {
            ...
            using (var context = CreateContext())
            {
                ...
                EDBRange<int>? param32 = null;
                Assert.Same(entity, context.Set<MappedNullableDataTypes>().Single(e => e.Int == 911 && e.EDBRangeAsRange == param32));
...
@p42='-1'",
        ...
        static void AssertMappedDataTypes(MappedDataTypes entity, int id)
        {
            ...
            Assert.Equal(new EDBPoint(5.2, 3.3), entity.NpgsqlPointAsPoint);
...
FROM ""MappedDataTypes"" AS m");
        ...
        protected class MappedDataTypes
        {
            ...
            public EDBPoint NpgsqlPointAsPoint { get; set; }
