...
namespace EnterpriseDB.EDBClient.EntityFrameworkCore.PostgreSQL.Query
{
    public class RangeQueryNpgsqlTest : IClassFixture<RangeQueryNpgsqlTest.RangeQueryNpgsqlFixture>
    {
        ...
        public void RangeContainsRange(EDBRange<int> range)
        {
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeDoesNotContainRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
                .Where(x => !x.Range.Contains(range))
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeContainedByRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeNotContainedByRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
                .Where(x => !range.ContainedBy(x.Range))
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeEqualsRange_Operator(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeEqualsRange_Method(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeDoesNotEqualsRange_Operator(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
                .Where(x => x.Range != range)
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeDoesNotEqualsRange_Method(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
                .Where(x => !x.Range.Equals(range))
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeOverlapsRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeDoesNotOverlapRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
                .Where(x => !x.Range.Overlaps(range))
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeIsStrictlyLeftOfRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeIsNotStrictlyLeftOfRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
                .Where(x => !x.Range.IsStrictlyLeftOf(range))
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeIsStrictlyRightOfRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeIsNotStrictlyRightOfRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
                .Where(x => !x.Range.IsStrictlyRightOf(range))
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeDoesNotExtendLeftOfRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeDoesExtendLeftOfRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
                .Where(x => !x.Range.DoesNotExtendLeftOf(range))
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeDoesNotExtendRightOfRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeDoesExtendRightOfRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
                .Where(x => !x.Range.DoesNotExtendRightOf(range))
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeIsAdjacentToRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeIsNotAdjacentToRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
                .Where(x => !x.Range.IsAdjacentTo(range))
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeUnionRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeIntersectsRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            var _ = context.RangeTestEntities
        ...
        [Theory]
        [MemberData(nameof(RangeTheoryData))]
        public void RangeExceptRange(EDBRange<int> range)
        {
            using var context = CreateContext();
            try
            {
        ...
        {
            using var context = CreateContext();
            var e = context.RangeTestEntities.Single(x => x.SchemaRange == EDBRange<double>.Parse("(0,10)"));
        ...
        public static IEnumerable<object[]> RangeTheoryData =>
            ...
            {
                // (0,5)
                new object[] { new EDBRange<int>(0, false, false, 5, false, false) },
                // [0,5]
                new object[] { new EDBRange<int>(0, true, false, 5, true, false) },
                // (,)
                new object[] { new EDBRange<int>(0, false, true, 0, false, true) },
                // (,)
                new object[] { new EDBRange<int>(0, false, true, 5, false, true) },
                // (0,)
                new object[] { new EDBRange<int>(0, false, false, 0, false, true) },
                // (0,)
                new object[] { new EDBRange<int>(0, false, false, 5, false, true) },
                // (,5)
                new object[] { new EDBRange<int>(0, false, true, 5, false, false) }
            };
        ...
        public class RangeTestEntity
        {
            ...
            public EDBRange<int> Range { get; set; }
            public EDBRange<float> FloatRange { get; set; }
            public EDBRange<double> SchemaRange { get; set; }
        }
        ...
        {
            /// <summary>
            /// Represents a set of entities with <see cref="EDBRange{T}"/> properties.
            /// </summary>
            ...
            public static void Seed(RangeContext context)
            {
                context.RangeTestEntities.AddRange(
                    new RangeTestEntity
                    {
                        Id = 1,
                        // (0, 10)
                        Range = new EDBRange<int>(0, false, false, 10, false, false),
                        FloatRange = new EDBRange<float>(0, false, false, 10, false, false),
                        SchemaRange = new EDBRange<double>(0, false, false, 10, false, false)
                    },
                    new RangeTestEntity
                    {
                        Id = 2,
                        // [0, 10)
                        Range = new EDBRange<int>(0, true, false, 10, false, false)
                    },
                    new RangeTestEntity
                    {
                        Id = 3,
                        // [0, 10]
                        Range = new EDBRange<int>(0, true, false, 10, true, false)
                    },
                    new RangeTestEntity
                    {
                        Id = 4,
                        // [0, ∞)
                        Range = new EDBRange<int>(0, true, false, 0, false, true)
                    },
                    new RangeTestEntity
                    {
                        Id = 5,
                        // (-∞, 10]
                        Range = new EDBRange<int>(0, false, true, 10, true, false)
                    },
                    new RangeTestEntity
                    {
                        Id = 6,
                        // (-∞, ∞)
                        Range = new EDBRange<int>(0, false, true, 0, false, true)
                    },
                    new RangeTestEntity
                    {
                        Id = 7,
