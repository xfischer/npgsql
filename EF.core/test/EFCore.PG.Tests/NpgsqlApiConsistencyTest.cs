...
using NpgsqlDbContextOptionsBuilderExtensions = EnterpriseDB.EDBClient.EntityFrameworkCore.PostgreSQL.TestUtilities.NpgsqlDbContextOptionsBuilderExtensions;
