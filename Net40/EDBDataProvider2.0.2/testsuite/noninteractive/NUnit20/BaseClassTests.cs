...
namespace NpgsqlTests
{
    ...
    public abstract class BaseClassTests
    {
        ...
        protected EDBConnection _conn = null;
        protected EDBConnection _connV2 = null;
        
        // Transaction to rollback tests modifications.
        protected EDBTransaction _t = null;
        protected EDBTransaction _tV2 = null;
        
        protected abstract EDBConnection TheConnection{get;}
        protected abstract EDBTransaction TheTransaction{get;set;}
        ...
        {
            //EDBEventLog.Level = LogLevel.None;
            //EDBEventLog.Level = LogLevel.Debug;
            //EDBEventLog.LogName = "NpgsqlTests.LogFile";
            _conn = new EDBConnection(_connString);
            _conn.Open();
            _t = _conn.BeginTransaction();
            
            _connV2 = new EDBConnection(_connV2String);
            _connV2.Open();
