...
namespace NpgsqlTests
{
    ...
    public class DataAdapterTests : BaseClassTests
    {
        ...
        public void InsertWithDataSet()
        {
            ...
            EDBDataAdapter da = new EDBDataAdapter("select * from tableb", TheConnection);

            da.InsertCommand = new EDBCommand("insert into tableb(field_int2, field_timestamp, field_numeric) values (:a, :b, :c)", TheConnection);
            ...
            EDBDataReader dr2 = new EDBCommand("select * from tableb where field_serial > 4", TheConnection).ExecuteReader();
            dr2.Read();
        ...
        public void DataAdapterUpdateReturnValue2()
        {
            ...
            EDBCommand cmd = TheConnection.CreateCommand();
            EDBDataAdapter da = new EDBDataAdapter("select * from tabled", TheConnection);
            EDBCommandBuilder cb = new EDBCommandBuilder(da);
            DataSet ds = new DataSet();
            da.Fill(ds);
        ...
        public void FillWithEmptyResultset()
        {
            ...
            EDBDataAdapter da = new EDBDataAdapter("select * from tableb where field_serial = -1", TheConnection);
        ...
        public void FillAddWithKey()
        {
            ...
            EDBDataAdapter da = new EDBDataAdapter("select field_serial, field_int2, field_timestamp, field_numeric from tableb", TheConnection);
        ...
        {
            EDBCommand command = new EDBCommand("insert into tableb(field_int2) values (2)", TheConnection);
            command.ExecuteNonQuery();
            

            DataSet ds = new DataSet();

            EDBDataAdapter da = new EDBDataAdapter("select * from tableb where field_serial = (select max(field_serial) from tableb)", TheConnection);
            da.InsertCommand = new EDBCommand(";", TheConnection);
      			da.UpdateCommand = new EDBCommand("update tableb set field_int2 = :a, field_timestamp = :b, field_numeric = :c where field_serial = :d", TheConnection);
            ...
            EDBDataReader dr2 = new EDBCommand("select * from tableb where field_serial = (select max(field_serial) from tableb)", TheConnection).ExecuteReader();
            dr2.Read();
        ...
        public void FillWithDuplicateColumnName()
        {
            ...
            EDBDataAdapter da = new EDBDataAdapter("select field_serial, field_serial from tableb", TheConnection);
        ...
        public virtual void DoInsertWithCommandBuilderCaseSensitive()
        {
            ...
            EDBDataAdapter da = new EDBDataAdapter("select * from tablei", TheConnection);
            EDBCommandBuilder builder = new EDBCommandBuilder(da);
            ...
            EDBDataReader dr2 = new EDBCommand("select * from tablei", TheConnection).ExecuteReader();
            dr2.Read();
