...
/*        [Test]
        ...
        {
            EDBCommand command = new EDBCommand("insert into tablea(field_int4) values (7); insert into tablea(field_int4) values (8)", TheConnection);
        ...
        public void GetBoolean()
        {
            ...
            EDBCommand command = new EDBCommand("select * from tablea where field_serial = 4;", TheConnection);
        ...
        {
            EDBCommand command = new EDBCommand("select * from tablea where field_serial = 1;", TheConnection);
        ...
        public void GetCharsSequential()
        {
            ...
            EDBDataReader dr = command.ExecuteReader(CommandBehavior.SequentialAccess);
        ...
        {
            EDBCommand command = new EDBCommand("select * from tablea where field_serial = 2;", TheConnection);
        ...
        {
            EDBCommand command = new EDBCommand("select * from tableb where field_serial = 1;", TheConnection);
        ...
        {
            EDBCommand command = new EDBCommand("select * from tableb where field_serial = 3;", TheConnection);
        ...
        {
            EDBCommand command = new EDBCommand("select * from tabled where field_serial = 2;", TheConnection);
        ...
        {
            EDBCommand command = new EDBCommand("select * from tabled where field_serial = 1;", TheConnection);
        ...
        {
            EDBCommand command = new EDBCommand("select * from tablea where field_text = :value;", TheConnection);
        ...
        {
            EDBCommand command = new EDBCommand("select cast(null as integer[])", TheConnection);
            using (EDBDataReader dr = command.ExecuteReader())
            {
        ...
        {
            EDBCommand command = new EDBCommand("select * from tablea where field_serial = :test_name or field_serial = :test_name_long", TheConnection);
            command.Parameters.Add(new EDBParameter("test_name", DbType.Int32, 4, "a"));
            command.Parameters.Add(new EDBParameter("test_name_long", DbType.Int32, 4, "aa"));
        ...
        {
            EDBCommand command = new EDBCommand("select * from tablea where field_serial = :test_name or field_serial = :test_name_long", TheConnection);
            command.Parameters.Add(new EDBParameter("test_name", DbType.Int32, 4, "abc_de"));
            command.Parameters.Add(new EDBParameter("test_name_long", DbType.Int32, 4, "abc_defg"));
        ...
        {
            EDBCommand command = new EDBCommand("select * from tablea where field_serial = :a or field_serial = :aa", TheConnection);
        ...
        {
            EDBDataAdapter da = new EDBDataAdapter("select * from tablea", TheConnection);
        ...
        {
            EDBDataAdapter da = new EDBDataAdapter("select * from tablea", TheConnectionString);
        ...
        {
            EDBDataAdapter da = new EDBDataAdapter("select * from tableb", TheConnectionString);
        ...
        {
            EDBCommand command = new EDBCommand("select field_text from tablea;", TheConnection);
        ...
        {
            EDBCommand command = new EDBCommand("select max(field_serial) from tablea;", TheConnection);
        ...
        {
            EDBCommand command = new EDBCommand("select * from tablea where 1 = 2;", TheConnection);
        ...
        public void SingleRowCommandBehaviorSupport()
        {
            ...
            EDBDataReader dr = command.ExecuteReader(CommandBehavior.SingleRow);
        ...
        {
            EDBCommand command = new EDBCommand("select * from metadatatest1", TheConnection);
            
            EDBDataReader dr = command.ExecuteReader(CommandBehavior.KeyInfo);
        ...
        {
            EDBCommand command = new EDBCommand("delete from tablea where field_serial = 2000000", TheConnection);
        ...
        public void ParameterAppearMoreThanOneTime()
        {
            ...
            EDBCommand command = new EDBCommand("select * from tablea where field_serial = :parameter and field_int4 = :parameter", TheConnection);
            
            command.Parameters.Add("parameter", EDBDbType.Integer);
        ...
        public void SchemaOnlySingleRowCommandBehaviorSupport()
        {
            ...
            EDBDataReader dr = command.ExecuteReader(CommandBehavior.SchemaOnly | CommandBehavior.SingleRow);
        ...
        public void SchemaOnlyCommandBehaviorSupport()
        {
            ...
            EDBDataReader dr = command.ExecuteReader(CommandBehavior.SchemaOnly);
        ...
        {
            EDBCommand command = new EDBCommand("select field_serial from tablea", TheConnection);
        ...
        public void ExecuteReaderBeforeClosingReader()
        {
            ...
            EDBCommand cmd1 = new EDBCommand("select field_serial from tablea", TheConnection);
            using(EDBDataReader dr1 = cmd1.ExecuteReader())
            {
                EDBCommand cmd2 = new EDBCommand("select * from tablea", TheConnection);
                EDBDataReader dr2 = cmd2.ExecuteReader();
            }
        }
        [Test]
        [ExpectedException(typeof(InvalidOperationException))]
        ...
        {
            EDBCommand command = new EDBCommand("select * from tableh", TheConnection);
            EDBDataReader dr = command.ExecuteReader();
