...
namespace EnterpriseDB.EDBClient
{
    ...
    /// from PostgreSQL
    /// </summary>
    internal sealed class EDBBackEndKeyData
    {
        // Logging related values
        private static readonly String CLASSNAME = "EDBBackEndKeyData";
        ...
        public EDBBackEndKeyData(ProtocolVersion protocolVersion)
        {
        ...
        public Int32 ProcessID
        {
            get
            {
                EDBEventLog.LogPropertyGet(LogLevel.Debug, CLASSNAME, "ProcessID");
                return _processId;
            }
        }
        ...
        public Int32 SecretKey
        {
            get
            {
                EDBEventLog.LogPropertyGet(LogLevel.Debug, CLASSNAME, "SecretKey");
                return _secretKey;
            }
        }
    }
