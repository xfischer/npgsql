...
namespace EnterpriseDB.EDBClient
{
    ...
    /// </summary>
    internal sealed class EDBConnectionString : IEnumerable
    {
        // Logging related values
        private static readonly String CLASSNAME = "EDBConnectionString";
        ...
        static EDBConnectionString()
        {
            resman = new System.Resources.ResourceManager(typeof(EDBConnectionString));
        }

        private EDBConnectionString(EDBConnectionString Other)
        {
        ...
        private EDBConnectionString(ListDictionary Values)
        {
        ...
        /// </summary>
        public EDBConnectionString Clone()
        {
            return new EDBConnectionString(this);
        }
        ...
        /// <summary>
        /// This method parses a connection string and returns a new EDBConnectionString object.
        /// </summary>
        public static EDBConnectionString ParseConnectionString(String CS)
        {
            ...
            return new EDBConnectionString(new_values);
        }
    ...
    internal abstract class ConnectionStringDefaults
    {
        ...
        public static readonly Int32 Port              = 5444;
