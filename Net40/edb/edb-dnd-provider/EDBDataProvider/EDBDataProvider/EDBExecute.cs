...
namespace EnterpriseDB.EDBClient
{
    ...
    /// </summary>
    ///
    internal sealed class EDBExecute
    {
        // Logging related values
        private static readonly String CLASSNAME = "EDBExecute";
		...
		public void WriteToStreamExecuteOut(Stream outputStream, Encoding encoding)
		{
