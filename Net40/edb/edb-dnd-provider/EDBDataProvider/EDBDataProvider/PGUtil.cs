...
namespace EnterpriseDB.EDBClient
{
	...
	//public static readonly string EDB_ServerVerion  = "8.0.3";//EDB team for server version (OLD support)
    ...
    /// reading and writing of EnterpriseDB protocol messages.
    /// </summary>
    internal abstract class PGUtil
    {
        ...
        /// version number that the EnterpriseDB backend will recognize in a
        /// startup packet.
        /// </summary>
        ...
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "ReadString");
            ...
            EDBEventLog.LogMsg(resman, "Log_StringRead", LogLevel.Debug, string_read);
