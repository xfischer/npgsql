...
namespace DOTNET
{
	...
	public class FunctionTest
	{
		...
		public void Init()
		{
			...
			string strSqlemptyfunction = "CREATE OR REPLACE Function emptyfunction_test return Varchar\n"
				+" IS \n"
				+" BEGIN \n"
				+"    RETURN 'EnterpriseDB'; \n"
				+" END; \n";
			...
			string strSqlfunctionsanity = "CREATE OR REPLACE Function functionsanity(a1 OUT NUMERIC, a2 OUT NUMERIC, a3 IN NUMERIC,a4 OUT NUMERIC) return Varchar\n"
				+" IS \n"
				+" BEGIN \n"
				+"    a1:= 100; \n"
				+"    a2:= 200; \n"
			...
			string strSqlFuncOneInArg = "CREATE OR REPLACE Function FunconeInArg_test(a IN NUMERIC) return varchar\n"
				+" AS \n"
				+"b        NUMBER(2);\n"
				+" BEGIN \n"
				+"    b := a; \n"
			...
			string strSqlFuncThreeInArg = "CREATE OR REPLACE FUNCTION funcThreeInArg(a IN NUMERIC, b IN NUMERIC, c IN NUMERIC) return varchar\n"
				+" AS \n"
				+"d        NUMBER(2);\n"
				+" BEGIN \n"
				+"    d:=a; \n"
		...
		public void testFunctionWithINTAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithINT(p_in in int,p_inout inout int,p_out out int) return int  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return 12000;  END;";
		...
		public void testFunctionWithINT4AsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithInt4(p_in in int4,p_inout inout int4,p_out out int4) return int4  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return 12000;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithINT8AsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithInt8(p_in in int8,p_inout inout int8,p_out out int8) return int8  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return 1010;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithINTEGERAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithInteger(p_in in Integer,p_inout inout Integer,p_out out Integer) return Integer  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return 1010;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithSmallINTAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithSmallInt(p_in in SmallInt,p_inout inout SmallInt,p_out out SmallInt) return SmallInt  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return 1010;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithBigIntAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithBigInt(p_in in Bigint,p_inout inout Bigint,p_out out Bigint) return Bigint  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return 101000;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithNUMERICASInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithNumeric(p_in in NUMERIC,p_inout inout NUMERIC,p_out out NUMERIC) return NUMERIC  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return 1234;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithNUMBERASInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithNumber(p_in in NUMBER,p_inout inout NUMBER,p_out out NUMBER) return NUMBER  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return 1234;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithDecASInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithDec(p_in in Dec,p_inout inout Dec,p_out out Dec) return Dec  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return 1234;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithDecimalASInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithDecimal(p_in in Decimal,p_inout inout Decimal,p_out out Decimal) return Decimal  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return 1234;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithFLOATAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithFloat(p_in in FLOAT,p_inout inout FLOAT,p_out out FLOAT) return FLOAT  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return -0.999;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
			...
			try
			{
				...
				command.Parameters.Add(new EDBParameter("v_out",	EDBTypes.EDBDbType.Float,10,"v_out",ParameterDirection.InputOutput,false, 8, 8,DataRowVersion.Current,4.4009));
		...
		public void testFunctionWithDoublePrecisionAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithDoublePrecision(p_in in Double Precision,p_inout inout Double Precision,p_out out Double Precision) return Double Precision  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return -0.999;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithREALAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithReal(p_in in REAL,p_inout inout REAL,p_out out REAL) return REAL  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return 10.1111;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
			...
			try
			{
				...
				command.Parameters.Add(new EDBParameter("v_out",	EDBTypes.EDBDbType.Float,10,"v_out",ParameterDirection.Output,false, 2, 2,DataRowVersion.Current,4.4));
				command.Parameters.Add(new EDBParameter("v_ret", EDBTypes.EDBDbType.Float,10,"v_ret",ParameterDirection.ReturnValue,false,2,2,System.Data.DataRowVersion.Current,8.8)); 
				command.Prepare();
				...
				Assert.AreEqual(10.1111,float.Parse(command.Parameters[3].Value.ToString()));	
			}
			catch(EDBException e)
			{			
				throw new Exception(e.ToString());
		...
		public void testFunctionWithCHARAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithChar(p_in in CHAR(30),p_inout inout CHAR(30),p_out out CHAR(30)) return CHAR(30)   IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return p_out;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
			...
			try
			{
				...
				command.Parameters.Add(new EDBParameter("v_ret", EDBTypes.EDBDbType.Char,10,"v_ret",ParameterDirection.ReturnValue,false,2,2,System.Data.DataRowVersion.Current,"Hashim")); 
				command.Prepare();
				command.ExecuteNonQuery();
		...
		public void testFunctionWithCHARACTERAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithCharacter(p_in in CHARACTER(30),p_inout inout CHARACTER(30),p_out out CHARACTER(30)) return CHARACTER(30)   IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return p_out;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithCHARACTERVARYINGAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithCharacterVarying(p_in in CHARACTER Varying,p_inout inout CHARACTER Varying,p_out out CHARACTER Varying) return CHARACTER Varying   IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return p_out;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
			...
			try
			{
				...
				command.Parameters.Add(new EDBParameter("v_out",	EDBTypes.EDBDbType.Varchar,10,"v_out",ParameterDirection.Output,false, 2, 2,DataRowVersion.Current,"4"));
		...
		public void testFunctionWithCHARVARYINGAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithCharVarying(p_in in CHAR Varying,p_inout inout CHAR Varying,p_out out CHAR Varying) return CHAR Varying   IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return p_out;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithCLOBAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithClob(p_in in CLOB,p_inout inout CLOB,p_out out CLOB) return CLOB   IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return p_out;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithLongTextAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithLongText(p_in in LongText,p_inout inout LongText,p_out out LongText) return LongText   IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return p_out;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
			...
			try
			{
				command = new EDBCommand("FunctionWithLongText(:v_in,:v_inout,:v_out)",con);
				command.CommandType = CommandType.StoredProcedure;
		
				command.Parameters.Add(new EDBParameter("v_in",	EDBTypes.EDBDbType.Text,10,"v_in",ParameterDirection.Input,false, 2, 2,DataRowVersion.Current,"Hashim"));
				command.Parameters.Add(new EDBParameter("v_inout",	EDBTypes.EDBDbType.Text,10,"v_inout",ParameterDirection.InputOutput,false, 2, 2,DataRowVersion.Current,"EnterpriseDB"));
				command.Parameters.Add(new EDBParameter("v_out",	EDBTypes.EDBDbType.Text,10,"v_out",ParameterDirection.Output,false, 2, 2,DataRowVersion.Current,"4"));
				command.Parameters.Add(new EDBParameter("v_ret", EDBTypes.EDBDbType.Text,10,"v_ret",ParameterDirection.ReturnValue,false,2,2,System.Data.DataRowVersion.Current,"Hashim")); 
				command.Prepare();
				command.ExecuteNonQuery();
		...
		public void testFunctionWithLongAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithLong(p_in in Long,p_inout inout Long,p_out out Long) return Long   IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return p_out;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithTextAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithText(p_in in Text,p_inout inout Text,p_out out Text) return Text   IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return p_out;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithLongVarcharAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithLongVarchar(p_in in Long Varchar,p_inout inout Long Varchar,p_out out Long Varchar) return Long Varchar   IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return p_out;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithLVarcharAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithLVarchar(p_in in LVarchar,p_inout inout LVarchar,p_out out LVarchar) return LVarchar   IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return p_out;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithTinyTextAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithtinyText(p_in in TinyText,p_inout inout TinyText,p_out out TinyText) return TinyText   IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return p_out;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithMONEYASInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithMONEY(p_in in MONEY,p_inout inout MONEY,p_out out MONEY) return MONEY  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return 1234;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithSmallMoneyASInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithSmallMoney(p_in in SmallMoney,p_inout inout SmallMoney,p_out out SmallMoney) return SmallMoney  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return 1234;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithVarchar2AsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithVarchar2(p_in in Varchar2,p_inout inout Varchar2,p_out out Varchar2) return Varchar2   IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return p_out;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
			...
			try
			{
				...
				command.Parameters.Add(new EDBParameter("v_in",	EDBTypes.EDBDbType.Varchar2,10,"v_in",ParameterDirection.Input,false, 2, 2,DataRowVersion.Current,"Hashim"));
				command.Parameters.Add(new EDBParameter("v_inout",	EDBTypes.EDBDbType.Varchar2,10,"v_inout",ParameterDirection.InputOutput,false, 2, 2,DataRowVersion.Current,"EnterpriseDB"));
				command.Parameters.Add(new EDBParameter("v_out",	EDBTypes.EDBDbType.Varchar2,10,"v_out",ParameterDirection.InputOutput,false, 2, 2,DataRowVersion.Current,"4"));
				command.Parameters.Add(new EDBParameter("v_ret", EDBTypes.EDBDbType.Varchar2,10,"v_ret",ParameterDirection.ReturnValue,false,2,2,System.Data.DataRowVersion.Current,"Hashim")); 
				command.Prepare();
				command.ExecuteNonQuery();
		...
		public void testFunctionWithBooleanAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithBoolean(p_in in Boolean,p_inout inout Boolean,p_out out Boolean) return Boolean  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return 1;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
			...
			{				
				...
				Assert.AreEqual(true,bool.Parse(command.Parameters[1].Value.ToString()));
				bool p_out = false;				
				Assert.AreEqual(p_out,command.Parameters[2].Value);				
				Assert.AreEqual(true,command.Parameters[3].Value);				
			}
			catch(EDBException e)
			{			
				throw new Exception(e.ToString());
		...
		public void testFunctionWithBitAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithBit(p_in in Bit,p_inout inout Bit,p_out out Bit) return Bit  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return true;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
			...
			try
			{
				...
				Assert.AreEqual(true,bool.Parse(command.Parameters[0].Value.ToString()));
				Assert.AreEqual("t",command.Parameters[1].Value);	
				bool p_out = false;
				Assert.AreEqual(p_out,command.Parameters[2].Value);
				Assert.AreEqual("1",command.Parameters[3].Value);
			}
			catch(EDBException e)
			{			
				throw new Exception(e.ToString());
		...
		public void testFunctionWithSMALLFLOATAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithSmallFloat(p_in in SmallFloat,p_inout inout SmallFloat,p_out out SmallFloat) return SmallFloat  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return 10.1111;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		public void testFunctionWithTinyIntAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithTinyInt(p_in in TinyInt,p_inout inout TinyInt,p_out out TinyInt) return TinyInt  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return 1010;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
...
/*		[Test]
		public void testFunctionWithDateAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithDate(p_in in Date,p_inout inout Date,p_out out Date) return Date  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return p_out;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
...
/*		[Test]
		public void testFunctionWithBinaryAsInInoutOut()
		{
			...
			string strSql ="CREATE OR REPLACE FUNCTION FunctionWithBinary(p_in in Binary,p_inout inout Binary,p_out out Binary) return Binary  IS   BEGIN  p_out:=p_inout; p_inout:=p_in; return p_out;  END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
