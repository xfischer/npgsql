...
namespace EnterpriseDB.EDBClient
{
    ...
    /// </summary>
    internal sealed class EDBBinaryRow : EDBRow
    {
        // Logging related values
        private static readonly String CLASSNAME = "EDBBinaryRow";

        public EDBBinaryRow(EDBRowDescription rowDesc)
        ...
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "ReadFromStream");
