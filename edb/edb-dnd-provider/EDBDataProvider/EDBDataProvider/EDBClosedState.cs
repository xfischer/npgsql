...
namespace EnterpriseDB.EDBClient
{
    ...
    internal sealed class EDBClosedState : EDBState
    {
        ...
        private static EDBClosedState _instance = null;
        private static readonly String CLASSNAME = "EDBClosedState";

        private EDBClosedState() : base()
        { }
        ...
        public override void Open(EDBConnector context)
        {
            ...
            {
                throw new EDBException(e.ToString(), e);
            }
        }
