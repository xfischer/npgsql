...
namespace EnterpriseDB.EDBClient
{
    ...
    /// </summary>
    public sealed class EDBDataReader : IDataReader, IEnumerable
    {
        ...
        private static readonly String CLASSNAME = "EDBDataReader";

        internal EDBDataReader( ArrayList resultsets, ArrayList responses, CommandBehavior behavior, EDBCommand command)
        {
        ...
        public Int32 Depth
        {
            get
            {
                EDBEventLog.LogPropertyGet(LogLevel.Debug, CLASSNAME, "Depth");
                return 0;
            }
        }
        ...
        public Boolean IsClosed
        {
            get
            {
                EDBEventLog.LogPropertyGet(LogLevel.Debug, CLASSNAME, "IsClosed");
                return _isClosed;
            }
        }
        ...
        public Int32 RecordsAffected
        {
            get
            {
                EDBEventLog.LogPropertyGet(LogLevel.Debug, CLASSNAME, "RecordsAffected");
        ...
        /// <summary>
        /// Indicates if EDBDatareader has rows to be read.
        /// </summary>
        ...
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "NextResult");
        ...
        public Boolean Read()
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "Read");
        ...
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "GetSchemaTable");
        ...
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "GetName");
        ...
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "GetDataTypeName");

            CheckHaveResultSet();

            EDBBackendTypeInfo  TI = GetTypeInfo(Index);
        ...
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "GetFieldType");
        ...
        /// <summary>
        /// Return the data EDBDbType of the column at index <param name="Index"></param>.
        /// </summary>
        public EDBDbType GetFieldEDBDbType(Int32 Index)
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "GetFieldType");
        ...
        public Object GetValue(Int32 Index)
        {
            ...
            return ((EDBAsciiRow)_currentResultset[_rowIndex])[Index];
        }
        ...
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "GetValues");
        ...
        public Object this [ Int32 i ]
        {
            get
            {
                EDBEventLog.LogIndexerGet(LogLevel.Debug, CLASSNAME, i);
                return GetValue(i);
            }
        }
        ...
        public Object this [ String name ]
        {
            get
            {
                EDBEventLog.LogIndexerGet(LogLevel.Debug, CLASSNAME, name);
        ...
        public Boolean GetBoolean(Int32 i)
        {
            ...
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "GetBoolean");
        ...
        {
			int j;	
            string value1 = GetValue(i).ToString();
			Byte[] result = new Byte[value1.Length];
			
//			for(j = 0 ;j<value1.Length;j++)
//			{
			//	Console.WriteLine(value1[j].ToString());
//				result[j] = (byte)value1[j];
//			Console.WriteLine(result[j].ToString());

//			}
		//	result[j] = Convert.ToByte(value1,10);
...
//
        ...
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "GetInt16");
        ...
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "GetInt32");
        ...
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "GetInt64");
        ...
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "GetFloat");
        ...
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "GetDouble");
        ...
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "GetString");
        ...
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "GetDecimal");
        ...
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "GetDateTime");
        ...
        {
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "IsDBNull");

            return (GetValue(i) == DBNull.Value);
        }

        internal EDBBackendTypeInfo GetTypeInfo(Int32 FieldIndex)
        {
        ...
        private DataTable GetResultsetSchema()
        {
            ...
            EDBEventLog.LogMethodEnter(LogLevel.Debug, CLASSNAME, "GetResultsetSchema");
...
//EDB Team: Patch of new npgsql release   
        ...
        private ArrayList GetPrimaryKeys(String tablename)
        {
            ...
            EDBConnection metadataConn = _connection.Clone();

            EDBCommand c = new EDBCommand(getPKColumns, metadataConn);
            c.Parameters.Add(new EDBParameter("tablename", EDBDbType.Text));
            c.Parameters["tablename"].Value = tablename;


            EDBDataReader dr = c.ExecuteReader();
