...
namespace EnterpriseDB.EDBClient
{
    ...
    /// </summary>
    ///
    internal sealed class EDBDescribe
    {
        // Logging related values
        private static readonly String CLASSNAME = "EDBDescribe";
		...
		public void WriteToStreamDescribeOut(Stream outputStream, Encoding encoding)
		{
			outputStream.WriteByte((Byte)'u');
