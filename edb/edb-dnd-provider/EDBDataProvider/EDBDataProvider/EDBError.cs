...
{
    /// <summary>
    /// EventArgs class to send Notice parameters, which are just EDBError's in a lighter context.
    /// </summary>
    public class EDBNoticeEventArgs : EventArgs
    {
        /// <summary>
        /// Notice information.
        /// </summary>
        public EDBError Notice = null;

        internal EDBNoticeEventArgs(EDBError eNotice)
        {
            Notice = eNotice;
        }
    }
    ...
    /// </summary>
    public sealed class EDBError
    {
        // Logging related values
        private static readonly String CLASSNAME = "EDBError";
        ...
        internal EDBError(ProtocolVersion protocolVersion)
        {
            protocol_version = protocolVersion;
        }
        
        internal EDBError(ProtocolVersion protocolVersion, String errorMessage)
        {
            protocol_version = protocolVersion;
