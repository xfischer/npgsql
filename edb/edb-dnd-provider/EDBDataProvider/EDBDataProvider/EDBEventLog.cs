...
namespace EnterpriseDB.EDBClient
{
    ...
    /// <summary>
    /// The level of verbosity of the EDBEventLog
    /// </summary>
    ...
    /// <summary>
    /// This class handles all the EDB event and debug logging
    /// </summary>
    public class EDBEventLog
    {
        // Logging related values
        private static readonly String CLASSNAME = "EDBEventLog";
        ...
        /// </summary>
        /// <value>The current <see cref="EDB.LogLevel">LogLevel</see></value>
        ...
        /// <summary>
        /// Writes a string to the EDB event log if msglevel is bigger then <see cref="EDB.EDBEventLog.Level">EDBEventLog.Level</see>
        /// </summary>
        /// <remarks>
        /// This method is obsolete and should no longer be used.
        /// It is likely to be removed in future versions of EDB
        /// </remarks>
        /// <param name="message">The message to write to the event log</param>
        /// <param name="msglevel">The minimum <see cref="EDB.LogLevel">LogLevel</see> for which this message should be logged.</param>
		...
		/// <summary>
		/// Public to used for configurator.Writes the default log-message for the action of calling a Method without Arguments to the logfile.
		/// </summary>
		/// <param name="msglevel">The minimum <see cref="EDB.LogLevel">LogLevel</see> for which this message should be logged.</param>
		/// <param name="ClassName">The name of the class that contains the Method</param>
		/// <param name="MethodName">The name of the Method</param>
		public static void LogMethodEnter(LogLevel msglevel, string ClassName)
		{
			if (msglevel > level)
				return;
			string message = String.Format(LogResMan.GetString("Method_0P_Enter"), ClassName,"Loading configuration");
			LogMsg(message, msglevel);
		}
