...
namespace EnterpriseDB.EDBClient
{
    ...
    /// </summary>
    [Serializable]
    public sealed class EDBException : ApplicationException
    {
        private IList errors;

        // Logging related values
        private static readonly String CLASSNAME = "EDBException";
        private static ResourceManager resman = new ResourceManager(typeof(EDBException));

        // To allow deserialization.
        private EDBException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        ...
        /// </summary>
        internal EDBException(IList errors) : base(((EDBError)errors[0]).ToString())
        {
            EDBEventLog.LogMsg(resman, "Log_ExceptionOccured", LogLevel.Normal, Message);
            this.errors = errors;

        }
        //NEW Fixes
		internal EDBException(String message) : base (message)
        {}
        
        internal EDBException(String message, Exception innerException) : base (message, innerException)
        {}
        ...
        /// </summary>
        public EDBError this[Int32 Index]
        {
            get
            {
                return (EDBError)errors[Index];
            }
        }
        ...
        public override String ToString()
        {
            ...
            foreach (EDBError PgError in Errors)
            {
