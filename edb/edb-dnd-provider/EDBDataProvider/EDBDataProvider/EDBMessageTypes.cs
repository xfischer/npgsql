...
{
    /// <summary>
    /// Class EDBMessageTypes_Ver_2.
    /// Defines PG frontend/backend protocol message types and parameters used in protocol version 2.
    /// </summary>
    internal sealed class EDBMessageTypes_Ver_2
    {
        private EDBMessageTypes_Ver_2()
        {}
		...
		public const Char OutDescription = 'u'; //Describe Out from server
		public const Char ParamData = 'v';		//Parameter Out data
    ...
    /// <summary>
    /// Class EDBMessageTypes_Ver_3.
    /// Defines PG frontend/backend protocol message types and parameters used in protocol version 3.
    /// </summary>
    internal sealed class EDBMessageTypes_Ver_3
    {
        private EDBMessageTypes_Ver_3()
        {}
