...
//		}
		...
		public static int ParamToOid(String param_name)
		{
			...
			switch(param_name.ToLower())
			{
				...
				case "datetime": 
					return 1082; //	19 OCT 05.New Support of datetime:  F #1185				
				...
				/*   
				 * If OID does not exist/match then return -1 which indicates anerror condition 
				 */ 

				default:
//					TODO:
//					throw new InvalidCastException(String.Format(resman.GetString("Exception_ImpossibleToCast"), value));
//					throw new EDBException("throw new InvalidCastException");
				return -1;	
			}
		}

		public static int ParamDirectionToValue(String param_name)
		{
			switch(param_name)
			{
				case "Input":
