...
namespace EnterpriseDB.EDBClient
{
    ...
    /// <summary>
    /// Represents a collection of parameters relevant to a <see cref="EDB.EDBCommand">EDBCommand</see>
    /// as well as their respective mappings to columns in a <see cref="System.Data.DataSet">DataSet</see>.
    /// This class cannot be inherited.
    /// </summary>
    #if WITHDESIGN
    [ListBindable(false)]
    //	[Editor(typeof(EDBParametersEditor), typeof(System.ComponentModel.Design.CollectionEditor))]
    [Editor(typeof(EDBParametersEditor), typeof(System.Drawing.Design.UITypeEditor))]
    #endif
    public sealed class EDBParameterCollection : MarshalByRefObject, IDataParameterCollection
    {
        ...
        private static readonly String CLASSNAME = "EDBParameterCollection";
...
#region EDBParameterCollection Member
        ...
        /// <summary>
        /// Gets the <see cref="EDB.EDBParameter">EDBParameter</see> with the specified name.
        /// </summary>
        /// <param name="parameterName">The name of the <see cref="EDB.EDBParameter">EDBParameter</see> to retrieve.</param>
        /// <value>The <see cref="EDB.EDBParameter">EDBParameter</see> with the specified name, or a null reference if the parameter is not found.</value>
        #if WITHDESIGN
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        #endif
        public EDBParameter this[string parameterName] {
            get
            {
                EDBEventLog.LogIndexerGet(LogLevel.Debug, CLASSNAME, parameterName);
                return (EDBParameter)this.InternalList[IndexOf(parameterName)];
            }
            set
            {
        ...
        /// <summary>
        /// Gets the <see cref="EDB.EDBParameter">EDBParameter</see> at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index of the <see cref="EDB.EDBParameter">EDBParameter</see> to retrieve.</param>
        /// <value>The <see cref="EDB.EDBParameter">EDBParameter</see> at the specified index.</value>
        #if WITHDESIGN
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        #endif
        public EDBParameter this[int index] {
            get
            {
                EDBEventLog.LogIndexerGet(LogLevel.Debug, CLASSNAME, index);
                return (EDBParameter)this.InternalList[index];
            }
            set
            {
        ...
        /// <summary>
        /// Adds the specified <see cref="EDB.EDBParameter">EDBParameter</see> object to the <see cref="EDB.EDBParameterCollection">EDBParameterCollection</see>.
        /// </summary>
        /// <param name="value">The <see cref="EDB.EDBParameter">EDBParameter</see> to add to the collection.</param>
        /// <returns>The index of the new <see cref="EDB.EDBParameter">EDBParameter</see> object.</returns>
		...
		public EDBParameter GetParameter(int index)
		{
			return (EDBParameter)(this.InternalList.ToArray())[index];
		}
		public EDBParameter GetReturnParam()
		{
			return return_param;
		}
        ...
        /// <summary>
        /// Adds a <see cref="EDB.EDBParameter">EDBParameter</see> to the <see cref="EDB.EDBParameterCollection">EDBParameterCollection</see> given the specified parameter name and value.
        /// </summary>
        /// <param name="parameterName">The name of the <see cref="EDB.EDBParameter">EDBParameter</see>.</param>
        /// <param name="value">The Value of the <see cref="EDB.EDBParameter">EDBParameter</see> to add to the collection.</param>
        /// <returns>The index of the new <see cref="EDB.EDBParameter">EDBParameter</see> object.</returns>
        /// <remarks>
        ...
        /// <summary>
        /// Adds a <see cref="EDB.EDBParameter">EDBParameter</see> to the <see cref="EDB.EDBParameterCollection">EDBParameterCollection</see> given the parameter name and the data type.
        /// </summary>
        ...
        /// <summary>
        /// Adds a <see cref="EDB.EDBParameter">EDBParameter</see> to the <see cref="EDB.EDBParameterCollection">EDBParameterCollection</see> with the parameter name, the data type, and the column length.
        /// </summary>
        /// <param name="parameterName">The name of the parameter.</param>
        /// <param name="parameterType">One of the DbType values.</param>
        ...
        /// <summary>
        /// Adds a <see cref="EDB.EDBParameter">EDBParameter</see> to the <see cref="EDB.EDBParameterCollection">EDBParameterCollection</see> with the parameter name, the data type, the column length, and the source column name.
        /// </summary>
        /// <param name="parameterName">The name of the parameter.</param>
        /// <param name="parameterType">One of the DbType values.</param>
        /// <param name="size">The length of the column.</param>
...
#region IDataParameterCollection Member
        ...
        /// <summary>
        /// Removes the specified <see cref="EDB.EDBParameter">EDBParameter</see> from the collection using the parameter name.
        /// </summary>
        /// <param name="parameterName">The name of the <see cref="EDB.EDBParameter">EDBParameter</see> object to retrieve.</param>
        ...
        /// <summary>
        /// Gets a value indicating whether a <see cref="EDB.EDBParameter">EDBParameter</see> with the specified parameter name exists in the collection.
        /// </summary>
        /// <param name="parameterName">The name of the <see cref="EDB.EDBParameter">EDBParameter</see> object to find.</param>
        ...
        /// <summary>
        /// Gets the location of the <see cref="EDB.EDBParameter">EDBParameter</see> in the collection with a specific parameter name.
        /// </summary>
        /// <param name="parameterName">The name of the <see cref="EDB.EDBParameter">EDBParameter</see> object to find.</param>
        /// <returns>The zero-based location of the <see cref="EDB.EDBParameter">EDBParameter</see> in the collection.</returns>
...
#region IList Member
        ...
        /// <summary>
        /// Removes the specified <see cref="EDB.EDBParameter">EDBParameter</see> from the collection using a specific index.
        /// </summary>
        ...
        /// <summary>
        /// Inserts a <see cref="EDB.EDBParameter">EDBParameter</see> into the collection at the specified index.
        /// </summary>
        ...
        /// <summary>
        /// Removes the specified <see cref="EDB.EDBParameter">EDBParameter</see> from the collection.
        /// </summary>
        /// <param name="value">The <see cref="EDB.EDBParameter">EDBParameter</see> to remove from the collection.</param>
        ...
        /// <summary>
        /// Gets a value indicating whether a <see cref="EDB.EDBParameter">EDBParameter</see> exists in the collection.
        /// </summary>
        /// <param name="value">The value of the <see cref="EDB.EDBParameter">EDBParameter</see> object to find.</param>
        /// <returns>true if the collection contains the <see cref="EDB.EDBParameter">EDBParameter</see> object; otherwise, false.</returns>
        ...
        /// <summary>
        /// Gets the location of a <see cref="EDB.EDBParameter">EDBParameter</see> in the collection.
        /// </summary>
        /// <param name="value">The value of the <see cref="EDB.EDBParameter">EDBParameter</see> object to find.</param>
        /// <returns>The zero-based index of the <see cref="EDB.EDBParameter">EDBParameter</see> object in the collection.</returns>
        ...
        /// </summary>
        /// <param name="value">The <see cref="EDB.EDBParameter">EDBParameter</see> to add to the collection.</param>
        /// <returns>The zero-based index of the new <see cref="EDB.EDBParameter">EDBParameter</see> object.</returns>
...
#region ICollection Member
        ...
        /// <summary>
        /// Gets the number of <see cref="EDB.EDBParameter">EDBParameter</see> objects in the collection.
        /// </summary>
        /// <value>The number of <see cref="EDB.EDBParameter">EDBParameter</see> objects in the collection.</value>
        #if WITHDESIGN
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        #endif
        public int Count {
        ...
        /// <summary>
        /// Copies <see cref="EDB.EDBParameter">EDBParameter</see> objects from the <see cref="EDB.EDBParameterCollection">EDBParameterCollection</see> to the specified array.
        /// </summary>
        /// <param name="array">An <see cref="System.Array">Array</see> to which to copy the <see cref="EDB.EDBParameter">EDBParameter</see> objects in the collection.</param>
...
#region IEnumerable Member
        ...
        /// that the argument has the type <see cref="EDB.EDBParameter">EDBParameter</see>
        /// </summary>
        ...
        private void CheckType(object Object)
        {
            ...
            if(Object.GetType() != typeof(EDBParameter))
