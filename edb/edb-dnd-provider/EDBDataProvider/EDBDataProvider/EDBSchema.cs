...
namespace EnterpriseDB.EDBClient
{
	...
	{	
        ...
        internal DataTable GetTables(string[] restrictions)
        {
            ...
            using (EDBCommand command = BuildCommand(getTables, restrictions, "table_catalog", "table_schema", "table_name", "table_type"))
            using (EDBDataAdapter adapter = new EDBDataAdapter(command))
            {
                adapter.Fill(tables);
            }
        ...
        internal DataTable GetColumns(string[] restrictions)
        {
            ...
            using (EDBCommand command = BuildCommand(getColumns, restrictions, "table_catalog", "table_schema", "table_name", "column_name"))
            using (EDBDataAdapter adapter = new EDBDataAdapter(command))
            {
