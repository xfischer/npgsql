...
namespace EDBTypes
{
    ...
    internal abstract class BasicBackendToNativeTypeConverter
    {
        ...
        /// </summary>
        internal static Object ToBoolean(EDBBackendTypeInfo TypeInfo, String BackendData, Int16 TypeSize, Int32 TypeModifier)
        {
        ...
        /// </summary>
        internal static Object ToDateTime(EDBBackendTypeInfo TypeInfo, String BackendData, Int16 TypeSize, Int32 TypeModifier)
        {
    ...
    internal abstract class BasicNativeToBackendTypeConverter
    {
        ...
        /// String data.
        /// </summary>
		internal static String ToString(EDBNativeTypeInfo TypeInfo, Object NativeData)
		{
			...
			strArray.Append("}");
			return strArray.ToString().Replace("'", "''").Replace("\\", "\\\\");
		}
		//SA:Added for Array Support, Start
		internal static String ToText(EDBNativeTypeInfo TypeInfo, Object NativeData)
		{
			Byte[]     byteArray = (Byte[])NativeData;
			int        len = byteArray.Length;
			char[]     res = new char[len * 5];
    ...
    internal abstract class ExtendedBackendToNativeTypeConverter
    {
        ...
        internal static Object ToPath(EDBBackendTypeInfo TypeInfo, String BackendData, Int16 TypeSize, Int32 TypeModifier)
        {
        	...
        	EDBPath result = new EDBPath((EDBPoint[]) points.ToArray(typeof(EDBPoint)));
			result.IsOpen = open; 
        	return result;
        ...
        /// Polygon.
        /// </summary>
        internal static Object ToPolygon(EDBBackendTypeInfo TypeInfo, String BackendData, Int16 TypeSize, Int32 TypeModifier)
        {
        	...
        	return new EDBPolygon((EDBPoint[]) points.ToArray(typeof(EDBPoint)));
    ...
    internal abstract class ExtendedNativeToBackendTypeConverter
    {
        ...
        internal static String ToPath(EDBNativeTypeInfo TypeInfo, Object NativeData)
        {
            ...
            foreach (EDBPoint P in ((EDBPath)NativeData).Points) {
        ...
        internal static String ToPolygon(EDBNativeTypeInfo TypeInfo, Object NativeData)
        {
            ...
            foreach (EDBPoint P in ((EDBPolygon)NativeData).Points) {
                B.AppendFormat(CultureInfo.InvariantCulture, "{0}({1},{2})", (B.Length > 0 ? "," : ""), P.X, P.Y);
            }
