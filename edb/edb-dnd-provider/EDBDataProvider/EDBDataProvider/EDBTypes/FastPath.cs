        ...
        private Object FastpathV3(Int32 fnid, Boolean resulttype, FastpathArg[] args)
        {
            ...
            lock (stream)
            {
                ...
                while (!l_endQuery)
                {
                    ...
                    case 'E':
                        EDBError e = new EDBError(conn.BackendProtocolVersion);
                    ...
                    case 'N':
                        ...
                        EDBError e1 = new EDBError(conn.BackendProtocolVersion);
            ...
            lock (stream)
            {
                ...
                while (!l_endQuery)
                {
                    ...
                    case 'E':
                        ...
                        // Notice from backend
                    case 'N':
                        EDBError notice = new EDBError(conn.BackendProtocolVersion);
