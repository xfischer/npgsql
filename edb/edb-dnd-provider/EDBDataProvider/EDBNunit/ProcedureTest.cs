...
namespace DOTNET
{
	...
	public class ProcedureTest
	{
		...
		public void testEmptyArg()
		{
			try 
			{
				EDBCommand command = new EDBCommand("emptyArg_test",con);
		...
		public void testOneInArg()
		{
			try 
			{
				EDBCommand command = new EDBCommand("oneInArg_test(:a)",con);
				command.CommandType = CommandType.StoredProcedure;
		...
		public void testThreeInArg()
		{
			try 
			{
				EDBCommand command = new EDBCommand("threeInArg_test(:a,:b,:c)",con);
				command.CommandType = CommandType.StoredProcedure;
		...
		public void testOneOutArg()
		{
			try 
			{
				EDBCommand command = new EDBCommand("oneOutArg_test(:a)",con);
				command.CommandType = CommandType.StoredProcedure;
		...
		public void testThreeOutArg()
		{
			try 
			{
				EDBCommand command = new EDBCommand("threeOutArg_test(:a,:b,:c)",con);
				command.CommandType = CommandType.StoredProcedure;
		...
		[Test]
		public void testSingleInOutArg()
		{
			try 
			{
				EDBCommand command = new EDBCommand("singleInOutArg_test(:a,:b)",con);
				command.CommandType = CommandType.StoredProcedure;
		...
		[Test]
		public void testMixInOutArg()
		{
			try 
			{
				EDBCommand command = new EDBCommand("mixArg_test(:a,:b,:c)",con);
				command.CommandType = CommandType.StoredProcedure;
		...
		[Test]
		public void testMultipleInOutArg()
		{
			try 
			{
				EDBCommand command = new EDBCommand("multipleInOutArg_test(:a,:b,:c,:d)",con);
				command.CommandType = CommandType.StoredProcedure;
		...
		public void TestOneProcCallingOtherProc()
		{
			...
			string strSql = "create or replace procedure check_proc(a inout int) as  BEGIN check_proc1(a);     END; ";
		...
		[Test]
		public void TestTwoProcCallingEachOtherRecursively()
		{
			//////prereq Sarim
			EDBCommand command = new EDBCommand("",con);
			command.CommandType = CommandType.Text;
		...
		/// </summary>
		[Test]
		public void TestProcCallingItself()
		{
			//////prereq
			EDBCommand command = new EDBCommand("",con);
			command.CommandType = CommandType.Text;
		...
		/// </summary>
		[Test]
		public void testProcedureWithINTAsInInoutOut()
		{
			//////prereq
			EDBCommand command = new EDBCommand("",con);
			command.CommandType = CommandType.Text;
			...
			string strSql ="CREATE OR REPLACE PROCEDURE ProcedureWithINT(p_in in int,p_inout inout int,p_out out int)   IS   BEGIN  p_out:=p_inout; p_inout:=p_in;   END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		/// </summary>
		[Test]
		public void testProcedureWithINT4AsInInoutOut()
		{
			//////prereq
			EDBCommand command = new EDBCommand("",con);
			command.CommandType = CommandType.Text;
			...
			string strSql ="CREATE OR REPLACE PROCEDURE ProcedureWithInt4(p_in in int4,p_inout inout int4,p_out out int4)   IS   BEGIN  p_out:=p_inout; p_inout:=p_in;   END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		/// </summary>
		[Test]
		public void testProcedureWithINT8AsInInoutOut()
		{
			//////prereq
			EDBCommand command = new EDBCommand("",con);
			command.CommandType = CommandType.Text;

			string strSql ="CREATE OR REPLACE PROCEDURE ProcedureWithInt8(p_in in int8,p_inout inout int8,p_out out int8)   IS   BEGIN  p_out:=p_inout; p_inout:=p_in;   END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		/// </summary>
		[Test]
		public void testProcedureWithNUMERICASInInoutOut()
		{
			//////prereq
			EDBCommand command = new EDBCommand("",con);
			command.CommandType = CommandType.Text;
			...
			string strSql ="CREATE OR REPLACE PROCEDURE ProcedureWithNumeric(p_in in NUMERIC,p_inout inout NUMERIC,p_out out NUMERIC)   IS   BEGIN  p_out:=p_inout; p_inout:=p_in;   END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		/// </summary>
		[Test]
		public void testProcedureWithFLOATAsInInoutOut()
		{
			//////prereq
			EDBCommand command = new EDBCommand("",con);
			command.CommandType = CommandType.Text;
			...
			try
			{
				...
				command.Parameters.Add(new EDBParameter("v_in",	EDBTypes.EDBDbType.Float,10,"v_in",ParameterDirection.Input,false, 8, 8,DataRowVersion.Current,1.100001));
				...
				Assert.AreEqual(1.100001,float.Parse(command.Parameters[0].Value.ToString()));
		...
		/// </summary>
		[Test]
		public void testProcedureWithREALAsInInoutOut()
		{
			//////prereq
			EDBCommand command = new EDBCommand("",con);
			command.CommandType = CommandType.Text;
			...
			string strSql ="CREATE OR REPLACE procedure procedureWithReal(p_in in REAL,p_inout inout REAL,p_out out REAL)   IS   BEGIN  p_out:=p_inout; p_inout:=p_in;   END;";
			command.CommandText = strSql;
			command.ExecuteNonQuery();
		...
		/// </summary>
		[Test]
		public void testProcedureWithCHARAsInInoutOut()
		{
			//////prereq
			EDBCommand command = new EDBCommand("",con);
			command.CommandType = CommandType.Text;
...
*/
		...
		{
//			EDBCommand command = new EDBCommand("DEPT_SELECT(:pDEPTNO,:pDNAME,:pLOC)", con);
//			command.CommandType = CommandType.StoredProcedure;
//
...
//			Assert.AreEqual("new york", command.Parameters["pLOC"].Value.ToString().ToLower() );          
        ...
        [Test]
        public void TERSE_PROC_DEFAULT_TYPES()
        {
            try
            {
