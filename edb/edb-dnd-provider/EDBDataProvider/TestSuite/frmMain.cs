...
using EnterpriseDB.EDBClient;
  ...
  public class frmMain : System.Windows.Forms.Form
  {
    ...
    private void cmdConnect_Click(object sender, System.EventArgs e) 
    {
		  ...
		  log("Connecting to EnterpriseDB...");
		  
		  // Setup the logging
//		  EDBEventLog.Level = LogLevel.Normal;
//		  EDBEventLog.LogName = "testsuite.log";
//		  EDBEventLog.EchoMessages = true;
      ...
      string szConnect = "DATABASE=" + txtDatabase.Text + ";SERVER=" + txtHostname.Text + ";PORT=" + int.Parse(txtPort.Text) + ";UID=" + txtUsername.Text + ";PWD=" + txtPassword.Text + ";SSL=TRUE";
      ...
      cnDB = new EDBConnection(szConnect);
      ...
      // Get the EDBSQL version number as proof
      try
      {
        EDBCommand cmdVer = new EDBCommand("SELECT version()", cnDB);
    ...
    {
      log("Disconnecting from EnterpriseDB...");    
      if (cnDB != null)
      {
        if (cnDB.State != ConnectionState.Closed)
        {
    ...
    private void cmdNonQuery_Click(object sender, System.EventArgs e) 
    {
      ...
      try
      {
        EDBCommand cmdNQ = new EDBCommand(txtNonQuery.Text, cnDB);
    ...
    private void cmdScalar_Click(object sender, System.EventArgs e) 
    {
      ...
      try
      {
        EDBCommand cmdNQ = new EDBCommand(txtScalar.Text, cnDB);
    ...
    private void cmdReader_Click(object sender, System.EventArgs e) 
    {
      ...
      // Attempt to execute the query
      EDBDataReader objRdr = null;
      try
      {
        EDBCommand cmdNQ = new EDBCommand(txtReader.Text, cnDB);
    ...
    private void InitializeComponent()
    {
		...
		// tabset
		// 
		this.tabset.Controls.Add(this.Connection);
		this.tabset.Controls.Add(this.ExecuteNonQuery);
		this.tabset.Controls.Add(this.ExecuteScalar);
		this.tabset.Controls.Add(this.ExecuteReader);
		...
		this.Connection.Controls.Add(this.cbVersion);
		this.Connection.Controls.Add(this.txtDatabase);
		...
		this.Connection.Controls.Add(this.txtPassword);
		this.Connection.Controls.Add(this.txtUsername);
		this.Connection.Controls.Add(this.txtPort);
		this.Connection.Controls.Add(this.txtHostname);
		this.Connection.Controls.Add(this.lblPassword);
		this.Connection.Controls.Add(this.lblUsername);
		this.Connection.Controls.Add(this.lblPort);
		this.Connection.Controls.Add(this.lblHostname);
		...
		this.txtUsername.Text = "enterprisedb";
		// 
		// txtPort
		// 
		...
		this.lblPort.Size = new System.Drawing.Size(25, 16);
		...
		this.lblHostname.Size = new System.Drawing.Size(56, 16);
		this.lblHostname.TabIndex = 19;
		this.lblHostname.Text = "Hostname";
		// 
		// ExecuteNonQuery
		// 
		this.ExecuteNonQuery.Controls.Add(this.cmdNonQuery);
		this.ExecuteNonQuery.Controls.Add(this.txtNonQuery);
		this.ExecuteNonQuery.Controls.Add(this.lblNonQuery);
		...
		this.lblNonQuery.Size = new System.Drawing.Size(60, 16);
		this.lblNonQuery.TabIndex = 24;
		this.lblNonQuery.Text = "Non-Query";
		// 
		// ExecuteScalar
		// 
		this.ExecuteScalar.Controls.Add(this.cmdScalar);
		this.ExecuteScalar.Controls.Add(this.txtScalar);
		this.ExecuteScalar.Controls.Add(this.lblScalar);
		...
		this.txtScalar.Text = "SELECT count(*) AS emp_count  FROM emp";
		// 
		// lblScalar
		// 
		...
		this.lblScalar.Size = new System.Drawing.Size(36, 16);
		this.lblScalar.TabIndex = 29;
		this.lblScalar.Text = "Scalar";
		// 
		// ExecuteReader
		// 
		this.ExecuteReader.Controls.Add(this.cmdReader);
		this.ExecuteReader.Controls.Add(this.txtReader);
		this.ExecuteReader.Controls.Add(this.lblReader);
		...
		this.lblReader.Size = new System.Drawing.Size(41, 16);
