...
project = 'EDB Postgres™ Advanced Server .NET Data Provider Guide'
...
latex_documents = [
    (master_doc, 'NET.tex', '.Net Data Provider',
     'EDB Postgres™ Advanced Server .NET Data Provider Guide', 'manual'),
]
