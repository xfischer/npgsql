.. _advanced_server_net_connector_logging:

***********************************
`EDB .NET Connector Logging`:index:
***********************************
...
``EnterpriseDB.EDBClient.Logging.ConsoleLoggingProvider`` is a class that outputs error messages to ``STDERR``.
To use this class, include the following line in your application before using any of the Advanced Server .NET Connector APIs.
