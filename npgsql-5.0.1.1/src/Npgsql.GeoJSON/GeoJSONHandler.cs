...
namespace EnterpriseDB.EDBClient.GeoJSON
{
    [Flags]
    ...
    public sealed class GeoJSONHandlerFactory : EDBTypeHandlerFactory<GeoJSONObject>
    {
    ...
    sealed class GeoJsonHandler : EDBTypeHandler<GeoJSONObject>,
        IEDBTypeHandler<Point>, IEDBTypeHandler<MultiPoint>,
        IEDBTypeHandler<Polygon>, IEDBTypeHandler<MultiPolygon>,
        IEDBTypeHandler<LineString>, IEDBTypeHandler<MultiLineString>,
        IEDBTypeHandler<GeometryCollection>,
        IEDBTypeHandler<IGeoJSONObject>,
        IEDBTypeHandler<IGeometryObject>
    {
        readonly GeoJSONOptions _options;
        ...
        static Position ReadPosition(EDBReadBuffer buf, EwkbGeometryType type, bool littleEndian)
        {
        ...
        public override Task Write(GeoJSONObject value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
            => value.Type switch
            {
        ...
        public async Task Write(Point value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
        ...
        public async Task Write(LineString value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
        ...
        public async Task Write(Polygon value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
        ...
        public async Task Write(MultiPoint value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
        ...
        public async Task Write(MultiLineString value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
        ...
        public async Task Write(MultiPolygon value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
        ...
        public async Task Write(GeometryCollection value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
        ...
        Task IEDBTypeHandler<IGeoJSONObject>.Write(IGeoJSONObject value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken)
            => Write((GeoJSONObject)value, buf, lengthCache, parameter, async, cancellationToken);

        Task IEDBTypeHandler<IGeometryObject>.Write(IGeometryObject value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken)
            => Write((GeoJSONObject)value, buf, lengthCache, parameter, async, cancellationToken);

        static async Task WritePosition(IPosition coordinate, EDBWriteBuffer buf, bool async, CancellationToken cancellationToken = default)
        {
