...
namespace EnterpriseDB.EDBClient
{
    ...
    /// </summary>
    public sealed class EDBBinaryExporter : ICancelable, IAsyncDisposable
    {
        ...
        readonly EDBTypeHandler?[] _typeHandlerCache;
        ...
        ValueTask<T> Read<T>(EDBDbType type, bool async, CancellationToken cancellationToken = default)
        {
            ...
            var handler = _typeHandlerCache[_column];
            if (handler == null)
                handler = _typeHandlerCache[_column] = _typeMapper.GetByEDBDbType(type);
