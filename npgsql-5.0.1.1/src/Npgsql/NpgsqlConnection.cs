...
namespace EnterpriseDB.EDBClient
{
    ...
    public sealed class EDBConnection : DbConnection, ICloneable
    {
        ...
        static readonly EDBConnectionStringBuilder DefaultSettings = new EDBConnectionStringBuilder();
        ...
        /// <see cref="EDBConnectionStringBuilder.Password">Password</see> and
        /// <see cref="EDBConnectionStringBuilder.Passfile">Passfile</see> connection string
            ...
            get => _fullState switch
                {
                    ConnectionState.Open => Connector == null
                        ...
                        : Connector.State switch
                        {
                            ...
                            ConnectorState.Closed      => throw new InvalidOperationException("Internal EnterpriseDB.EDBClient bug: connection is in state Open but connector is in state Closed"),
        ...
        public TextWriter BeginTextImport(string copyFromCommand)
        {
            ...
            try
            {
                var writer = new EDBCopyTextWriter(connector, new EDBRawCopyStream(connector, copyFromCommand));
        ...
        public TextReader BeginTextExport(string copyToCommand)
        {
            ...
            try
            {
                var reader = new EDBCopyTextReader(connector, new EDBRawCopyStream(connector, copyToCommand));
