...
namespace EnterpriseDB.EDBClient
{
    ...
    public sealed class EDBConnectionStringBuilder : DbConnectionStringBuilder, IDictionary<string, object?>
    {
        ...
        /// </summary>
        [Category("Timeouts")]
        [Description("After Command Timeout is reached (or user supplied cancellation token is cancelled) and command cancellation is attempted, EnterpriseDB.EDBClient waits for this additional timeout (in milliseconds) before breaking the connection. Defaults to 2000, set to zero for infinity.")]
