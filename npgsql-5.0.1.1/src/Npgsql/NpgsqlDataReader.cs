...
#pragma warning restore CA1010
    {
        ...
        EDBConnection _connection = default!;
        ...
        /// </summary>
        internal List<(int Offset, int Length)> _columns = new List<(int Offset, int Length)>();
        ...
        internal void Init(
            EDBCommand command, CommandBehavior behavior, List<EDBStatement> statements, Task? sendTask = null)
        {
            Command = command;
...
#nullable restore
        ...
        internal void UnbindIfNecessary()
        {
            ...
            if (State != ReaderState.Disposed)
                Connector.DataReader = new EDBDataReader(Connector);
        }
