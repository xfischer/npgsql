...
namespace EnterpriseDB.EDBClient
{
    ...
    public abstract class EDBDatabaseInfo
    {
        ...
        internal static readonly ConcurrentDictionary<EDBDatabaseInfoCacheKey, EDBDatabaseInfo> Cache
            = new ConcurrentDictionary<EDBDatabaseInfoCacheKey, EDBDatabaseInfo>();
        ...
        internal static async Task<EDBDatabaseInfo> Load(EDBConnection conn, EDBTimeout timeout, bool async)
        {
