...
namespace EnterpriseDB.EDBClient
{
    ...
    /// </summary>
    public sealed partial class EDBReadBuffer : IDisposable
    {
        ...
        internal EDBReadBuffer AllocateOversize(int count)
        {
            ...
            var tempBuf = new EDBReadBuffer(Connector, Underlying, _underlyingSocket, count, TextEncoding, RelaxedTextEncoding);
        ...
        public ValueTask<int> ReadAsync(Memory<byte> output, CancellationToken cancellationToken = default)
        {
            ...
            static async ValueTask<int> ReadAsyncLong(EDBReadBuffer buffer, Memory<byte> output, CancellationToken cancellationToken)
            {
        ...
        ValueTask<string> ReadNullTerminatedString(Encoding encoding, bool async, CancellationToken cancellationToken = default)
        {
            ...
            static bool ReadFromBuffer(EDBReadBuffer buffer, Encoding encoding, out string s)
            {
            ...
            static async ValueTask<string> ReadLong(EDBReadBuffer buffer, bool async, Encoding encoding, string s)
            {
