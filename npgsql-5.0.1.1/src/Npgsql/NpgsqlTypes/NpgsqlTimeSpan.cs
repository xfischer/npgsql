...
namespace EDBTypes
{
                                   ...
                                   IComparer<EDBTimeSpan>
    {
        ...
        /// <summary>
        /// Represents the maximum <see cref="EDBTimeSpan"/>. This field is read-only.
        /// </summary>
        public static readonly EDBTimeSpan MaxValue = new EDBTimeSpan(long.MaxValue);

        /// <summary>
        /// Represents the minimum <see cref="EDBTimeSpan"/>. This field is read-only.
        /// </summary>
        public static readonly EDBTimeSpan MinValue = new EDBTimeSpan(long.MinValue);

        /// <summary>
        /// Represents the zero <see cref="EDBTimeSpan"/>. This field is read-only.
        /// </summary>
        public static readonly EDBTimeSpan Zero = new EDBTimeSpan(0);
        ...
        /// <summary>
        /// Initializes a new <see cref="EDBTimeSpan"/> to the specified number of ticks.
        /// </summary>
        /// <param name="ticks">A time period expressed in 100ns units.</param>
        public EDBTimeSpan(long ticks)
            : this(new TimeSpan(ticks))
        {
        }

        /// <summary>
        /// Initializes a new <see cref="EDBTimeSpan"/> to hold the same time as a <see cref="TimeSpan"/>
        /// </summary>
        /// <param name="timespan">A time period expressed in a <see cref="TimeSpan"/></param>
        public EDBTimeSpan(TimeSpan timespan)
            : this(0, timespan.Days, timespan.Ticks - (TicksPerDay * timespan.Days))
        {
        }

        /// <summary>
        /// Initializes a new <see cref="EDBTimeSpan"/> to the specified number of months, days
        /// &amp; ticks.
        /// </summary>
        /// <param name="months">Number of months.</param>
        /// <param name="days">Number of days.</param>
        /// <param name="ticks">Number of 100ns units.</param>
        public EDBTimeSpan(int months, int days, long ticks)
        {
            _months = months;
            _days = days;
            _ticks = ticks;
        ...
        /// <summary>
        /// Initializes a new <see cref="EDBTimeSpan"/> to the specified number of
        ...
        public EDBTimeSpan(int days, int hours, int minutes, int seconds)
        ...
        public EDBTimeSpan(int days, int hours, int minutes, int seconds, int milliseconds)
        ...
        /// <param name="seconds">Number of seconds.</param>
        /// <param name="milliseconds">Number of milliseconds.</param>
        public EDBTimeSpan(int months, int days, int hours, int minutes, int seconds, int milliseconds)
        ...
        /// <param name="seconds">Number of seconds.</param>
        /// <param name="milliseconds">Number of milliseconds.</param>
        public EDBTimeSpan(int years, int months, int days, int hours, int minutes, int seconds, int milliseconds)
        ...
        /// <see cref="EDBTimeSpan"/>  type. This ignores the number of days and
        ...
        /// <see cref="EDBTimeSpan"/> will always suffice to handle the resolution of any interval value, and upon
        ...
        /// <summary>
        /// Creates an <see cref="EDBTimeSpan"/> from a number of ticks.
        /// </summary>
        ...
        public EDBTimeSpan Add(in EDBTimeSpan interval)
        ...
        public EDBTimeSpan Subtract(in EDBTimeSpan interval)
            => new EDBTimeSpan(Months - interval.Months, Days - interval.Days, Ticks - interval.Ticks);
        ...
        /// </summary>
        /// <returns>An <see cref="EDBTimeSpan"/> based on this one, but with any hours outside of the range [-23, 23]
        /// converted into days.</returns>
        public EDBTimeSpan JustifyDays()
        {
            return new EDBTimeSpan(Months, Days + (int)(Ticks / TicksPerDay), Ticks % TicksPerDay);
        }

        /// <summary>
        /// Opposite to PostgreSQL's justify_days function.
        /// </summary>
        /// <returns>An <see cref="EDBTimeSpan"/> based on this one, but with any days converted to multiples of &#xB1;24hours.</returns>
        public EDBTimeSpan UnjustifyDays()
        {
            return new EDBTimeSpan(Months, 0, Ticks + Days * TicksPerDay);
        }

        /// <summary>
        /// Equivalent to PostgreSQL's justify_months function.
        /// </summary>
        /// <returns>An <see cref="EDBTimeSpan"/> based on this one, but with any days outside of the range [-30, 30]
        /// converted into months.</returns>
        public EDBTimeSpan JustifyMonths()
        {
            return new EDBTimeSpan(Months + Days / DaysPerMonth, Days % DaysPerMonth, Ticks);
        }

        /// <summary>
        /// Opposite to PostgreSQL's justify_months function.
        /// </summary>
        /// <returns>An <see cref="EDBTimeSpan"/> based on this one, but with any months converted to multiples of &#xB1;30days.</returns>
        public EDBTimeSpan UnjustifyMonths()
        {
            return new EDBTimeSpan(0, Days + Months * DaysPerMonth, Ticks);
        }

        /// <summary>
        /// Equivalent to PostgreSQL's justify_interval function.
        /// </summary>
        /// <returns>An <see cref="EDBTimeSpan"/> based on this one,
        /// but with any months converted to multiples of &#xB1;30days
        /// and then with any days converted to multiples of &#xB1;24hours</returns>
        public EDBTimeSpan JustifyInterval()
        {
        ...
        /// </summary>
        /// <returns>An <see cref="EDBTimeSpan"/> based on this one, but with any months converted to multiples of &#xB1;30days and then any days converted to multiples of &#xB1;24hours;</returns>
        public EDBTimeSpan UnjustifyInterval()
        {
            return new EDBTimeSpan(Ticks + Days * TicksPerDay + Months * DaysPerMonth * TicksPerDay);
        }
        ...
        /// <remarks>
        /// <para>
        /// While the fact that for many purposes, two different <see cref="EDBTimeSpan"/> instances could be considered
        ...
        /// another.
        /// </para>
        /// <para>Note that the results of casting a <see cref="TimeSpan"/> to <see cref="EDBTimeSpan"/> is
        /// canonicalised.</para>
        /// </remarks>
        /// </summary>
        /// <returns>An <see cref="EDBTimeSpan"/> based on this one, but with months converted to multiples of &#xB1;30days and with any hours outside of the range [-23, 23]
        /// converted into days.</returns>
        public EDBTimeSpan Canonicalize()
        {
            return new EDBTimeSpan(0, Days + Months * DaysPerMonth + (int)(Ticks / TicksPerDay), Ticks % TicksPerDay);
        }
        ...
        /// <summary>
        /// Implicit cast of a <see cref="TimeSpan"/> to an <see cref="EDBTimeSpan"/>
        /// </summary>
        ...
        /// </summary>
        public static TimeSpan ToTimeSpan(in EDBTimeSpan interval)
        ...
        /// <summary>
        /// Returns true if another <see cref="EDBTimeSpan"/> is exactly the same as this instance.
        /// </summary>
        /// <param name="other">An <see cref="EDBTimeSpan"/> for comparison.</param>
        ...
        /// </summary>
        /// <param name="x">The first <see cref="EDBTimeSpan"/>.</param>
        ...
        /// </summary>
        /// <param name="other">An <see cref="EDBTimeSpan"/> to compare this with.</param>
        ...
        /// <returns>0 if the argument is an <see cref="EDBTimeSpan"/> and the instances are equal or equivalent.
        /// A value less than zero if the argument is an <see cref="EDBTimeSpan"/> and
        /// this instance is less than the argument.
        /// A value greater than zero if the argument is an <see cref="EDBTimeSpan"/> and this instance
        /// is greater than the instance.</returns>
        ...
        /// <exception cref="FormatException">The string was not in a format that could be parsed to produce an <see cref="EDBTimeSpan"/>.</exception>
        public static EDBTimeSpan Parse(string str)
        {
            if (str == null) {
        ...
        /// <summary>
        /// Adds two <see cref="EDBTimeSpan"/> together.
        /// </summary>
        /// <param name="x">The first <see cref="EDBTimeSpan"/> to add.</param>
        /// <param name="y">The second <see cref="EDBTimeSpan"/> to add.</param>
        /// <returns>An <see cref="EDBTimeSpan"/> whose values are the sum of the arguments.</returns>
        public static EDBTimeSpan operator +(EDBTimeSpan x, EDBTimeSpan y)
        {
            return x.Add(y);
        }

        /// <summary>
        /// Subtracts one <see cref="EDBTimeSpan"/> from another.
        /// </summary>
        /// <param name="x">The <see cref="EDBTimeSpan"/> to subtract the other from.</param>
        /// <param name="y">The <see cref="EDBTimeSpan"/> to subtract from the other.</param>
        /// <returns>An <see cref="EDBTimeSpan"/> whose values are the difference of the arguments</returns>
        public static EDBTimeSpan operator -(EDBTimeSpan x, EDBTimeSpan y)
        {
            return x.Subtract(y);
        }
        ...
        /// <summary>
        /// Returns true if two <see cref="EDBTimeSpan"/> are exactly the same.
        /// </summary>
        /// <param name="x">The first <see cref="EDBTimeSpan"/> to compare.</param>
        /// <param name="y">The second <see cref="EDBTimeSpan"/> to compare.</param>
        /// <returns>true if the two arguments are exactly the same, false otherwise.</returns>
        public static bool operator ==(EDBTimeSpan x, EDBTimeSpan y)
        {
            return x.Equals(y);
        }

        /// <summary>
        /// Returns false if two <see cref="EDBTimeSpan"/> are exactly the same.
        /// </summary>
        /// <param name="x">The first <see cref="EDBTimeSpan"/> to compare.</param>
        /// <param name="y">The second <see cref="EDBTimeSpan"/> to compare.</param>
        ...
        /// <summary>
        /// Compares two <see cref="EDBTimeSpan"/> instances to see if the first is less than the second
        /// </summary>
        /// <param name="x">The first <see cref="EDBTimeSpan"/> to compare.</param>
        /// <param name="y">The second <see cref="EDBTimeSpan"/> to compare.</param>
        /// <returns>true if the first <see cref="EDBTimeSpan"/> is less than second, false otherwise.</returns>
        public static bool operator <(EDBTimeSpan x, EDBTimeSpan y)
        {
        ...
        /// <summary>
        /// Compares two <see cref="EDBTimeSpan"/> instances to see if the first is less than or equivalent to the second
        /// </summary>
        /// <param name="x">The first <see cref="EDBTimeSpan"/> to compare.</param>
        /// <param name="y">The second <see cref="EDBTimeSpan"/> to compare.</param>
        /// <returns>true if the first <see cref="EDBTimeSpan"/> is less than or equivalent to second, false otherwise.</returns>
        public static bool operator <=(EDBTimeSpan x, EDBTimeSpan y)
        {
            return x.UnjustifyInterval().Ticks <= y.UnjustifyInterval().Ticks;
        }
        ...
        /// <summary>
        /// Compares two <see cref="EDBTimeSpan"/> instances to see if the first is greater than the second
        /// </summary>
        /// <param name="x">The first <see cref="EDBTimeSpan"/> to compare.</param>
        /// <param name="y">The second <see cref="EDBTimeSpan"/> to compare.</param>
        /// <returns>true if the first <see cref="EDBTimeSpan"/> is greater than second, false otherwise.</returns>
        public static bool operator >(EDBTimeSpan x, EDBTimeSpan y)
        {
            return !(x <= y);
        }
        ...
        /// <summary>
        /// Compares two <see cref="EDBTimeSpan"/> instances to see if the first is greater than or equivalent the second
        /// </summary>
        /// <param name="x">The first <see cref="EDBTimeSpan"/> to compare.</param>
        /// <param name="y">The second <see cref="EDBTimeSpan"/> to compare.</param>
        /// <returns>true if the first <see cref="EDBTimeSpan"/> is greater than or equivalent to the second, false otherwise.</returns>
        public static bool operator >=(EDBTimeSpan x, EDBTimeSpan y)
        {
            return !(x < y);
        }
        ...
        /// Returns the instance.
        /// </summary>
        public static EDBTimeSpan Plus(in EDBTimeSpan x) => x;
