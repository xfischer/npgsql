...
namespace EnterpriseDB.EDBClient
{
    ...
    /// </summary>
    public sealed partial class EDBWriteBuffer : IDisposable
    {
        ...
        internal EDBWriteBuffer(EDBConnector connector, Stream stream, Socket? socket, int size, Encoding textEncoding)
        {
            if (size < MinimumSize)
        ...
        public Task WriteString(string s, int charLen, int byteLen, bool async, CancellationToken cancellationToken = default)
        {
            ...
            static async Task WriteStringLong(EDBWriteBuffer buffer, bool async, string s, int charLen, int byteLen, CancellationToken cancellationToken)
            {
        ...
        internal Task WriteChars(char[] chars, int offset, int charLen, int byteLen, bool async, CancellationToken cancellationToken = default)
        {
            ...
            static async Task WriteCharsLong(EDBWriteBuffer buffer, bool async, char[] chars, int offset, int charLen, int byteLen, CancellationToken cancellationToken)
            {
                Debug.Assert(byteLen > buffer.WriteSpaceLeft);
                if (byteLen <= buffer.Size)
                {
        ...
        public Task WriteBytesRaw(byte[] bytes, bool async, CancellationToken cancellationToken = default)
        {
            ...
            static async Task WriteBytesLong(EDBWriteBuffer buffer, bool async, byte[] bytes, CancellationToken cancellationToken)
            {
