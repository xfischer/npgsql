...
namespace EnterpriseDB.EDBClient
{
    class SqlQueryParser
    {
        ...
        /// The parameters configured on the <see cref="EDBCommand"/> of this query or an empty <see cref="EDBParameterCollection"/>
