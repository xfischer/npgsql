...
namespace EnterpriseDB.EDBClient.TypeHandlers
{
    ...
    public abstract class ArrayHandler : EDBTypeHandler
    {
        ...
        /// <inheritdoc />
        protected internal override async ValueTask<TRequestedArray> Read<TRequestedArray>(EDBReadBuffer buf, int len, bool async, FieldDescription? fieldDescription = null)
        {
