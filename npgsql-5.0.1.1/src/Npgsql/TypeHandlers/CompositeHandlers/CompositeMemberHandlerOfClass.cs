...
namespace EnterpriseDB.EDBClient.TypeHandlers.CompositeHandlers
{
        ...
        where TComposite : class
    {
        ...
        public CompositeClassMemberHandler(FieldInfo fieldInfo, PostgresType postgresType, EDBTypeHandler handler)
        ...
        public CompositeClassMemberHandler(PropertyInfo propertyInfo, PostgresType postgresType, EDBTypeHandler handler)
        ...
        public override async ValueTask Read(TComposite composite, EDBReadBuffer buffer, bool async)
        {
            if (_set == null)
        ...
        public override ValueTask Read(ByReference<TComposite> composite, EDBReadBuffer buffer, bool async)
