...
namespace EnterpriseDB.EDBClient.TypeHandlers.CompositeHandlers
{
        ...
        where TComposite : struct
    {
        ...
        public CompositeStructMemberHandler(FieldInfo fieldInfo, PostgresType postgresType, EDBTypeHandler handler)
        ...
        public CompositeStructMemberHandler(PropertyInfo propertyInfo, PostgresType postgresType, EDBTypeHandler handler)
        ...
        public override ValueTask Read(TComposite composite, EDBReadBuffer buffer, bool async)
            => throw new NotSupportedException();

        public override async ValueTask Read(ByReference<TComposite> composite, EDBReadBuffer buffer, bool async)
        {
            if (_set == null)
        ...
        public override async Task Write(TComposite composite, EDBWriteBuffer buffer, EDBLengthCache? lengthCache, bool async, CancellationToken cancellationToken = default)
        {
            if (_get == null)
        ...
        public override int ValidateAndGetLength(TComposite composite, ref EDBLengthCache? lengthCache)
        {
            if (_get == null)
                ThrowHelper.ThrowInvalidOperationException_NoPropertyGetter(typeof(TComposite), MemberInfo);
