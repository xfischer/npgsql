...
namespace EnterpriseDB.EDBClient.TypeHandlers.DateTimeHandlers
{
    ...
    /// </remarks>
    [TypeMapping("timestamp without time zone", EDBDbType.Timestamp, new[] { DbType.DateTime, DbType.DateTime2 }, new[] { typeof(EDBDateTime), typeof(DateTime) }, DbType.DateTime)]
