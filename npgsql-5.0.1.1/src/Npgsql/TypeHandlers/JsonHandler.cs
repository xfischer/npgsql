...
namespace EnterpriseDB.EDBClient.TypeHandlers
{
    ...
    public class JsonHandler : EDBTypeHandler<string>, ITextReaderHandler
    {
        ...
        /// <inheritdoc />
        protected internal override async Task WriteObjectWithLength(object value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
