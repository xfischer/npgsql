...
namespace EnterpriseDB.EDBClient.TypeHandlers
{
    ...
    /// </remarks>
    [TypeMapping("jsonpath", EDBDbType.JsonPath)]
    public class JsonPathHandlerFactory : EDBTypeHandlerFactory<string>
    {
        /// <inheritdoc />
    ...
    /// Use it at your own risk.
    /// </remarks>
    public class JsonPathHandler : EDBTypeHandler<string>, ITextReaderHandler
    {
        ...
        /// <inheritdoc />
        protected internal JsonPathHandler(PostgresType postgresType, EDBConnection connection)
