...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    ...
    [TypeMapping("lquery", EDBDbType.LQuery)]
    class LQueryHandlerFactory : EDBTypeHandlerFactory<string>
    {
    ...
    public class LQueryHandler : TextHandler
    {
        ...
        protected internal LQueryHandler(PostgresType postgresType, EDBConnection connection)
        ...
        public override TextReader GetTextReader(Stream stream)
        {
            ...
            if (version != LQueryProtocolVersion)
                throw new EDBException($"Don't know how to decode lquery with wire format {version}, your connection is now broken");
