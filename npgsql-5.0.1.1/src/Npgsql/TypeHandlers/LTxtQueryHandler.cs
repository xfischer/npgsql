...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    ...
    [TypeMapping("ltxtquery", EDBDbType.LTxtQuery)]
    class LTxtQueryHandlerFactory : EDBTypeHandlerFactory<string>
    {
    ...
    public class LTxtQueryHandler : TextHandler
    {
        ...
        protected internal LTxtQueryHandler(PostgresType postgresType, EDBConnection connection)
        ...
        public override TextReader GetTextReader(Stream stream)
        {
            ...
            if (version != LTxtQueryProtocolVersion)
                throw new EDBException($"Don't know how to decode ltxtquery with wire format {version}, your connection is now broken");
