...
namespace EnterpriseDB.EDBClient.TypeHandlers
{
    class UnmappedEnumHandler : TextHandler
    {
        ...
        internal UnmappedEnumHandler(PostgresType pgType, IEDBNameTranslator nameTranslator, EDBConnection connection)
        ...
        protected override Task WriteWithLength<TAny>(TAny value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
