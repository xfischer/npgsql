...
namespace EnterpriseDB.EDBClient.TypeHandling
{
    ...
    public interface IEDBTypeHandler<T>
    {
        ...
        int ValidateAndGetLength(T value, ref EDBLengthCache? lengthCache, EDBParameter? parameter);
        ...
        Task Write(T value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default);
    }
}
