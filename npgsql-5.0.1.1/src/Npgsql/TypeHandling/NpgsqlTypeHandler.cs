...
namespace EnterpriseDB.EDBClient.TypeHandling
{
    ...
    public abstract class EDBTypeHandler
    {
        ...
        /// <param name="fieldDescription">Additional PostgreSQL information about the type, such as the length in varchar(30).</param>
        /// <returns>The fully-read value.</returns>
        public abstract TAny Read<TAny>(EDBReadBuffer buf, int len, FieldDescription? fieldDescription = null);
        ...
        /// </summary>
        internal abstract Task WriteWithLengthInternal<TAny>([AllowNull] TAny value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default);
        ...
        protected internal abstract Task WriteObjectWithLength(object value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default);
        ...
        internal delegate Task NonGenericWriteWithLength(EDBTypeHandler handler, object value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken);
        ...
        internal static NonGenericWriteWithLength GenerateNonGenericWriteMethod(Type handlerType, Type interfaceType)
        {
            ...
            // EDBTypeHandler handler, object value, EDBWriteBuffer buf, EDBLengthCache lengthCache, EDBParameter parameter, bool async, CancellationToken cancellationToken
            var handlerParam = Expression.Parameter(typeof(EDBTypeHandler), "handler");
            var valueParam = Expression.Parameter(typeof(object), "value");
            var bufParam = Expression.Parameter(typeof(EDBWriteBuffer), "buf");
            var lengthCacheParam = Expression.Parameter(typeof(EDBLengthCache), "lengthCache");
