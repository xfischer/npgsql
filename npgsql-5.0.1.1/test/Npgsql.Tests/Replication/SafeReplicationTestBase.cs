...
namespace EnterpriseDB.EDBClient.Tests.Replication
{
        ...
        where TConnection : ReplicationConnection, new()
    {
        ...
        private protected async Task<TConnection> OpenReplicationConnectionAsync(EDBConnectionStringBuilder? csb = null, CancellationToken cancellationToken = default)
        {
