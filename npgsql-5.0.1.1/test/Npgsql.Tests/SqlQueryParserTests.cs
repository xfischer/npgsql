...
namespace EnterpriseDB.EDBClient.Tests
{
    class SqlQueryParserTests
    {
        ...
        public void ParamSimple()
        {
            ...
            _parser.ParseRawQuery("SELECT :p1, :p2", _params, _queries, standardConformingStrings: true);
        ...
        public void ParamNameWithDot()
        {
            ...
            _parser.ParseRawQuery("INSERT INTO data (field_char5) VALUES (:a.parameter)", _params, _queries, standardConformingStrings: true);
        ...
        public void ParamGetsBoundNonAscii()
        {
            ...
            _parser.ParseRawQuery("SELECT @漢字", _params, _queries, standardConformingStrings: true);
            Assert.That(_queries.Single().InputParameters.Single(), Is.SameAs(_params.Single()));
        }
...
2", TestName = "LineComment")]
        ...
        public void NonConformingStrings()
        {
            ...
            parser.ParseRawQuery(@"SELECT 'abc\':str''a:str'", _params, _queries, standardConformingStrings: true);
        ...
        public void MultiqueryWithParams()
        {
            ...
            _parser.ParseRawQuery("SELECT @p3, @p1; SELECT @p2, @p3", _params, _queries, standardConformingStrings: true);
        ...
        public void NoOutputParameters()
        {
            ...
            _params.Add(p);
            Assert.That(() => _parser.ParseRawQuery("SELECT @p", _params, _queries, standardConformingStrings: true), Throws.Exception);
        }

        [Test]
        public void MissingParamIsIgnored()
        {
            _parser.ParseRawQuery("SELECT @p; SELECT 1", _params, _queries, standardConformingStrings: true);
        ...
        public void Empty()
        {
            _parser.ParseRawQuery("", _params, _queries, standardConformingStrings: true);
            Assert.That(_queries, Has.Count.EqualTo(1));
        }
        ...
        {
            _parser.ParseRawQuery
                ("CREATE OR REPLACE RULE test AS ON UPDATE TO test DO (SELECT 1; SELECT 1)", _params, _queries, standardConformingStrings: true);
            Assert.That(_queries, Has.Count.EqualTo(1));
        }
        ...
        {
            _parser.ParseRawQuery("CREATE OR REPLACE RULE test AS ON UPDATE TO test DO (SELECT 1); SELECT 1", _params, _queries, standardConformingStrings: true);
            Assert.That(_queries, Has.Count.EqualTo(2));
        }
        ...
        {
            _parser.ParseRawQuery("SELECT 1; SELECT 2", _params, _queries, standardConformingStrings: true);
            Assert.That(_queries, Has.Count.EqualTo(2));
            _parser.ParseRawQuery("SELECT 1", _params, _queries, standardConformingStrings: true);
            Assert.That(_queries, Has.Count.EqualTo(1));
        }
        ...
        List<EDBStatement> _queries = default!;
        EDBParameterCollection _params = default!;
