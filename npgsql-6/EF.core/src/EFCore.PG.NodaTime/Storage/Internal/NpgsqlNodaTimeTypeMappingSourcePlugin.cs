...
public class NpgsqlNodaTimeTypeMappingSourcePlugin : IRelationalTypeMappingSourcePlugin
{
    ...
    private readonly EDBRangeTypeMapping _timestampLocalDateTimeRange;
    private readonly EDBRangeTypeMapping _legacyTimestampInstantRange;
    private readonly EDBRangeTypeMapping _timestamptzInstantRange;
    private readonly EDBRangeTypeMapping _timestamptzZonedDateTimeRange;
    private readonly EDBRangeTypeMapping _timestamptzOffsetDateTimeRange;
    private readonly EDBRangeTypeMapping _dateRange;
    ...
    public NpgsqlNodaTimeTypeMappingSourcePlugin(ISqlGenerationHelper sqlGenerationHelper)
    {
        _timestampLocalDateTimeRange
            = new EDBRangeTypeMapping("tsrange", typeof(EDBRange<LocalDateTime>), _timestampLocalDateTime, sqlGenerationHelper);
        _legacyTimestampInstantRange
            = new EDBRangeTypeMapping("tsrange", typeof(EDBRange<Instant>), _legacyTimestampInstant, sqlGenerationHelper);
        _timestamptzInstantRange
            = new EDBRangeTypeMapping("tstzrange", typeof(EDBRange<Instant>), _timestamptzInstant, sqlGenerationHelper);
        _timestamptzZonedDateTimeRange
            = new EDBRangeTypeMapping("tstzrange", typeof(EDBRange<ZonedDateTime>), _timestamptzZonedDateTime, sqlGenerationHelper);
        _timestamptzOffsetDateTimeRange
            = new EDBRangeTypeMapping("tstzrange", typeof(EDBRange<OffsetDateTime>), _timestamptzOffsetDateTime, sqlGenerationHelper);
        _dateRange
            = new EDBRangeTypeMapping("daterange", typeof(EDBRange<LocalDate>), _date, sqlGenerationHelper);
