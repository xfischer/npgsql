...
/// used to configure a <see cref="DbContext"/> to context to a PostgreSQL database with EnterpriseDB.EDBClient.
/// </summary>
public static class NpgsqlDbContextOptionsBuilderExtensions
{
    ...
    /// <summary>
    /// Configures the context to connect to a PostgreSQL database with EnterpriseDB.EDBClient.
    /// </summary>
