...
/// </remarks>
public class EDBDateTimeMemberTranslator : IMemberTranslator
{
    ...
    public EDBDateTimeMemberTranslator(
...
#pragma warning disable 618 // EDBDateTime and EDBDate have been obsoleted
            && type != typeof(EDBDateTime)
            && type != typeof(EDBDate))
