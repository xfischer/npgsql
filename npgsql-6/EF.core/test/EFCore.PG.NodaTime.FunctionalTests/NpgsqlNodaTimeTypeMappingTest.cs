...
public class NpgsqlNodaTimeTypeMappingTest
{
    ...
    [Fact]
    public void EDBRange_of_LocalDateTime_is_properly_mapped()
    {
    ...
    {
        var mapping = (EDBRangeTypeMapping)GetMapping(typeof(EDBRange<LocalDateTime>));
    ...
    [Fact]
    public void Array_of_EDBRange_of_LocalDateTime_is_properly_mapped()
    {
    ...
    [Fact]
    public void List_of_EDBRange_of_LocalDateTime_is_properly_mapped()
    {
    ...
    {
        var mapping = (EDBRangeTypeMapping)GetMapping(typeof(EDBRange<Instant>));
    ...
    {
        var mapping = (EDBRangeTypeMapping)GetMapping(typeof(EDBRange<ZonedDateTime>));
        Assert.Equal("tstzrange", mapping.StoreType);
        Assert.Equal("timestamp with time zone", mapping.SubtypeMapping.StoreType);
    ...
    {
        var mapping = (EDBRangeTypeMapping)GetMapping(typeof(EDBRange<OffsetDateTime>));
        Assert.Equal("tstzrange", mapping.StoreType);
        Assert.Equal("timestamp with time zone", mapping.SubtypeMapping.StoreType);
    ...
    [Fact]
    public void Array_of_EDBRange_of_Instant_is_properly_mapped()
        => Assert.Equal("tstzmultirange", GetMapping(typeof(EDBRange<Instant>[])).StoreType);

    [Fact]
    public void List_of_EDBRange_of_Instant_is_properly_mapped()
    ...
    [Fact]
    public void EDBRange_of_LocalDate_is_properly_mapped()
    ...
    {
        var mapping = (EDBRangeTypeMapping)GetMapping(typeof(EDBRange<LocalDate>));
    ...
    [Fact]
    public void Array_of_EDBRange_of_LocalDate_is_properly_mapped()
        => Assert.Equal("datemultirange", GetMapping(typeof(EDBRange<LocalDate>[])).StoreType);

    [Fact]
    public void List_of_EDBRange_of_LocalDate_is_properly_mapped()
