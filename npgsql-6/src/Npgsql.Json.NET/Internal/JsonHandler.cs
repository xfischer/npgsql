...
{
    class JsonHandler : EnterpriseDB.EDBClient.Internal.TypeHandlers.JsonHandler
    {
        readonly JsonSerializerSettings _settings;

        public JsonHandler(PostgresType postgresType, EDBConnector connector, JsonSerializerSettings settings)
