...
This package is an EDB plugin which allows you to use the [NodaTime](https://nodatime.org) date/time library when interacting with PostgreSQL; this provides a better and safer API for dealing with date and time data. 
...
For more information, [visit the NodaTime plugin documentation page](https://www.EnterpriseDB.EDBClient.org/doc/types/nodatime.html).
