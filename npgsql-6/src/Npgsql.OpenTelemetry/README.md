...
This package helps set up EDB's support for OpenTelemetry tracing, which allows you to observe database commands as they are being executed.
...
using var tracerProvider = Sdk.CreateTracerProviderBuilder()
    ...
    .AddSource("MyApp")
    // This activates up EDB's tracing:
    .AddEDB()
...
Once this is done, you should start seeing EDB trace data appearing in your application's console. At this point, you can look into exporting your trace data to a more useful destination: systems such as [Zipkin](https://zipkin.io/) or [Jaeger](https://www.jaegertracing.io/) can efficiently collect and store your data, and provide user interfaces for querying and exploring it.

For more information, [visit the diagnostics documentation page](https://www.EnterpriseDB.EDBClient.org/doc/diagnostics.html).
