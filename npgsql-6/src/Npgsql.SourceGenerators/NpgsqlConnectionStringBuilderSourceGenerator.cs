...
{
    [Generator]
    public class EDBConnectionStringBuilderSourceGenerator : ISourceGenerator
    {
        ...
        {
            if (context.Compilation.Assembly.GetTypeByMetadataName("EnterpriseDB.EDBClient.EDBConnectionStringBuilder") is not { } type)
                return;

            if (context.Compilation.Assembly.GetTypeByMetadataName("EnterpriseDB.EDBClient.EDBConnectionStringPropertyAttribute") is not
