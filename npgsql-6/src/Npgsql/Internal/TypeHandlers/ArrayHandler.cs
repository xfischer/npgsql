...
namespace EnterpriseDB.EDBClient.Internal.TypeHandlers
{
    ...
    public abstract class ArrayHandler : EDBTypeHandler
    {
        ...
        private protected EDBTypeHandler ElementHandler { get; }
        ...
        /// <inheritdoc />
        protected ArrayHandler(PostgresType arrayPostgresType, EDBTypeHandler elementHandler, ArrayNullabilityMode arrayNullabilityMode, int lowerBound = 1)
        ...
        /// <inheritdoc />
        protected internal override async ValueTask<TRequestedArray> ReadCustom<TRequestedArray>(EDBReadBuffer buf, int len, bool async, FieldDescription? fieldDescription = null)
        {
        ...
        /// </summary>
        protected async ValueTask<Array> ReadArray<TRequestedElement>(EDBReadBuffer buf, bool async, int expectedDimensions = 0, bool readAsObject = false)
        {
        ...
        /// </summary>
        protected async ValueTask<List<TRequestedElement>> ReadList<TRequestedElement>(EDBReadBuffer buf, bool async)
        {
            await buf.Ensure(12, async);
            var dimensions = buf.ReadInt32();
            var containsNulls = buf.ReadInt32() == 1;
        ...
        internal static class ArrayTypeInfo<TArrayOrList>
        {
            ...
            public static readonly Func<ArrayHandler, EDBReadBuffer, bool, ValueTask<Array>> ReadArrayFunc = default!;
            public static readonly Func<ArrayHandler, EDBReadBuffer, bool, ValueTask<TArrayOrList>> ReadListFunc = default!;
            ...
            static ArrayTypeInfo()
            {
                ...
                var bufferParam = Expression.Parameter(typeof(EDBReadBuffer), "buf");
                var asyncParam = Expression.Parameter(typeof(bool), "async");

                if (IsArray)
                {
                    ReadArrayFunc = Expression
                        .Lambda<Func<ArrayHandler, EDBReadBuffer, bool, ValueTask<Array>>>(
                            Expression.Call(
                                arrayHandlerParam,
                ...
                if (IsList)
                {
                    ReadListFunc = Expression
                        .Lambda<Func<ArrayHandler, EDBReadBuffer, bool, ValueTask<TArrayOrList>>>(
                            Expression.Call(
                                arrayHandlerParam,
    ...
    {
        /// <inheritdoc />
        public ArrayHandler(PostgresType arrayPostgresType, EDBTypeHandler elementHandler, ArrayNullabilityMode arrayNullabilityMode, int lowerBound = 1)
        ...
        /// <inheritdoc />
        protected internal override int ValidateAndGetLengthCustom<TAny>([DisallowNull] TAny value, ref EDBLengthCache? lengthCache, EDBParameter? parameter)
        ...
        int ValidateAndGetLengthGeneric(ICollection<TElement> value, ref EDBLengthCache lengthCache)
        {
        ...
        int ValidateAndGetLengthNonGeneric(ICollection value, ref EDBLengthCache lengthCache)
        {
        ...
        protected override Task WriteWithLengthCustom<TAny>([DisallowNull] TAny value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken)
        {
        ...
        async Task WriteGeneric(ICollection<TElement> value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, bool async, CancellationToken cancellationToken = default)
        {
            var len =
                4 +    // dimensions
                4 +    // has_nulls (unused)
        ...
        async Task WriteNonGeneric(ICollection value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, bool async, CancellationToken cancellationToken = default)
        {
    ...
    {
        public ArrayHandlerWithPsv(PostgresType arrayPostgresType, EDBTypeHandler elementHandler, ArrayNullabilityMode arrayNullabilityMode)
