...
#pragma warning disable 618 // EDBDateTime is obsolete, remove in 7.0
        internal static EDBDateTime ReadEDBDateTime(EDBReadBuffer buf, int len, FieldDescription? fieldDescription = null)
        {
...
#pragma warning disable 618 // EDBDateTime is obsolete, remove in 7.0
        internal static void WriteTimestamp(EDBDateTime value, EDBWriteBuffer buf)
        {
            if (value.IsInfinity)
            {
                buf.WriteInt64(long.MaxValue);
