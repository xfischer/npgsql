...
namespace EnterpriseDB.EDBClient.Internal.TypeHandlers.GeometricHandlers
{
    ...
    /// </remarks>
    public partial class PathHandler : EDBTypeHandler<EDBPath>
    {
        ...
        /// <inheritdoc />
        public override async Task Write(EDBPath value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
