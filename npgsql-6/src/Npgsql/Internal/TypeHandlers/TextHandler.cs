...
namespace EnterpriseDB.EDBClient.Internal.TypeHandlers
{
        ...
        IEDBTypeHandler<char>, IEDBTypeHandler<byte[]>, ITextReaderHandler
    {
        ...
        /// <inheritdoc />
        public Task Write(char value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
            _singleCharArray[0] = value;
