...
namespace EnterpriseDB.EDBClient.Internal.TypeHandlers
{
    ...
    class UnknownTypeHandler : TextHandler
    {
        ...
        internal UnknownTypeHandler(EDBConnector connector)
        ...
        protected internal override int ValidateAndGetLengthCustom<TAny>(
            [DisallowNull] TAny value, ref EDBLengthCache? lengthCache, EDBParameter? parameter)
        ...
        public override Task WriteObjectWithLength(object? value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        {
            ...
            async Task WriteWithLengthLong(object value, string convertedValue, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken)
            {
