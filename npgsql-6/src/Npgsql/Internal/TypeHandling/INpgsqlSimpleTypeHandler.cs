...
namespace EnterpriseDB.EDBClient.Internal.TypeHandling
{
    ...
    /// </summary>
    public interface IEDBSimpleTypeHandler<T>
    {
        /// <summary>
        ...
        int ValidateAndGetLength([DisallowNull] T value, EDBParameter? parameter);
        ...
        /// information relevant to the write process (e.g. <see cref="EDBParameter.Size"/>).
        /// </param>
        void Write([DisallowNull] T value, EDBWriteBuffer buf, EDBParameter? parameter);
    }
}
