...
namespace EnterpriseDB.EDBClient.Internal.TypeHandling
{
    ...
    /// <see cref="EDBDateTime"/>). The provider-specific type <typeparamref name="TPsv"/> will be returned
    ...
    {
        public EDBSimpleTypeHandlerWithPsv(PostgresType pgType) : base(pgType) {}
