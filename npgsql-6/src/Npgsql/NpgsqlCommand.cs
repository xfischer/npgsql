...
namespace EnterpriseDB.EDBClient
{
    ...
    public sealed class EDBCommand : DbCommand, ICloneable, IComponent
    {
        #region Fields
        ...
        /// </summary>
        internal EDBCommand(List<EDBBatchCommand> batchCommands)
        {
            GC.SuppressFinalize(this);
        ...
        /// Used when this <see cref="EDBCommand"/> instance is wrapped inside an <see cref="EDBBatch"/>.
        /// </summary>
        internal EDBCommand(EDBConnector connector, List<EDBBatchCommand> batchCommands)
            : this(batchCommands)
            => _connector = connector;
...
#pragma warning restore CS8602
        ...
        /// <summary>
        /// Releases the resources used by the <see cref="EDBCommand"/>.
        /// </summary>
        ...
        internal void TraceCommandStart(EDBConnector connector)
        {
            ...
            if (EDBActivitySource.IsEnabled)
                CurrentActivity = EDBActivitySource.CommandStart(connector, CommandText);
        }
        ...
        void LogCommand(EDBConnector connector)
        {
            var sb = new StringBuilder();
