...
namespace EnterpriseDB.EDBClient
{
    ...
    public sealed class EDBConnection : DbConnection, ICloneable, IComponent
    {
        ...
        /// </summary>
        public EDBConnectionStringBuilder Settings { get; private set; } = DefaultSettings;
        ...
        void GetPoolAndSettings()
        {
            ...
            if (hostsSeparator is -1)
            {
                ...
                if (!EDBConnectionStringBuilder.IsUnixSocket(settings.Host!, settings.Port, out _) &&
                    EDBConnectionStringBuilder.TrySplitHostPort(settings.Host!.AsSpan(), out var newHost, out var newPort))
                {
        ...
        internal Task Open(bool async, CancellationToken cancellationToken)
        {
            ...
            async Task OpenAsync(bool async, CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    timeout = new EDBTimeout(connectionTimeout);
        ...
        async ValueTask<EDBTransaction> BeginTransaction(IsolationLevel level, bool async, CancellationToken cancellationToken)
        {
            ...
            var connector = ConnectorBindingScope == ConnectorBindingScope.Transaction ?
                    Connector
                    : await StartBindingScope(ConnectorBindingScope.Transaction, EDBTimeout.Infinite, async,
                        cancellationToken);
        ...
        /// Ignored if <see cref="EDBConnectionStringBuilder.SslMode"/> is set to <see cref="SslMode.Allow"/>,
        ...
        [Obsolete("Use EDBConnection.TypeMapper.MapEnum() instead")]
        public void MapEnum<TEnum>(string? pgName = null, IEDBNameTranslator? nameTranslator = null)
        ...
        /// </param>
        /// <typeparam name="TEnum">The .NET enum type to be mapped</typeparam>
        [Obsolete("Use EDBConnection.GlobalTypeMapper.MapEnum() instead")]
        public static void MapEnumGlobally<TEnum>(string? pgName = null, IEDBNameTranslator? nameTranslator = null)
            where TEnum : struct, Enum
        ...
        /// Defaults to <see cref="EDBSnakeCaseNameTranslator"/>
        /// </param>
        [Obsolete("Use EDBConnection.GlobalTypeMapper.UnmapEnum() instead")]
        public static void UnmapEnumGlobally<TEnum>(string? pgName = null, IEDBNameTranslator? nameTranslator = null)
            where TEnum : struct, Enum
        ...
        [Obsolete("Use EDBConnection.TypeMapper.MapComposite() instead")]
        ...
        /// </param>
        /// <typeparam name="T">The .NET type to be mapped</typeparam>
        [Obsolete("Use EDBConnection.GlobalTypeMapper.MapComposite() instead")]
        [RequiresUnreferencedCode("Composite type mapping currently isn't trimming-safe.")]
        ...
        /// Defaults to <see cref="EDBSnakeCaseNameTranslator"/>
        /// </param>
        [Obsolete("Use EDBConnection.GlobalTypeMapper.UnmapComposite() instead")]
        [RequiresUnreferencedCode("Composite type mapping currently isn't trimming-safe.")]
    ...
    public delegate void PhysicalOpenCallback(EDBConnector connection);

    /// <summary>
    /// Represents an asynchronous method that allows the application to setup a connection with custom commands.
    /// </summary>
    /// <param name="connection">Physical connection to the database</param>
    public delegate Task PhysicalOpenAsyncCallback(EDBConnector connection);
