...
namespace EnterpriseDB.EDBClient
{
    ...
    /// </summary>
    public sealed partial class EDBConnectionStringBuilder : DbConnectionStringBuilder, IDictionary<string, object?>
    {
        #region Fields

        /// <summary>
        /// Cached DataSource value to reduce allocations on EDBConnection.DataSource.get
        /// </summary>
        ...
        /// </summary>
        /// <param name="item">The item to locate in the <see cref="EDBConnectionStringBuilder"/>.</param>
        ...
        public bool IntegratedSecurity
        {
            ...
            set
            {
                ...
                // see https://github.com/npgsql/EDB/issues/133
                if (value && Type.GetType("Mono.Runtime") != null)
                    throw new NotSupportedException("IntegratedSecurity is currently unsupported on mono and .NET 4.5 (see https://github.com/npgsql/EDB/issues/133)");
        ...
        /// </summary>
        [Category("Timeouts")]
        [Description("After Command Timeout is reached (or user supplied cancellation token is cancelled) and command cancellation is attempted, EDB waits for this additional timeout (in milliseconds) before breaking the connection. Defaults to 2000, set to zero for infinity.")]
        ...
        /// </summary>
        [Category("Advanced")]
        [Description("whether connection is with PGPOOL or EPAS.")]
        ...
        public bool IsPgPoolConnection
        {
            ...
            set
            {
                _isPgPoolConnection = value;
                SetValue(nameof(IsPgPoolConnection), value);
            }
        }
        ...
        /// </summary>
        [Category("Advanced")]
        [Description("Sync time (milliseconds) in case connection is made with PGPOOL.")]
        ...
        public int PgPoolSyncTime
        {
            ...
            set
            {
                _pgPoolSyncTime = value;
                SetValue(nameof(PgPoolSyncTime), value);
            }
        }
        int _pgPoolSyncTime;
        ...
        /// <summary>
        /// Obsolete, see https://www.EnterpriseDB.EDBClient.org/doc/release-notes/6.0.html
        /// </summary>
        [Category("Compatibility")]
        ...
        {
            get => false;
            set => throw new NotSupportedException("The Convert Infinity DateTime parameter is no longer supported; EDB 6.0 and above convert min/max values to Infinity by default. See https://www.EnterpriseDB.EDBClient.org/doc/types/datetime.html for more details.");
        }

        /// <summary>
        /// Obsolete, see https://www.EnterpriseDB.EDBClient.org/doc/release-notes/3.1.html
        /// </summary>
        [Category("Obsolete")]
        [Description("Obsolete, see https://www.EnterpriseDB.EDBClient.org/doc/release-notes/3.1.html")]
        ...
        {
            get => false;
            set => throw new NotSupportedException("The ContinuousProcessing parameter is no longer supported. Please see https://www.EnterpriseDB.EDBClient.org/doc/release-notes/3.1.html");
        }
        ...
        {
            get => false;
            set => throw new NotSupportedException("The BackendTimeouts parameter is no longer supported. Please see https://www.EnterpriseDB.EDBClient.org/doc/release-notes/3.1.html");
        }

        /// <summary>
        /// Obsolete, see https://www.EnterpriseDB.EDBClient.org/doc/release-notes/3.0.html
        /// </summary>
        [Category("Obsolete")]
        [Description("Obsolete, see https://www.EnterpriseDB.EDBClient.org/doc/v/3.0.html")]
        ...
        {
            get => false;
            set => throw new NotSupportedException("The PreloadReader parameter is no longer supported. Please see https://www.EnterpriseDB.EDBClient.org/doc/release-notes/3.0.html");
        }
        ...
        /// </summary>
        [Category("Obsolete")]
        [Description("Obsolete, see https://www.EnterpriseDB.EDBClient.org/doc/release-notes/3.0.html")]
        ...
        {
            get => false;
            set => throw new NotSupportedException("The UseExtendedTypes parameter is no longer supported. Please see https://www.EnterpriseDB.EDBClient.org/doc/release-notes/3.0.html");
        }

        /// <summary>
        /// Obsolete, see https://www.EnterpriseDB.EDBClient.org/doc/release-notes/4.1.html
        /// </summary>
        [Category("Obsolete")]
        [Description("Obsolete, see https://www.EnterpriseDB.EDBClient.org/doc/release-notes/4.1.html")]
        ...
        {
            get => true;
            set => throw new NotSupportedException("The UseSslStream parameter is no longer supported (SslStream is always used). Please see https://www.EnterpriseDB.EDBClient.org/doc/release-notes/4.1.html");
        }
        ...
        {
            get => false;
            set => throw new NotSupportedException("The UsePerfCounters parameter is no longer supported. Please see https://www.EnterpriseDB.EDBClient.org/doc/release-notes/5.0.html");
        }
        ...
        [EDBConnectionStringProperty]
        [Obsolete("Use EDBConnectionStringBuilder.SslKey instead")]
        ...
        [EDBConnectionStringProperty]
        [Obsolete("Use EDBConnectionStringBuilder.SslPassword instead")]
        ...
        [EDBConnectionStringProperty]
        [Obsolete("Use EDBConnectionStringBuilder.IncludeErrorDetail instead")]
        ...
        internal void Validate()
        {
            ...
            if (SslMode == SslMode.Require && !TrustServerCertificate)
                throw new EDBException(
                    ...
                    "See https://www.EnterpriseDB.EDBClient.org/doc/release-notes/6.0.html for more details.");
            if (TrustServerCertificate && (SslMode == SslMode.Allow || SslMode == SslMode.VerifyCA || SslMode == SslMode.VerifyFull))
                throw new EDBException($"TrustServerCertificate=true is not supported with SslMode={SslMode}");
        }
        ...
        internal EDBConnectionStringBuilder Clone() => new(ConnectionString);
        ...
        public override bool Equals(object? obj)
            => obj is EDBConnectionStringBuilder o && EquivalentTo(o);
        ...
        /// <summary>
        /// Gets an <see cref="ICollection" /> containing the keys of the <see cref="EDBConnectionStringBuilder"/>.
        /// </summary>
        public new ICollection<string> Keys => base.Keys.Cast<string>().ToArray()!;

        /// <summary>
        /// Gets an <see cref="ICollection" /> containing the values in the <see cref="EDBConnectionStringBuilder"/>.
        /// </summary>
    ...
    public enum ArrayNullabilityMode
    {
        ...
        /// that the actual type of array instances returned from APIs like <see cref="EDBDataReader.GetValue"/>
