...
namespace EnterpriseDB.EDBClient
{
    ...
    public class EDBParameter : DbParameter, IDbDataParameter, ICloneable
    {
        ...
        {
            [RequiresUnreferencedCodeAttribute("The EDBDbType getter isn't trimming-safe")]
            get
            {
                if (_npgsqlDbType.HasValue)
                ...
                if (_value != null) // Infer from value
                {
                    return GlobalTypeMapper.Instance.TryResolveMappingByValue(_value, out var mapping)
                        ...
                        : throw new NotSupportedException("Can't infer EDBDbType for type " + _value.GetType());
                }
