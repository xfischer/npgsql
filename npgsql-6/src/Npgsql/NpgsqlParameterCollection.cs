...
{
    /// <summary>
    /// Represents a collection of parameters relevant to a <see cref="EDBCommand"/> as well as their respective mappings to columns in
    /// a <see cref="DataSet"/>.
    /// </summary>
    public sealed class EDBParameterCollection : DbParameterCollection, IList<EDBParameter>
    {
        ...
        internal List<EDBParameter> InternalList { get; } = new(5);
#if DEBUG
        ...
        void LookupChangeName(EDBParameter parameter, string oldName, string oldTrimmedName, int index)
        {
        ...
        internal void ChangeParameterName(EDBParameter parameter, string? value)
        {
        ...
        /// <value>
        /// The <see cref="EDBParameter"/> with the specified name, or a <see langword="null"/> reference if the parameter is not found.
        /// </value>
            ...
            set
            {
                ...
                if (!string.Equals(parameterName, value.TrimmedName, StringComparison.OrdinalIgnoreCase))
                    throw new ArgumentException(
                        "Parameter name must be a case-insensitive match with the property 'ParameterName' on the given EDBParameter",
        ...
        /// </summary>
        /// <param name="index">The zero-based index of the <see cref="EDBParameter"/> to retrieve.</param>
        /// <value>The <see cref="EDBParameter"/> at the specified index.</value>
        ...
        /// <summary>
        /// Adds a <see cref="EDBParameter"/> to the <see cref="EDBParameterCollection"/> given the specified parameter name and
        /// value.
        /// </summary>
        /// <param name="parameterName">The name of the <see cref="EDBParameter"/>.</param>
        /// <param name="value">The value of the <see cref="EDBParameter"/> to add to the collection.</param>
        /// <returns>The parameter that was added.</returns>
        public EDBParameter AddWithValue(string parameterName, object value)
            => Add(new EDBParameter(parameterName, value));

        /// <summary>
        /// Adds a <see cref="EDBParameter"/> to the <see cref="EDBParameterCollection"/> given the specified parameter name,
        /// data type and value.
        /// </summary>
        /// <param name="parameterName">The name of the <see cref="EDBParameter"/>.</param>
        ...
        /// <param name="parameterName">The name of the <see cref="EDBParameter"/>.</param>
        /// <param name="value">The value of the <see cref="EDBParameter"/> to add to the collection.</param>
        /// <param name="parameterType">One of the <see cref="EDBDbType"/> values.</param>
        ...
        /// <summary>
        /// Adds a <see cref="EDBParameter"/> to the <see cref="EDBParameterCollection"/> given the specified value.
        /// </summary>
        /// <param name="value">The value of the <see cref="EDBParameter"/> to add to the collection.</param>
        /// <returns>The parameter that was added.</returns>
        ...
        /// <summary>
        /// Adds a <see cref="EDBParameter"/> to the <see cref="EDBParameterCollection"/> given the specified data type and value.
        /// </summary>
        /// <param name="parameterType">One of the <see cref="EDBDbType"/> values.</param>
        /// <param name="value">The value of the <see cref="EDBParameter"/> to add to the collection.</param>
        /// <returns>The parameter that was added.</returns>
        ...
        /// <summary>
        /// Adds a <see cref="EDBParameter"/> to the <see cref="EDBParameterCollection"/> given the parameter name and the data type.
        /// </summary>
        ...
        /// <summary>
        /// Adds a <see cref="EDBParameter"/> to the <see cref="EDBParameterCollection"/> with the parameter name, the data type,
        ...
        /// <summary>
        /// Adds a <see cref="EDBParameter"/> to the <see cref="EDBParameterCollection"/> with the parameter name, the data type, the
        ...
        /// <summary>
        /// Removes the specified <see cref="EDBParameter"/> from the collection using a specific index.
        /// </summary>
        ...
        /// </summary>
        /// <param name="parameterName">The name of the <see cref="EDBParameter"/> to remove from the collection.</param>
        ...
        /// Removes the specified <see cref="EDBParameter"/> from the collection.
        /// </summary>
        /// <param name="value">The <see cref="EDBParameter"/> to remove from the collection.</param>
        public override void Remove(object value)
            => Remove(Cast(value));

        /// <inheritdoc />
        public override bool Contains(object value)
            => value is EDBParameter param && InternalList.Contains(param);

        /// <summary>
        /// Gets a value indicating whether a <see cref="EDBParameter"/> with the specified parameter name exists in the collection.
        /// </summary>
        /// <param name="parameterName">The name of the <see cref="EDBParameter"/> object to find.</param>
        ...
        /// </summary>
        /// <value>The number of <see cref="EDBParameter"/> objects in the collection.</value>
        ...
        public bool Contains(EDBParameter item) => InternalList.Contains(item);
        ...
        public EDBParameter[] ToArray() => InternalList.ToArray();
        ...
        internal void CalculatePlaceholderType(EDBParameter p)
        {
            if (p.IsPositional)
            {
        ...
        static EDBParameter Cast(object? value)
            => value is EDBParameter p
                ? p
                : throw new InvalidCastException(
                    $"The value \"{value}\" is not of type \"{nameof(EDBParameter)}\" and cannot be used in this parameter collection.");
    }
    ...
    enum PlaceholderType
    {
        ...
        /// This is only supported when <see cref="EDBCommand.CommandType" /> is set to <see cref="CommandType.StoredProcedure" />.
        /// </summary>
        Mixed
    }
}
