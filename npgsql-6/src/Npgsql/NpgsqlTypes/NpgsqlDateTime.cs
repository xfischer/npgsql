...
namespace EDBTypes
{
        ...
        IComparer<EDBDateTime>, IComparer
    {
        ...
        public static readonly EDBDateTime Epoch = new(EDBDate.Epoch);
        public static readonly EDBDateTime Era = new(EDBDate.Era);

        public static readonly EDBDateTime Infinity =
            new(InternalType.Infinity, EDBDate.Era, TimeSpan.Zero);

        public static readonly EDBDateTime NegativeInfinity =
            new(InternalType.NegativeInfinity, EDBDate.Era, TimeSpan.Zero);
        ...
        public static EDBDateTime Now => new(DateTime.Now);
        ...
        public EDBDateTime Add(in EDBTimeSpan value) => AddTicks(value.UnjustifyInterval().TotalTicks);
        ...
        public EDBDateTime Subtract(in EDBTimeSpan interval) =>  Add(-interval);
        ...
        public static EDBDateTime ToEDBDateTime(DateTime dateTime) => new(dateTime);
