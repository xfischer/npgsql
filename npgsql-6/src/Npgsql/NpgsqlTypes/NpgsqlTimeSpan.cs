...
namespace EDBTypes
{
    ...
    [Obsolete(
        "For values outside the range of TimeSpan, consider using NodaTime (range -9998 to 9999), or read the value as an EDBInterval. " +
        "See https://www.EnterpriseDB.EDBClient.org/doc/types/datetime.html for more information.")]
    [Serializable]
                                   ...
                                   IComparer<EDBTimeSpan>
    {
        ...
        /// </summary>
        public static readonly EDBTimeSpan MaxValue = new(long.MaxValue);

        /// <summary>
        /// Represents the minimum <see cref="EDBTimeSpan"/>. This field is read-only.
        /// </summary>
        public static readonly EDBTimeSpan MinValue = new(long.MinValue);

        /// <summary>
        /// Represents the zero <see cref="EDBTimeSpan"/>. This field is read-only.
        /// </summary>
        public static readonly EDBTimeSpan Zero = new(0);
        ...
        /// <returns>An <see cref="EDBTimeSpan"/> whose values are the sums of the two instances.</returns>
        ...
        /// <returns>An <see cref="EDBTimeSpan"/> whose values are the differences of the two instances.</returns>
        ...
        public EDBTimeSpan Negate() => new(-Months, -Days, -Ticks);
