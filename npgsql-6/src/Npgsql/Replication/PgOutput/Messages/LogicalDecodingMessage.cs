...
namespace EnterpriseDB.EDBClient.Replication.PgOutput.Messages
{
    ...
    public sealed class LogicalDecodingMessage : TransactionalMessage
    {
        ...
        /// </summary>
        public EDBLogSequenceNumber MessageLsn { get; private set; }
        ...
        internal LogicalDecodingMessage Populate(EDBLogSequenceNumber walStart, EDBLogSequenceNumber walEnd, DateTime serverClock,
            uint? transactionXid, byte flags, EDBLogSequenceNumber messageLsn, string prefix, Stream data)
        {
