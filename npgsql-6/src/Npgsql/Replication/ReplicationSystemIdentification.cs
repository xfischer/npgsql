...
namespace EnterpriseDB.EDBClient.Replication
{
    ...
    {
        internal ReplicationSystemIdentification(string systemId, uint timeline, EDBLogSequenceNumber xLogPos, string dbName)
        {
            SystemId = systemId;
            Timeline = timeline;
            XLogPos = xLogPos;
        ...
        /// </summary>
        public EDBLogSequenceNumber XLogPos { get; }
