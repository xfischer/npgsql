...
namespace EnterpriseDB.EDBClient.NodaTime.Tests
{
    ...
    public class NodaTimeInfinityTests : TestBase
    {
        ...
        public async Task Timestamp_write()
        {
            ...
            {
                Parameters = { new() { Value = LocalDate.MinIsoValue + LocalTime.MinValue, EDBDbType = EDBDbType.Timestamp } }
            };
            ...
            {
                Parameters = { new() { Value = LocalDate.MaxIsoValue + LocalTime.MaxValue, EDBDbType = EDBDbType.Timestamp } }
            };
