...
namespace EnterpriseDB.EDBClient.Tests.SPL
{
    internal class EDBAssociativeArrayTest : TestBase
    {
        ...
        [Test]
        public void SimpleAssociativeArrayTest()
        {
            ...
            Execute("DROP PROCEDURE SimpleAssociativeArray_SP;");
        ...
        [Test]
        public void RecordTypeAssociativeArrayTest()
        {
            // use a record type in the array definition
            Execute("DROP PROCEDURE RecordTypeAssociativeArray_SP;");
        ...
        [Test]
        public void RowTypeAssociativeArrayTest()
        {
            //The emp1%ROWTYPE attribute could be used to define emp_arr_typ
            Execute("DROP PROCEDURE RowTypeAssociativeArray_SP;");
        ...
        [Test]
        public void RecordLevelAssignmentAssociativeArrayTestTest()
        {
            //a record level assignment can be made from r_emp to emp_arr.
            Execute("DROP PROCEDURE RecordLevelAssignmentAssociativeArrayTest_SP;");
        ...
        [Test]
        public void CharacterDataAssociativeArrayTest()
        {
            //The key of an associative array can be character data
            Execute("DROP PROCEDURE CharacterDataAssociativeArray_SP;");
