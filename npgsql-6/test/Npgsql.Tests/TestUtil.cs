...
namespace EnterpriseDB.EDBClient.Tests
{
    public static class TestUtil
    {
        ...
        /// test database.
        /// </summary>
        public const string DefaultConnectionString = "Server=localhost;port=5444;Username=npgsql_tests;Password=npgsql_tests;Database=npgsql_tests;Timeout=0;Command Timeout=0";
        ...
        /// </summary>
        internal static Task<IAsyncDisposable> CreateTempTable(EDBConnection conn, string columns, out string tableName)
        {
        ...
        /// drop it at the end of the test.
        /// </summary>
        internal static Task<IAsyncDisposable> CreateTempSchema(EDBConnection conn, out string schemaName)
        {
        ...
        /// </returns>
        internal static Task<IAsyncDisposable> GetTempTableName(EDBConnection conn, out string tableName)
        {
            tableName = "temp_table" + Interlocked.Increment(ref _tempTableCounter);
        ...
        /// </returns>
        internal static Task<IAsyncDisposable> GetTempViewName(EDBConnection conn, out string viewName)
        {
        ...
        /// </returns>
        internal static IAsyncDisposable GetTempFunctionName(EDBConnection conn, out string functionName)
        {
        ...
        /// An <see cref="IDisposable"/> to drop the function at the end of the test.
        /// </returns>
        internal static Task<IAsyncDisposable> GetTempTypeName(EDBConnection conn, out string typeName)
        {
        ...
        sealed class DatabaseObjectDropper : IAsyncDisposable
        {
            ...
            internal DatabaseObjectDropper(EDBConnection conn, string name, string type)
