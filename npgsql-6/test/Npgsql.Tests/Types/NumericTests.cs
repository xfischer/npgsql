...
namespace EnterpriseDB.EDBClient.Tests.Types
{
    public class NumericTests : MultiplexingTestBase
    {
        ...
        public async Task Mapping()
        {
            ...
            cmd.Parameters.Add(new EDBParameter("p1", EDBDbType.Numeric) { Value = 8M });
            cmd.Parameters.Add(new EDBParameter("p2", DbType.Decimal) { Value = 8M });
            cmd.Parameters.Add(new EDBParameter("p3", DbType.VarNumeric) { Value = 8M });
            cmd.Parameters.Add(new EDBParameter("p4", 8M));
