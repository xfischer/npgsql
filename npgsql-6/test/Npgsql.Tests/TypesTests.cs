...
#pragma warning disable 618 // EDBDateTime, EDBDate, EDBTimeSpan are obsolete, remove in 7.0
...
namespace EnterpriseDB.EDBClient.Tests
{
    ...
    {
        [Test]
        public void EDBIntervalParse()
        {
            string input;
            EDBTimeSpan test;

            input = "1 day";
            test = EDBTimeSpan.Parse(input);
        ...
        [Test]
        public void EDBIntervalConstructors()
        {
            EDBTimeSpan test;

            test = new EDBTimeSpan();
            ...
            test = new EDBTimeSpan(1234567890);
            Assert.AreEqual(0, test.Months, "Months");
            Assert.AreEqual(0, test.Days, "Days");
            Assert.AreEqual(0, test.Hours, "Hours");
            ...
            test = new EDBTimeSpan(new TimeSpan(1, 2, 3, 4, 5)).JustifyInterval();
            Assert.AreEqual(0, test.Months, "Months");
            ...
            test = new EDBTimeSpan(3, 2, 1234567890);
            ...
            test = new EDBTimeSpan(1, 2, 3, 4, 5);
            Assert.AreEqual(0, test.Months, "Months");
            Assert.AreEqual(1, test.Days, "Days");
            Assert.AreEqual(2, test.Hours, "Hours");
            Assert.AreEqual(3, test.Minutes, "Minutes");
            ...
            test = new EDBTimeSpan(1, 2, 3, 4, 5, 6);
            ...
            test = new EDBTimeSpan(1, 2, 3, 4, 5, 6, 7);
        ...
        [Test]
        public void EDBIntervalToString()
        {
            Assert.AreEqual("00:00:00", new EDBTimeSpan().ToString());

            Assert.AreEqual("00:02:03.456789", new EDBTimeSpan(1234567890).ToString());

            Assert.AreEqual("00:02:03.456789", new EDBTimeSpan(1234567891).ToString());

            Assert.AreEqual("1 day 02:03:04.005",
                            new EDBTimeSpan(new TimeSpan(1, 2, 3, 4, 5)).JustifyInterval().ToString());

            Assert.AreEqual("3 mons 2 days 00:02:03.456789", new EDBTimeSpan(3, 2, 1234567890).ToString());

            Assert.AreEqual("1 day 02:03:04", new EDBTimeSpan(1, 2, 3, 4).ToString());

            Assert.AreEqual("1 day 02:03:04.005", new EDBTimeSpan(1, 2, 3, 4, 5).ToString());

            Assert.AreEqual("1 mon 2 days 03:04:05.006", new EDBTimeSpan(1, 2, 3, 4, 5, 6).ToString());

            Assert.AreEqual("14 mons 3 days 04:05:06.007", new EDBTimeSpan(1, 2, 3, 4, 5, 6, 7).ToString());

            Assert.AreEqual(new EDBTimeSpan(0, 2, 3, 4, 5).ToString(), new EDBTimeSpan(new TimeSpan(0, 2, 3, 4, 5)).ToString());

            Assert.AreEqual(new EDBTimeSpan(1, 2, 3, 4, 5).ToString(), new EDBTimeSpan(new TimeSpan(1, 2, 3, 4, 5)).ToString());
            const long moreThanAMonthInTicks = TimeSpan.TicksPerDay*40;
            Assert.AreEqual(new EDBTimeSpan(moreThanAMonthInTicks).ToString(), new EDBTimeSpan(new TimeSpan(moreThanAMonthInTicks)).ToString());
        ...
        [Test]
        public void EDBDateConstructors()
        {
            EDBDate date;
            DateTime dateTime;
            ...
            date = new EDBDate(733557); // days since 1 Jan 1
            Assert.AreEqual(dateTime.Day, date.Day);
            Assert.AreEqual(dateTime.DayOfWeek, date.DayOfWeek);
            Assert.AreEqual(dateTime.DayOfYear, date.DayOfYear);
            Assert.AreEqual(calendar.IsLeapYear(2009), date.IsLeapYear);
            ...
            date = new EDBDate(new DateOnly(2012, 3, 4));
        ...
        [Test]
        public void EDBDateToString()
        {
            Assert.AreEqual("2009-05-31", new EDBDate(2009, 5, 31).ToString());

            Assert.AreEqual("0001-05-07 BC", new EDBDate(-1, 5, 7).ToString());
        ...
        [Test]
        public void EDBDateMath()
        {
            EDBDate date;

            // add a day to the empty constructor
            date = new EDBDate() + new EDBTimeSpan(0, 1, 0);
            ...
            date = new EDBDate(1, 1, 1) + new EDBTimeSpan(0, 1, 0);
            Assert.AreEqual(2, date.Day);
            Assert.AreEqual(DayOfWeek.Tuesday, date.DayOfWeek);
            Assert.AreEqual(2, date.DayOfYear);
            Assert.AreEqual(false, date.IsLeapYear);
            ...
            var diff = new EDBDate(1, 1, 1) - new EDBDate(-1, 12, 31);
            Assert.AreEqual(new EDBTimeSpan(0, 1, 0), diff);

            // Test of the addMonths method (positive values added)
            var dateForTestMonths = new EDBDate(2008, 1, 1);
            Assert.AreEqual(dateForTestMonths.AddMonths(0), dateForTestMonths);
            Assert.AreEqual(dateForTestMonths.AddMonths(4), new EDBDate(2008, 5, 1));
            Assert.AreEqual(dateForTestMonths.AddMonths(11), new EDBDate(2008, 12, 1));
            Assert.AreEqual(dateForTestMonths.AddMonths(12), new EDBDate(2009, 1, 1));
            Assert.AreEqual(dateForTestMonths.AddMonths(14), new EDBDate(2009, 3, 1));
            dateForTestMonths = new EDBDate(2008, 1, 31);
            Assert.AreEqual(dateForTestMonths.AddMonths(1), new EDBDate(2008, 2, 29));
            Assert.AreEqual(dateForTestMonths.AddMonths(13), new EDBDate(2009, 2, 28));

            // Test of the addMonths method (negative values added)
            dateForTestMonths = new EDBDate(2009, 1, 1);
            Assert.AreEqual(dateForTestMonths.AddMonths(0), dateForTestMonths);
            Assert.AreEqual(dateForTestMonths.AddMonths(-4), new EDBDate(2008, 9, 1));
            Assert.AreEqual(dateForTestMonths.AddMonths(-12), new EDBDate(2008, 1, 1));
            Assert.AreEqual(dateForTestMonths.AddMonths(-13), new EDBDate(2007, 12, 1));
            dateForTestMonths = new EDBDate(2009, 3, 31);
            Assert.AreEqual(dateForTestMonths.AddMonths(-1), new EDBDate(2009, 2, 28));
        ...
        public void EDBDateTimeMath()
        {
            ...
            Assert.That(new EDBDateTime(2020, 1, 1, 0, 0, 0).Add(new EDBTimeSpan(1, 2, 0)),
                Is.EqualTo(new EDBDateTime(2020, 2, 2, 0, 0, 0)));
            Assert.That(new EDBDateTime(2020, 1, 1, 0, 0, 0).Add(new EDBTimeSpan(0, -1, 0)),
                Is.EqualTo(new EDBDateTime(2019, 12, 31, 0, 0, 0)));
            Assert.That(new EDBDateTime(2020, 1, 1, 0, 0, 0).Add(new EDBTimeSpan(0, 0, 0)),
                Is.EqualTo(new EDBDateTime(2020, 1, 1, 0, 0, 0)));
            Assert.That(new EDBDateTime(2020, 1, 1, 0, 0, 0).Add(new EDBTimeSpan(0, 0, 10000000)),
