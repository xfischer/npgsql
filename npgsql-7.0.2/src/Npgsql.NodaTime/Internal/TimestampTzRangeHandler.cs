    ...
    IEDBTypeHandler<EDBRange<DateTime>>, IEDBTypeHandler<EDBRange<DateTimeOffset>>
{
    ...
    public int ValidateAndGetLength(Interval value, ref EDBLengthCache? lengthCache, EDBParameter? parameter)
        => ValidateAndGetLengthRange(
            new EDBRange<Instant>(value.HasStart ? value.Start : default, true, !value.HasStart, value.HasEnd ? value.End : default, false, !value.HasEnd), ref lengthCache, parameter);
    ...
    public Task Write(Interval value, EDBWriteBuffer buf, EDBLengthCache? lengthCache,
        ...
        => WriteRange(new EDBRange<Instant>(value.HasStart ? value.Start : default, true, !value.HasStart, value.HasEnd ? value.End : default, false, !value.HasEnd),
