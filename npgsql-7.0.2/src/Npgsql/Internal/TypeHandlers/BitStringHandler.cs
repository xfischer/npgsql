...
/// </remarks>
public partial class BitStringHandler : EDBTypeHandler<BitArray>,
    IEDBTypeHandler<BitVector32>, IEDBTypeHandler<bool>, IEDBTypeHandler<string>
{
    ...
    /// <inheritdoc />
    public override async Task Write(BitArray value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task Write(BitVector32 value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task Write(bool value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task Write(string value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
    {
        // Initial bitlength byte
        if (buf.WriteSpaceLeft < 4)
            await buf.Flush(async, cancellationToken);
