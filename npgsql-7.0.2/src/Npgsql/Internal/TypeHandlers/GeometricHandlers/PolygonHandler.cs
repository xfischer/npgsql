...
/// </remarks>
public partial class PolygonHandler : EDBTypeHandler<EDBPolygon>
{
    ...
    /// <inheritdoc />
    public override async Task Write(EDBPolygon value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
    {
