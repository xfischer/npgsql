...
#endif
{
    ...
    public override int ValidateObjectAndGetLength(object? value, ref EDBLengthCache? lengthCache, EDBParameter? parameter)
        => value switch
        {
            ...
            ImmutableDictionary<string, string?> converted => ((IEDBTypeHandler<ImmutableDictionary<string, string?>>)this).ValidateAndGetLength(converted, ref lengthCache, parameter),
#endif
            Dictionary<string, string?> converted => ((IEDBTypeHandler<Dictionary<string, string?>>)this).ValidateAndGetLength(converted, ref lengthCache, parameter),
            IDictionary<string, string?> converted => ((IEDBTypeHandler<IDictionary<string, string?>>)this).ValidateAndGetLength(converted, ref lengthCache, parameter),
    ...
    /// <inheritdoc />
    public async Task Write(IDictionary<string, string?> value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public override Task Write(Dictionary<string, string?> value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
    ...
    async ValueTask<T> ReadInto<T>(T dictionary, int numElements, EDBReadBuffer buf, bool async)
    ...
    /// <inheritdoc />
    public override async ValueTask<Dictionary<string, string?>> Read(EDBReadBuffer buf, int len, bool async,
    ...
    ValueTask<IDictionary<string, string?>> IEDBTypeHandler<IDictionary<string, string?>>.Read(
    ...
    public int ValidateAndGetLength(
        ImmutableDictionary<string, string?> value, ref EDBLengthCache? lengthCache, EDBParameter? parameter)
    ...
    public Task Write(ImmutableDictionary<string, string?> value,
        EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        => Write((IDictionary<string, string?>)value, buf, lengthCache, parameter, async, cancellationToken);

    async ValueTask<ImmutableDictionary<string, string?>> IEDBTypeHandler<ImmutableDictionary<string, string?>>.Read(
        EDBReadBuffer buf, int len, bool async, FieldDescription? fieldDescription)
    {
        await buf.Ensure(4, async);
        var numElements = buf.ReadInt32();
