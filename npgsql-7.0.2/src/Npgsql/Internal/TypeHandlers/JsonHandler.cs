...
/// </remarks>
public class JsonHandler : EDBTypeHandler<string>, ITextReaderHandler
{
    ...
    /// <inheritdoc />
    protected override async Task WriteWithLengthCustom<TAny>([DisallowNull] TAny value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public override async Task WriteObjectWithLength(object? value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    protected internal override async ValueTask<T> ReadCustom<T>(EDBReadBuffer buf, int byteLen, bool async, FieldDescription? fieldDescription = null)
    {
        if (_isJsonb)
        {
    ...
    /// <inheritdoc />
    public TextReader GetTextReader(Stream stream, EDBReadBuffer buffer)
    {
        if (_isJsonb)
        {
