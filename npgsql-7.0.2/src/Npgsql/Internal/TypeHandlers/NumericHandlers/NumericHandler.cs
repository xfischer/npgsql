...
/// </remarks>
public partial class NumericHandler : EDBTypeHandler<decimal>,
    IEDBTypeHandler<byte>, IEDBTypeHandler<short>, IEDBTypeHandler<int>, IEDBTypeHandler<long>,
    IEDBTypeHandler<float>, IEDBTypeHandler<double>, IEDBTypeHandler<BigInteger>
{
    ...
    /// <inheritdoc />
    public override async ValueTask<decimal> Read(EDBReadBuffer buf, int len, bool async, FieldDescription? fieldDescription = null)
    {
    ...
    async ValueTask<byte> IEDBTypeHandler<byte>.Read(EDBReadBuffer buf, int len, bool async, FieldDescription? fieldDescription)
        => (byte)await Read(buf, len, async, fieldDescription);

    async ValueTask<short> IEDBTypeHandler<short>.Read(EDBReadBuffer buf, int len, bool async, FieldDescription? fieldDescription)
        => (short)await Read(buf, len, async, fieldDescription);

    async ValueTask<int> IEDBTypeHandler<int>.Read(EDBReadBuffer buf, int len, bool async, FieldDescription? fieldDescription)
        => (int)await Read(buf, len, async, fieldDescription);

    async ValueTask<long> IEDBTypeHandler<long>.Read(EDBReadBuffer buf, int len, bool async, FieldDescription? fieldDescription)
        => (long)await Read(buf, len, async, fieldDescription);

    async ValueTask<float> IEDBTypeHandler<float>.Read(EDBReadBuffer buf, int len, bool async, FieldDescription? fieldDescription)
        => (float)await Read(buf, len, async, fieldDescription);

    async ValueTask<double> IEDBTypeHandler<double>.Read(EDBReadBuffer buf, int len, bool async, FieldDescription? fieldDescription)
        => (double)await Read(buf, len, async, fieldDescription);

    async ValueTask<BigInteger> IEDBTypeHandler<BigInteger>.Read(EDBReadBuffer buf, int len, bool async, FieldDescription? fieldDescription)
    {
        await buf.Ensure(4 * sizeof(short), async);
    ...
    /// <inheritdoc />
    public override int ValidateAndGetLength(decimal value, ref EDBLengthCache? lengthCache, EDBParameter? parameter)
    {
    ...
    /// <inheritdoc />
    public int ValidateAndGetLength(short value, ref EDBLengthCache? lengthCache, EDBParameter? parameter)
        => ValidateAndGetLength((decimal)value, ref lengthCache, parameter);
    /// <inheritdoc />
    public int ValidateAndGetLength(int value, ref EDBLengthCache? lengthCache, EDBParameter? parameter)
        => ValidateAndGetLength((decimal)value, ref lengthCache, parameter);
    /// <inheritdoc />
    public int ValidateAndGetLength(long value, ref EDBLengthCache? lengthCache, EDBParameter? parameter)
        => ValidateAndGetLength((decimal)value, ref lengthCache, parameter);
    /// <inheritdoc />
    public int ValidateAndGetLength(float value, ref EDBLengthCache? lengthCache, EDBParameter? parameter)
        => ValidateAndGetLength((decimal)value, ref lengthCache, parameter);
    /// <inheritdoc />
    public int ValidateAndGetLength(double value, ref EDBLengthCache? lengthCache, EDBParameter? parameter)
        => ValidateAndGetLength((decimal)value, ref lengthCache, parameter);
    /// <inheritdoc />
    public int ValidateAndGetLength(byte value, ref EDBLengthCache? lengthCache, EDBParameter? parameter)
        => ValidateAndGetLength((decimal)value, ref lengthCache, parameter);

    public override async Task Write(decimal value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
    {
        ...
        static void WriteInner(DecimalRaw raw, EDBWriteBuffer buf)
        {
            var weight = 0;
            var groupCount = 0;
    ...
    /// <inheritdoc />
    public Task Write(short value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        => Write((decimal)value, buf, lengthCache, parameter, async, cancellationToken);
    /// <inheritdoc />
    public Task Write(int value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        => Write((decimal)value, buf, lengthCache, parameter, async, cancellationToken);
    /// <inheritdoc />
    public Task Write(long value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        => Write((decimal)value, buf, lengthCache, parameter, async, cancellationToken);
    /// <inheritdoc />
    public Task Write(byte value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        => Write((decimal)value, buf, lengthCache, parameter, async, cancellationToken);
    /// <inheritdoc />
    public Task Write(float value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        => Write((decimal)value, buf, lengthCache, parameter, async, cancellationToken);
    /// <inheritdoc />
    public Task Write(double value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        => Write((decimal)value, buf, lengthCache, parameter, async, cancellationToken);
    ...
    public int ValidateAndGetLength(BigInteger value, ref EDBLengthCache? lengthCache, EDBParameter? parameter)
    {
        lengthCache ??= new EDBLengthCache(1);
        if (lengthCache.IsPopulated)
            return lengthCache.Get();
    ...
    public async Task Write(BigInteger value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async,
