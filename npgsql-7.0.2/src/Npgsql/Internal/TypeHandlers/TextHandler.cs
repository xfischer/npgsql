...
/// </remarks>
public partial class TextHandler : EDBTypeHandler<string>, IEDBTypeHandler<char[]>, IEDBTypeHandler<ArraySegment<char>>,
    IEDBTypeHandler<char>, IEDBTypeHandler<byte[]>, ITextReaderHandler
{
    ...
    public override ValueTask<string> Read(EDBReadBuffer buf, int byteLen, bool async, FieldDescription? fieldDescription = null)
    {
        ...
        static async ValueTask<string> ReadLong(EDBReadBuffer buf, int byteLen, bool async)
        {
            if (byteLen <= buf.Size)
            {
    ...
    async ValueTask<char> IEDBTypeHandler<char>.Read(EDBReadBuffer buf, int len, bool async, FieldDescription? fieldDescription)
    {
        ...
        unsafe char ReadCharCore()
        {
            ...
            if (charsUsed < 1)
                throw new EDBException("Could not read char - string was empty");
    ...
    ValueTask<byte[]> IEDBTypeHandler<byte[]>.Read(EDBReadBuffer buf, int byteLen, bool async, FieldDescription? fieldDescription)
    {
        ...
        static async ValueTask<byte[]> ReadLong(EDBReadBuffer buf, byte[] bytes, int byteLen, bool async)
        {
            if (byteLen <= buf.Size)
            {
    ...
    /// <inheritdoc />
    public override unsafe int ValidateAndGetLength(string value, [NotNullIfNotNull("lengthCache")] ref EDBLengthCache? lengthCache, EDBParameter? parameter)
    {
    ...
    /// <inheritdoc />
    public override Task Write(string value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
        => WriteString(value, buf, lengthCache!, parameter, async, cancellationToken);

    /// <inheritdoc />
    public virtual Task Write(char[] value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public virtual Task Write(ArraySegment<char> value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
    ...
    Task WriteString(string str, EDBWriteBuffer buf, EDBLengthCache lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task Write(char value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public virtual TextReader GetTextReader(Stream stream, EDBReadBuffer buffer)
    {
