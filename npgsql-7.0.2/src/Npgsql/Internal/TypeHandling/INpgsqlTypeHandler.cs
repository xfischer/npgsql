...
/// </summary>
public interface IEDBTypeHandler<T>
{
    /// <summary>
    ...
    ValueTask<T> Read(EDBReadBuffer buf, int len, bool async, FieldDescription? fieldDescription = null);
    ...
    int ValidateAndGetLength([DisallowNull] T value, ref EDBLengthCache? lengthCache, EDBParameter? parameter);
    ...
    /// </param>
    Task Write([DisallowNull] T value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async, CancellationToken cancellationToken = default);
}