...
public sealed partial class EDBConnectionStringBuilder : DbConnectionStringBuilder, IDictionary<string, object?>
{
    ...
    {
        get => false;
        set => throw new NotSupportedException("The Convert Infinity DateTime parameter is no longer supported; EDB 6.0 and above convert min/max values to Infinity by default. See https://www.npgsql.org/doc/types/datetime.html for more details.");
    }
    ...
    internal void PostProcessAndValidate()
    {
        ...
        if (TrustServerCertificate && SslMode is SslMode.Allow or SslMode.VerifyCA or SslMode.VerifyFull)
            throw new ArgumentException(EDBStrings.CannotUseTrustServerCertificate);
...
sealed class EDBConnectionStringPropertyAttribute : Attribute
{
    /// <summary>
