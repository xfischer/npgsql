...
public class EDBException : DbException
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EDBException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
    /// </summary>
    ...
    public EDBException(string? message, Exception? innerException)
        : base(message, innerException) {}

    /// <summary>
    /// Initializes a new instance of the <see cref="EDBException"/> class with a specified error message.
    /// </summary>
    ...
    /// </summary>
    public EDBBatchCommand? BatchCommand { get; set; }
#endif
    ...
    protected internal EDBException(SerializationInfo info, StreamingContext context) : base(info, context) {}
