...
using EnterpriseDB.EDBClient.Replication.Internal;
using EnterpriseDB.EDBClient.Replication.PgOutput.Messages;
...
sealed class PgOutputAsyncEnumerable : IAsyncEnumerable<PgOutputReplicationMessage>
{
    ...
    readonly EDBLogSequenceNumber? _walLocation;
    ...
    internal PgOutputAsyncEnumerable(
        ...
        EDBLogSequenceNumber? walLocation = null)
    {
        ...
        await foreach (var xLogData in stream.WithCancellation(cancellationToken))
        {
            ...
            case BackendReplicationMessageCode.Begin:
            {
                ...
                yield return _beginMessage.Populate(xLogData.WalStart, xLogData.WalEnd, xLogData.ServerClock,
                    transactionFinalLsn: new EDBLogSequenceNumber(buf.ReadUInt64()),
            ...
            case BackendReplicationMessageCode.Message:
            {
                ...
                var messageLsn = new EDBLogSequenceNumber(buf.ReadUInt64());
                ...
                var data = (EDBReadBuffer.ColumnStream)xLogData.Data;
            ...
            case BackendReplicationMessageCode.Commit:
            {
                ...
                yield return _commitMessage.Populate(
                    ...
                    commitLsn: new EDBLogSequenceNumber(buf.ReadUInt64()),
                    transactionEndLsn: new EDBLogSequenceNumber(buf.ReadUInt64()),
                    transactionCommitTimestamp: DateTimeUtils.DecodeTimestamp(buf.ReadInt64(), DateTimeKind.Utc));
                continue;
            }
            case BackendReplicationMessageCode.Origin:
            {
                ...
                yield return _originMessage.Populate(xLogData.WalStart, xLogData.WalEnd, xLogData.ServerClock,
                    originCommitLsn: new EDBLogSequenceNumber(buf.ReadUInt64()),
            ...
            case BackendReplicationMessageCode.StreamCommit:
            {
                ...
                yield return _streamCommitMessage.Populate(xLogData.WalStart, xLogData.WalEnd, xLogData.ServerClock,
                    transactionXid: buf.ReadUInt32(), flags: buf.ReadByte(), commitLsn: new EDBLogSequenceNumber(buf.ReadUInt64()),
                    transactionEndLsn: new EDBLogSequenceNumber(buf.ReadUInt64()),
                    transactionCommitTimestamp: DateTimeUtils.DecodeTimestamp(buf.ReadInt64(), DateTimeKind.Utc));
                continue;
            }
            ...
            case BackendReplicationMessageCode.BeginPrepare:
            {
                ...
                yield return _beginPrepareMessage.Populate(xLogData.WalStart, xLogData.WalEnd, xLogData.ServerClock,
                    prepareLsn: new EDBLogSequenceNumber(buf.ReadUInt64()),
                    prepareEndLsn: new EDBLogSequenceNumber(buf.ReadUInt64()),
            ...
            case BackendReplicationMessageCode.CommitPrepared:
            {
                ...
                yield return _commitPreparedMessage.Populate(xLogData.WalStart, xLogData.WalEnd, xLogData.ServerClock,
                    ...
                    commitPreparedLsn: new EDBLogSequenceNumber(buf.ReadUInt64()),
                    commitPreparedEndLsn: new EDBLogSequenceNumber(buf.ReadUInt64()),
                    transactionCommitTimestamp: DateTimeUtils.DecodeTimestamp(buf.ReadInt64(), DateTimeKind.Utc),
                    transactionXid: buf.ReadUInt32(),
                    transactionGid: buf.ReadNullTerminatedString());
                continue;
            ...
            case BackendReplicationMessageCode.RollbackPrepared:
            {
                ...
                yield return _rollbackPreparedMessage.Populate(xLogData.WalStart, xLogData.WalEnd, xLogData.ServerClock,
                    ...
                    preparedTransactionEndLsn: new EDBLogSequenceNumber(buf.ReadUInt64()),
                    rollbackPreparedEndLsn: new EDBLogSequenceNumber(buf.ReadUInt64()),
                    transactionPrepareTimestamp: DateTimeUtils.DecodeTimestamp(buf.ReadInt64(), DateTimeKind.Utc),
