...
public class ReplicationValue
{
    ...
    /// </summary>
    readonly EDBReadBuffer.ColumnStream _columnStream;

    internal ReplicationValue(EDBConnector connector)
    {
        _readBuffer = connector.ReadBuffer;
        _columnStream = new EDBReadBuffer.ColumnStream(connector, startCancellableOperations: false);
    }
