...
public sealed class PhysicalReplicationConnection : ReplicationConnection
{
    ...
    /// <returns>A <see cref="Task{T}"/> representing an <see cref="IAsyncEnumerable{EDBXLogDataMessage}"/> that
    ...
    public IAsyncEnumerable<XLogDataMessage> StartReplication(PhysicalReplicationSlot? slot,
        EDBLogSequenceNumber walLocation,
    ...
    public IAsyncEnumerable<XLogDataMessage> StartReplication(
        EDBLogSequenceNumber walLocation, CancellationToken cancellationToken, ulong timeline = default)
