...
public class PhysicalReplicationSlot : ReplicationSlot
{
    ...
    public PhysicalReplicationSlot(string slotName, EDBLogSequenceNumber? restartLsn = null, ulong? restartTimeline = null)
        : base(slotName)
    {
    ...
    /// </summary>
    public EDBLogSequenceNumber? RestartLsn { get; }
