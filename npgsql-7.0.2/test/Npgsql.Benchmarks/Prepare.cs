...
{
    EDBConnection _conn = default!, _autoPreparingConn = default!;
    static readonly string[] Queries;
    string _query = default!;
    EDBCommand _preparedCmd = default!;
    ...
    public void GlobalSetup()
    {
        ...
        _autoPreparingConn = new EDBConnection(new EDBConnectionStringBuilder(BenchmarkEnvironment.ConnectionString)
        {
            MaxAutoPrepare = 10
        }.ToString());
...
";
        ...
        _preparedCmd = new EDBCommand(_query, _conn);
...
";
    ...
    {
        using (var cmd = new EDBCommand(_query, _conn))
    ...
    {
        using (var cmd = new EDBCommand(_query, _autoPreparingConn))
            return cmd.ExecuteScalar()!;
    }
