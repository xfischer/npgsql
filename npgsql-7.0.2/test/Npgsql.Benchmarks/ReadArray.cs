...
public class ReadArrays
{
    ...
    EDBConnection _intConn = default!;
    EDBCommand _intCmd = default!;
    EDBDataReader _intReader = default!;

    EDBConnection _nullableIntConn = default!;
    EDBCommand _nullableIntCmd = default!;
    EDBDataReader _nullableIntReader = default!;

    EDBConnection _stringConn = default!;
    EDBCommand _stringCmd = default!;
    EDBDataReader _stringReader = default!;
    ...
    public void Setup()
    {
        ...
        _intCmd = new EDBCommand("SELECT @p1", _intConn);
        ...
        _nullableIntCmd = new EDBCommand("SELECT @p1", _nullableIntConn);
        ...
        _stringCmd = new EDBCommand("SELECT @p1", _stringConn);
