...
public abstract class TypeHandlerBenchmarks<T>
{
    ...
    protected TypeHandlerBenchmarks(EDBTypeHandler handler)
    {
        ...
        _readBuffer = new EDBReadBuffer(null, _stream, null, EDBReadBuffer.MinimumSize, Encoding.UTF8, PGUtil.RelaxedUTF8Encoding);
        _writeBuffer = new EDBWriteBuffer(null, _stream, null, EDBWriteBuffer.MinimumSize, Encoding.UTF8);
    }
