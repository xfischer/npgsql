...
public class NodaTimeTests : TestBase
{
    ...
    [Test]
    public Task Tsrange_as_EDBRange_of_LocalDateTime()
        => AssertType(
    ...
    [Test]
    public Task Daterange_as_EDBRange_of_LocalDate()
        => AssertType(
    ...
    public Task Interval_as_Duration_with_months_fails()
        => AssertTypeUnsupportedRead<Duration, EDBException>("2 months", "interval");
