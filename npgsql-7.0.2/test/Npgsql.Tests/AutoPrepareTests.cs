...
SELECT COUNT(*) FROM pg_prepared_statements
    ...
    public async Task Auto_prepared_command_failure()
    {
        ...
        using (var command = new EDBCommand($"INSERT INTO {tableName} (id) VALUES (1)", conn))
        {
            await command.ExecuteNonQueryAsync();
    ...
    public void Replace_with_bad_sql()
    {
        ...
        // Since PreparedStatementManager.NumPrepared is 0, EDB will now send DISCARD ALL, but our internal state thinks
