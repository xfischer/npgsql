...
{
    [Test, Description("Makes sure that when EDBDbType or Value/NpgsqlValue are set, DbType and EDBDbType are set accordingly")]
    ...
    {
        var p = new EDBParameter("p1", new Dictionary<string, string>());
