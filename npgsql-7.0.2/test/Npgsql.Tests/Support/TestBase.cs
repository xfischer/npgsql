...
public abstract class TestBase
{
        ...
        Func<T, T, bool>? comparer = null)
    {
        ...
        return await AssertType(
            ...
            isDefault, isEDBDbTypeInferredFromClrType, comparer);
    }
        ...
        Func<T, T, bool>? comparer = null)
    {
        ...
        return await AssertType(connection, value, sqlLiteral, pgTypeName, npgsqlDbType, dbType, inferredDbType, isDefaultForReading,
            isDefaultForWriting, isDefault, isEDBDbTypeInferredFromClrType);
    }
        ...
        Func<T, T, bool>? comparer = null)
    {
        ...
        await AssertTypeWrite(connection, () => value, sqlLiteral, pgTypeName, npgsqlDbType, dbType, inferredDbType, isDefaultForWriting, isEDBDbTypeInferredFromClrType);
    ...
    protected static readonly EDBDataSource SharedDataSource = EDBDataSource.Create(TestUtil.ConnectionString);
    ...
    protected virtual EDBDataSource CreateDataSource()
        => EDBDataSource.Create(TestUtil.ConnectionString);
