...
#pragma warning restore CS8602 // Dereference of a possibly null reference.
		...
		public void test_bytea_three_in_with_numeric()
		{
			try
			{
				...
				EDBCommand cmd = new EDBCommand("test_bytea_three_in_with_numeric(:imgin,:imgout,:img3,:num)",conn);
				cmd.CommandType= CommandType.StoredProcedure;

				cmd.Parameters.Add(new EDBParameter("imgin", EDBTypes.EDBDbType.Bytea,10000,"imgin",ParameterDirection.Input,false ,2,2,System.Data.DataRowVersion.Current,null));
				cmd.Parameters.Add(new EDBParameter("imgout", EDBTypes.EDBDbType.Bytea,10000,"imgout",ParameterDirection.Input,false ,2,2,System.Data.DataRowVersion.Current,null));
				cmd.Parameters.Add(new EDBParameter("img3", EDBTypes.EDBDbType.Bytea,10000,"img3",ParameterDirection.Input,false ,2,2,System.Data.DataRowVersion.Current,null));
				cmd.Parameters.Add(new EDBParameter("num", EDBTypes.EDBDbType.Numeric,100,"num",ParameterDirection.Input,false ,2,2,System.Data.DataRowVersion.Current,null));
				cmd.Prepare();
		...
		public void test_bytea_three_in()
		{
			try
			{
				...
				EDBCommand cmd = new EDBCommand("test_bytea_three_in(:imgin,:imgout,:img3)",conn);
				cmd.CommandType= CommandType.StoredProcedure;
		...
		public void test_bytea_in_in()
		{
			try
			{
				...
				cmd.Parameters.Add(new EDBParameter("imgin", EDBTypes.EDBDbType.Bytea,10000,"imgin",ParameterDirection.Input,false ,2,2,System.Data.DataRowVersion.Current,null));
				cmd.Parameters.Add(new EDBParameter("imgout", EDBTypes.EDBDbType.Numeric,100,"imgout",ParameterDirection.Input,true ,2,2,System.Data.DataRowVersion.Current,1));
		...
		public void test_bytea_two_in()
		{
			...
			try
			{
				...
				EDBCommand cmd = new EDBCommand("test_bytea_two_in(:imgin,:imgout)",conn);
				cmd.CommandType= CommandType.StoredProcedure;
		...
		*/
		...
		public void testa_bytea_out_two_with_num_varchar1()
		{
			...
			try
			{
				...
				cmd.Parameters.Add(new EDBParameter("imgout", EDBTypes.EDBDbType.Bytea,10000,"imgout",ParameterDirection.Output,false ,2,2,System.Data.DataRowVersion.Current,null));
				cmd.Parameters.Add(new EDBParameter("imgout1", EDBTypes.EDBDbType.Bytea,10000,"imgout1",ParameterDirection.Output,false ,2,2,System.Data.DataRowVersion.Current,null));
				cmd.Parameters.Add(new EDBParameter("num", EDBTypes.EDBDbType.Numeric,10,"num",ParameterDirection.InputOutput,false ,2,2,System.Data.DataRowVersion.Current,null));
				cmd.Parameters.Add(new EDBParameter("var", EDBTypes.EDBDbType.Varchar,10,"var",ParameterDirection.InputOutput,false ,2,2,System.Data.DataRowVersion.Current,null));
				cmd.Prepare();
				cmd.Parameters[2].Value = 100;
				EDBDataReader reader = cmd.ExecuteReader();
...
//				conn.Close();
		...
		public void testa_bytea_inout_two_with_numinout_varchar()
		{
			try
			{
				EDBCommand cmd = new EDBCommand("test_bytea_inout_two_with_numinout_varchar(:imgout,:imgout1,:num,:var,:imgout2)",conn);
				cmd.CommandType= CommandType.StoredProcedure;
				cmd.Parameters.Add(new EDBParameter("imgout", EDBTypes.EDBDbType.Bytea,10000,"imgout",ParameterDirection.Output,false ,2,2,System.Data.DataRowVersion.Current,null));
				cmd.Parameters.Add(new EDBParameter("imgout1", EDBTypes.EDBDbType.Bytea,10000,"imgout1",ParameterDirection.Output,false ,2,2,System.Data.DataRowVersion.Current,null));
				cmd.Parameters.Add(new EDBParameter("num", EDBTypes.EDBDbType.Numeric,10,"num",ParameterDirection.InputOutput,false ,2,2,System.Data.DataRowVersion.Current,null));
				cmd.Parameters.Add(new EDBParameter("var", EDBTypes.EDBDbType.Varchar,10,"var",ParameterDirection.InputOutput,false ,2,2,System.Data.DataRowVersion.Current,null));
				cmd.Parameters.Add(new EDBParameter("imgout2", EDBTypes.EDBDbType.Bytea,10,"imgout2",ParameterDirection.Output,false ,2,2,System.Data.DataRowVersion.Current,null));
				cmd.Prepare();
				cmd.Parameters[2].Value = 100;
				EDBDataReader reader = cmd.ExecuteReader();
				reader.Read(); 
