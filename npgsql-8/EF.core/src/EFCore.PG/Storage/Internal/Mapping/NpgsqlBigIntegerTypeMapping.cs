...
public class NpgsqlBigIntegerTypeMapping : NpgsqlTypeMapping
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static NpgsqlBigIntegerTypeMapping Default { get; } = new();
    ...
    public NpgsqlBigIntegerTypeMapping()
        : base("numeric", typeof(BigInteger), EDBDbType.Numeric, jsonValueReaderWriter: JsonBigIntegerReaderWriter.Instance)
    {
    }
