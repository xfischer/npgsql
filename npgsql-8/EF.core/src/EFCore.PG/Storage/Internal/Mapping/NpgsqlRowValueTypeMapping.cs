...
public class NpgsqlRowValueTypeMapping : RelationalTypeMapping
{
    ...
    protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
        => new NpgsqlRowValueTypeMapping(parameters);
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    // SQL generation for row values is in NpgsqlQuerySqlGenerator
    protected override string GenerateNonNullSqlLiteral(object value)
        => throw new InvalidOperationException("GenerateNonNullSqlLiteral not supported on NpgsqlRowValueTypeMapping");
    ...
    protected override void ConfigureParameter(DbParameter parameter)
        => throw new InvalidOperationException("ConfigureParameter not supported on NpgsqlRowValueTypeMapping");
}
