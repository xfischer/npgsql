...
public class JsonTypesNpgsqlTest : JsonTypesRelationalTestBase
{
    ...
    public virtual void Can_read_write_LogSequenceNumber_JSON_values(ulong value, string json)
        => Can_read_and_write_JSON_value<LogSequenceNumberType, EDBLogSequenceNumber>(
    ...
    {
        public EDBLogSequenceNumber LogSequenceNumber { get; set; }
    }
...
#pragma warning disable CS0618 // EDBConnection.GlobalTypeMapper is obsolete
        ...
        EDBConnection.GlobalTypeMapper.MapEnum<Mood>("test.mapped_enum");
