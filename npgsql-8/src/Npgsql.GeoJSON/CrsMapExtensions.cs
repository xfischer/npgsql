...
public static class CrsMapExtensions
{
    ...
    public static async Task<CrsMap> GetCrsMapAsync(this EDBDataSource dataSource)
    {
    ...
    /// </summary>
    /// <param name="dataSource"></param>
    public static CrsMap GetCrsMap(this EDBDataSource dataSource)
    {
        var builder = new CrsMapBuilder();
        using var cmd = GetCsrCommand(dataSource);
    ...
    static EDBCommand GetCsrCommand(EDBDataSource dataSource)
