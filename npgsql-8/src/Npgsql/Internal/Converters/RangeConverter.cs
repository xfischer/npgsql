...
sealed class RangeConverter<TSubtype> : PgStreamingConverter<EDBRange<TSubtype>>
{
    ...
    public override EDBRange<TSubtype> Read(PgReader reader)
        => Read(async: false, reader, CancellationToken.None).GetAwaiter().GetResult();

    public override ValueTask<EDBRange<TSubtype>> ReadAsync(PgReader reader, CancellationToken cancellationToken = default)
        => Read(async: true, reader, cancellationToken);

    async ValueTask<EDBRange<TSubtype>> Read(bool async, PgReader reader, CancellationToken cancellationToken)
    {
        ...
        if ((flags & RangeFlags.Empty) != 0)
            return EDBRange<TSubtype>.Empty;
        ...
        return new EDBRange<TSubtype>(lowerBound, upperBound, flags);
    }

    public override Size GetSize(SizeContext context, EDBRange<TSubtype> value, ref object? writeState)
    {
    ...
    public override void Write(PgWriter writer, EDBRange<TSubtype> value)
        => Write(async: false, writer, value, CancellationToken.None).GetAwaiter().GetResult();

    public override ValueTask WriteAsync(PgWriter writer, EDBRange<TSubtype> value, CancellationToken cancellationToken = default)
        => Write(async: true, writer, value, cancellationToken);

    async ValueTask Write(bool async, PgWriter writer, EDBRange<TSubtype> value, CancellationToken cancellationToken)
    {
