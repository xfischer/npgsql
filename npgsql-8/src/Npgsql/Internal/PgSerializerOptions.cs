...
public sealed class PgSerializerOptions
{
    ...
    internal PgSerializerOptions(EDBDatabaseInfo databaseInfo, PgTypeInfoResolverChain? resolverChain = null, Func<string>? timeZoneProvider = null)
    {
    ...
    internal EDBDatabaseInfo DatabaseInfo { get; }
    ...
    public IEDBNameTranslator DefaultNameTranslator { get; init; } = EDBSnakeCaseNameTranslator.Instance;
