...
static partial class LogMessages
{
    ...
    [LoggerMessage(
        EventId = EDBEventId.OpeningConnection,
        Level = LogLevel.Trace,
    ...
    [LoggerMessage(
        EventId = EDBEventId.OpenedConnection,
    ...
    [LoggerMessage(
        EventId = EDBEventId.ClosingConnection,
        Level = LogLevel.Trace,
    ...
    [LoggerMessage(
        EventId = EDBEventId.ClosedConnection,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = EDBEventId.OpeningPhysicalConnection,
        Level = LogLevel.Trace,
    ...
    [LoggerMessage(
        EventId = EDBEventId.OpenedPhysicalConnection,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = EDBEventId.ClosingPhysicalConnection,
        Level = LogLevel.Trace,
    ...
    [LoggerMessage(
        EventId = EDBEventId.ClosedPhysicalConnection,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = EDBEventId.StartingWait,
    ...
    [LoggerMessage(
        EventId = EDBEventId.ReceivedNotice,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = EDBEventId.ConnectionExceededMaximumLifetime,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = EDBEventId.CaughtUserExceptionInNoticeEventHandler,
    ...
    [LoggerMessage(
        EventId = EDBEventId.CaughtUserExceptionInNotificationEventHandler,
        Level = LogLevel.Error,
    ...
    [LoggerMessage(
        EventId = EDBEventId.ExceptionWhenClosingPhysicalConnection,
    ...
    [LoggerMessage(
        EventId = EDBEventId.ExceptionWhenOpeningConnectionForMultiplexing,
        Level = LogLevel.Error,
    ...
    [LoggerMessage(
        EventId = EDBEventId.ExecutingCommand,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = EDBEventId.CommandExecutionCompleted,
        Level = LogLevel.Information,
    ...
    [LoggerMessage(
        EventId = EDBEventId.PreparingCommandExplicitly,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = EDBEventId.ExceptionWhenWritingMultiplexedCommands,
        Level = LogLevel.Error,
    ...
    [LoggerMessage(
        EventId = EDBEventId.RolledBackToSavepoint,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = EDBEventId.ReleasedSavepoint,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = EDBEventId.ExceptionDuringTransactionDispose,
        Level = LogLevel.Error,
    ...
    [LoggerMessage(
        EventId = EDBEventId.EnlistedVolatileResourceManager,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = EDBEventId.CommittingSinglePhaseTransaction,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = EDBEventId.RollingBackSinglePhaseTransaction,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = EDBEventId.SinglePhaseTransactionRollbackFailed,
        Level = LogLevel.Error,
    ...
    [LoggerMessage(
        EventId = EDBEventId.PreparingTwoPhaseTransaction,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = EDBEventId.CommittingTwoPhaseTransaction,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = EDBEventId.TwoPhaseTransactionCommitFailed,
        Level = LogLevel.Error,
    ...
    [LoggerMessage(
        EventId = EDBEventId.RollingBackTwoPhaseTransaction,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = EDBEventId.TwoPhaseTransactionRollbackFailed,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = EDBEventId.TwoPhaseTransactionInDoubt,
        Level = LogLevel.Warning,
    ...
    [LoggerMessage(
        EventId = EDBEventId.ConnectionInUseWhenRollingBack,
        Level = LogLevel.Warning,
    ...
    [LoggerMessage(
        EventId = EDBEventId.CleaningUpResourceManager,
        Level = LogLevel.Trace,
    ...
    [LoggerMessage(
        EventId = EDBEventId.CreatingReplicationSlot,
        Level = LogLevel.Information,
    ...
    [LoggerMessage(
        EventId = EDBEventId.DroppingReplicationSlot,
        Level = LogLevel.Information,
    ...
    [LoggerMessage(
        EventId = EDBEventId.StartingLogicalReplication,
        Level = LogLevel.Information,
    ...
    [LoggerMessage(
        EventId = EDBEventId.StartingPhysicalReplication,
        Level = LogLevel.Information,
    ...
    [LoggerMessage(
        EventId = EDBEventId.ExecutingReplicationCommand,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = EDBEventId.ReceivedReplicationPrimaryKeepalive,
        Level = LogLevel.Trace,
    ...
    internal static partial void ReceivedReplicationPrimaryKeepalive(ILogger logger, EDBLogSequenceNumber EndLsn, DateTime Timestamp, int ConnectorId);

    [LoggerMessage(
        EventId = EDBEventId.SendingReplicationStandbyStatusUpdate,
        Level = LogLevel.Trace,
    ...
    [LoggerMessage(
        EventId = EDBEventId.SentReplicationFeedbackMessage,
        Level = LogLevel.Trace,
    ...
    internal static partial void SentReplicationFeedbackMessage(
        ILogger logger,
        EDBLogSequenceNumber LastReceivedLsn,
        EDBLogSequenceNumber LastFlushedLsn,
        EDBLogSequenceNumber LastAppliedLsn,
        DateTime Timestamp,
        int ConnectorId);

    [LoggerMessage(
        EventId = EDBEventId.ReplicationFeedbackMessageSendingFailed,
        Level = LogLevel.Error,
