...
public sealed class EDBNestedDataReader : DbDataReader
{
    ...
    /// <inheritdoc />
    [UnconditionalSuppressMessage("ILLink", "IL2093", Justification = "No members are dynamically accessed by EDB .NET Connector via EDBNestedDataReader.GetFieldType.")]
