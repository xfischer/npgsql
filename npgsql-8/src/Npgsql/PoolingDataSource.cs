...
class PoolingDataSource : EDBDataSource
{
    ...
    readonly EDBMultiHostDataSource? _parentPool;
    ...
    internal PoolingDataSource(
        ...
        EDBMultiHostDataSource? parentPool = null)
        : base(settings, dataSourceConfig)
    {
        ...
        Connectors = new EDBConnector[MaxConnections];
        ...
        EDBConnection conn, EDBTimeout timeout, bool async, CancellationToken cancellationToken)
    {
        ...
        for (var numConnectors = _numConnectors; numConnectors < MaxConnections; numConnectors = _numConnectors)
        {
            ...
            try
            {
                ...
                // on EDBConnector.Open due to timeout, CancellationToken or other reasons.
