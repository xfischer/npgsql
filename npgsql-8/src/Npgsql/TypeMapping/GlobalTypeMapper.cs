...
sealed class GlobalTypeMapper : IEDBTypeMapper
{
    ...
    public void AddTypeInfoResolverFactory(PgTypeInfoResolverFactory factory)
    {
        ...
        try
        {
            ...
            // Since EFCore.PG plugins (and possibly other users) repeatedly call EDBConnection.GlobalTypeMapper.UseNodaTime,
    ...
    /// <inheritdoc />
    public IEDBTypeMapper ConfigureJsonOptions(JsonSerializerOptions serializerOptions)
    {
    ...
    public IEDBTypeMapper EnableDynamicJson(
    ...
    /// <inheritdoc />
    public IEDBTypeMapper MapEnum<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] TEnum>(string? pgName = null, IEDBNameTranslator? nameTranslator = null) where TEnum : struct, Enum
    {
        _lock.EnterWriteLock();
        try
        {
    ...
    /// <inheritdoc />
    public bool UnmapEnum<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] TEnum>(string? pgName = null, IEDBNameTranslator? nameTranslator = null) where TEnum : struct, Enum
    {
        _lock.EnterWriteLock();
        try
        {
    ...
    public IEDBTypeMapper MapComposite<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.PublicProperties | DynamicallyAccessedMemberTypes.PublicFields)]  T>(string? pgName = null, IEDBNameTranslator? nameTranslator = null)
        => MapComposite(typeof(T), pgName, nameTranslator);

    /// <inheritdoc />
    [RequiresDynamicCode("Mapping composite types involves serializing arbitrary types which can require creating new generic types or methods. This is currently unsupported with NativeAOT, vote on issue #5303 if this is important to you.")]
    public bool UnmapComposite<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.PublicProperties | DynamicallyAccessedMemberTypes.PublicFields)]  T>(string? pgName = null, IEDBNameTranslator? nameTranslator = null)
