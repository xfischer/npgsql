...
/// </summary>
/// <remarks>
/// The preferred way to manage type mappings is on <see cref="EDBDataSourceBuilder" />. An alternative, but discouraged, method, is to
/// manage them globally via <see cref="EDBConnection.GlobalTypeMapper"/>).
/// </remarks>
public interface IEDBTypeMapper
{
    /// <summary>
    /// The default name translator to convert CLR type names and member names. Defaults to <see cref="EDBSnakeCaseNameTranslator"/>.
    /// </summary>
    IEDBNameTranslator DefaultNameTranslator { get; set; }
    ...
    IEDBTypeMapper MapEnum<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] TEnum>(
        string? pgName = null,
    ...
    IEDBTypeMapper MapComposite<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.PublicProperties | DynamicallyAccessedMemberTypes.PublicFields)] T>(
        string? pgName = null,
        IEDBNameTranslator? nameTranslator = null);
    ...
    /// <returns></returns>
    IEDBTypeMapper ConfigureJsonOptions(JsonSerializerOptions serializerOptions);
    ...
    IEDBTypeMapper EnableDynamicJson(Type[]? jsonbClrTypes = null, Type[]? jsonClrTypes = null);
    ...
    IEDBTypeMapper EnableRecordsAsTuples();
    ...
    IEDBTypeMapper EnableUnmappedTypes();
