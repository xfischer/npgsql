...
namespace EnterpriseDB.EDBClient.Tests
{
    internal static class NetFrameworkShims
    {
        ...
        internal static bool StartsWith(this string s, char c) => s.StartsWith(c.ToString());
        internal static bool EndsWith(this string s, char c) => s.EndsWith(c.ToString());

        internal static Task CopyToAsync(this Stream source, Stream destination, CancellationToken cancellationToken)
        ...
        public static DateTime UnixEpoch()
        {
            ...
            const long UnixEpochTicks = 719162 * TicksPerDay;
            return new DateTime(UnixEpochTicks, DateTimeKind.Utc);
        }
#endif
    }
}
