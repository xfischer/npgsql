...
class PgServerMock : IDisposable
{
    ...
    static readonly Encoding Encoding = EDBWriteBuffer.UTF8Encoding;
    ...
    internal EDBReadBuffer ReadBuffer => _readBuffer;
    internal EDBWriteBuffer WriteBuffer => _writeBuffer;

    internal PgServerMock(
        NetworkStream stream,
        EDBReadBuffer readBuffer,
