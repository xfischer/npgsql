...
/// <summary>
///     Represents a plugin that configures an <see cref="EDBDataSource" /> via <see cref="EDBDataSourceBuilder" />.
/// </summary>
/// <remarks>
///     <para>
...
public interface INpgsqlDataSourceConfigurationPlugin
{
    ...
    /// </summary>
    void Configure(EDBDataSourceBuilder npgsqlDataSourceBuilder);
}
