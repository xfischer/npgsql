...
public class NpgsqlTsRankingNormalizationTypeMapping : IntTypeMapping
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static new NpgsqlTsRankingNormalizationTypeMapping Default { get; } = new();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public NpgsqlTsRankingNormalizationTypeMapping()
        : base(
            new RelationalTypeMappingParameters(
                new CoreTypeMappingParameters(
                    typeof(NpgsqlTsRankingNormalization), new EnumToNumberConverter<NpgsqlTsRankingNormalization, int>()),
                "integer"))
    {
    }
