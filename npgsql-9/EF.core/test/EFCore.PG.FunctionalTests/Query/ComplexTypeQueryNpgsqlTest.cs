...
public class ComplexTypeQueryNpgsqlTest : ComplexTypeQueryRelationalTestBase<
    ComplexTypeQueryNpgsqlTest.ComplexTypeQueryNpgsqlFixture>
{
    public ComplexTypeQueryNpgsqlTest(ComplexTypeQueryNpgsqlFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
ORDER BY t."Id" NULLS FIRST, t."Id0" NULLS FIRST
LIMIT @__p_0
""");
    }
...
ORDER BY t1."Id" NULLS FIRST, t1."Id0" NULLS FIRST
LIMIT @__p_0
""");
    }
...
ORDER BY t."BillingAddress_ZipCode" NULLS FIRST, t."BillingAddress_ZipCode0" NULLS FIRST
LIMIT @__p_0
""");
    }
...
ORDER BY t1."BillingAddress_ZipCode" NULLS FIRST, t1."BillingAddress_ZipCode0" NULLS FIRST
LIMIT @__p_0
""");
    }
...
""");
    ...
    public class ComplexTypeQueryNpgsqlFixture : ComplexTypeQueryRelationalFixtureBase
    {
