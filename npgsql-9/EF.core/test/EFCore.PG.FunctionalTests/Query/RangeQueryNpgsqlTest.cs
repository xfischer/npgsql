...
""");
    ...
    {
        using var context = CreateContext();
        var result = context.RangeTestEntities.Single(x => x.IntRange.Intersect(new EDBRange<int>(1, 2)).IsEmpty);
        Assert.Equal(2, result.Id);
...
""");
    ...
    {
        using var context = CreateContext();
        var result = context.RangeTestEntities.Single(x => x.IntRange.Merge(new EDBRange<int>(12, 13)) == new EDBRange<int>(1, 13));
        Assert.Equal(1, result.Id);
        ...
        public static void Seed(RangeContext context)
        {
            context.RangeTestEntities.AddRange(
                new RangeTestEntity
                {
                    ...
                    DateOnlyDateRange = new EDBRange<DateOnly>(new DateOnly(2020, 1, 1), new DateOnly(2020, 1, 10)),
                    DateTimeDateRange = new EDBRange<DateTime>(new DateTime(2020, 1, 1), new DateTime(2020, 1, 10)),
                ...
                new RangeTestEntity
                {
                    ...
                    DateOnlyDateRange = new EDBRange<DateOnly>(new DateOnly(2020, 1, 5), new DateOnly(2020, 1, 15)),
                    DateTimeDateRange = new EDBRange<DateTime>(new DateTime(2020, 1, 5), new DateTime(2020, 1, 15)),
