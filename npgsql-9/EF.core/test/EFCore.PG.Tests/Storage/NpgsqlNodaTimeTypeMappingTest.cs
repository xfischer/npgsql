...
public class NpgsqlNodaTimeTypeMappingTest
{
    ...
    public void GenerateSqlLiteral_returns_tsrange_literal()
    {
        ...
        var value = new EDBRange<LocalDateTime>(new LocalDateTime(2020, 1, 1, 12, 0, 0), new LocalDateTime(2020, 1, 2, 12, 0, 0));
    ...
    public void Array_of_NpgsqlRange_of_LocalDateTime_is_properly_mapped()
    {
        ...
        Assert.Same(typeof(List<EDBRange<LocalDateTime>>), GetMapping("tsmultirange").ClrType);
    }
    ...
    public void GenerateSqlLiteral_returns_daterange_LocalDate_literal()
    {
        ...
        var value = new EDBRange<LocalDate>(new LocalDate(2020, 1, 1), new LocalDate(2020, 1, 2));
