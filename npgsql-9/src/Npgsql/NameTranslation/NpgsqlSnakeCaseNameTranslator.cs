...
/// names (some_class)
/// </summary>
public sealed class EDBSnakeCaseNameTranslator : IEDBNameTranslator
{
    internal static EDBSnakeCaseNameTranslator Instance { get; } = new();

    readonly CultureInfo _culture;

    /// <summary>
    /// Creates a new <see cref="EDBSnakeCaseNameTranslator"/>.
    /// </summary>
    /// <param name="culture">
    ...
    /// </param>
    public EDBSnakeCaseNameTranslator(CultureInfo? culture = null)
        : this(false, culture) { }
    ...
    /// If <see langword="null"/> then <see cref="CultureInfo.InvariantCulture"/> will be used.
    /// </param>
    public EDBSnakeCaseNameTranslator(bool legacyMode, CultureInfo? culture = null)
    {
