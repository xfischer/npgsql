...
public class EDBBatch : DbBatch
{
    ...
    private protected EDBCommand Command { get; }
    ...
    /// </para>
    /// <para>
    ///     To control error barriers on a command-by-command basis, see <see cref="EDBBatchCommand.AppendErrorBarrier" />.
    /// </para>
    /// </remarks>
    ...
    internal static EDBBatch CreateCachedBatch(EDBConnection connection)
    {
        var batch = new EDBBatch(connection);
