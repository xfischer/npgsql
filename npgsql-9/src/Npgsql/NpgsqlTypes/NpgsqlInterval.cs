...
/// </p>
/// </remarks>
public readonly struct EDBInterval : IEquatable<EDBInterval>
{
    /// <summary>
    /// Constructs an <see cref="EDBInterval"/>.
    /// </summary>
    public EDBInterval(int months, int days, long time)
    ...
    public override bool Equals(object? obj)
        => obj is EDBInterval other && Equals(other);
