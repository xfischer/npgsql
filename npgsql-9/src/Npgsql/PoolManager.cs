...
/// </summary>
/// <remarks>
/// Note that pools created directly as <see cref="EDBDataSource" /> are referenced directly by users, and aren't managed here.
/// </remarks>
static class PoolManager
{
    internal static ConcurrentDictionary<string, EDBDataSource> Pools { get; } = new();
