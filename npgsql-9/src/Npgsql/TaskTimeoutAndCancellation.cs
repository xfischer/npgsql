...
static class TaskTimeoutAndCancellation
{
    ...
    internal static async Task<TResult> ExecuteAsync<TResult>(Func<CancellationToken, Task<TResult>> getTaskFunc, EDBTimeout timeout, CancellationToken cancellationToken)
    {
    ...
    internal static async Task ExecuteAsync(Func<CancellationToken, Task> getTaskFunc, EDBTimeout timeout, CancellationToken cancellationToken)
    {
