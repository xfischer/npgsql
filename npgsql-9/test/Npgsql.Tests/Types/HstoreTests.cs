...
public class HstoreTests : MultiplexingTestBase
{
    ...
    public Task Hstore()
        => AssertType(
            ...
            @"""a""=>""3"", ""b""=>NULL, ""cd""=>""hello""",
            "hstore",
            EDBDbType.Hstore, isEDBDbTypeInferredFromClrType: false);

    [Test]
    public Task Hstore_empty()
        => AssertType(new Dictionary<string, string?>(), @"", "hstore", EDBDbType.Hstore, isEDBDbTypeInferredFromClrType: false);
    ...
    public Task Hstore_as_ImmutableDictionary()
    {
        ...
        return AssertType(
            ...
            "hstore",
            EDBDbType.Hstore,
            isDefaultForReading: false, isEDBDbTypeInferredFromClrType: false);
    }
