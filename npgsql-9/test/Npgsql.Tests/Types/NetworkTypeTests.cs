...
class NetworkTypeTests : MultiplexingTestBase
{
    ...
    public Task Inet_v4_as_IPAddress()
        => AssertType(IPAddress.Parse("192.168.1.1"), "192.168.1.1/32", "inet", EDBDbType.Inet, skipArrayCheck: true);
    ...
    public Task Inet_v4_array_as_IPAddress_array()
        => AssertType(
            ...
            "{192.168.1.1,192.168.1.2}", "inet[]", EDBDbType.Inet | EDBDbType.Array);
    ...
    public Task Inet_v6_array_as_IPAddress_array()
        => AssertType(
            ...
            "{2001:1db8:85a3:1142:1000:8a2e:1370:7334,2001:1db8:85a3:1142:1000:8a2e:1370:7335}", "inet[]", EDBDbType.Inet | EDBDbType.Array);
