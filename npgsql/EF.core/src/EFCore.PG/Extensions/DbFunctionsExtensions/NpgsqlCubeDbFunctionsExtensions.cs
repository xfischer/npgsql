...
/// <summary>
///     Provides extension methods for <see cref="EDBCube" /> supporting PostgreSQL translation.
/// </summary>
/// <remarks>
...
public static class NpgsqlCubeDbFunctionsExtensions
{
    ...
    /// </exception>
    public static bool Overlaps(this EDBCube cube, EDBCube other)
    ...
    /// </exception>
    public static bool Contains(this EDBCube cube, EDBCube other)
    ...
    /// </exception>
    public static bool ContainedBy(this EDBCube cube, EDBCube other)
    ...
    /// </exception>
    public static double NthCoordinate(this EDBCube cube, int index)
    ...
    /// </exception>
    public static double NthCoordinateKnn(this EDBCube cube, int index)
    ...
    /// </exception>
    public static double Distance(this EDBCube cube, EDBCube other)
    ...
    /// </exception>
    public static double DistanceTaxicab(this EDBCube cube, EDBCube other)
    ...
    /// </exception>
    public static double DistanceChebyshev(this EDBCube cube, EDBCube other)
    ...
    /// </exception>
    public static EDBCube Union(this EDBCube cube, EDBCube other)
    ...
    /// </exception>
    public static EDBCube Intersect(this EDBCube cube, EDBCube other)
    ...
    /// </exception>
    public static EDBCube Enlarge(this EDBCube cube, double radius, int dimensions)
