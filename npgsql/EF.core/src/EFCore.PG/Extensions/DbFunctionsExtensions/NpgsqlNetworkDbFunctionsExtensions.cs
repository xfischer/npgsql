...
public static class NpgsqlNetworkDbFunctionsExtensions
{
    ...
    /// <summary>
    ///     Determines whether an <see cref="EDBInet" /> is less than another <see cref="EDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    /// <returns>
    ///     True if the <see cref="EDBInet" /> is less than the other <see cref="EDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool LessThan(this DbFunctions _, EDBInet inet, EDBInet other)
    ...
    /// <summary>
    ///     Determines whether an <see cref="EDBInet" /> is less than or equal to another <see cref="EDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    /// <returns>
    ///     True if the <see cref="EDBInet" /> is less than or equal to the other <see cref="EDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool LessThanOrEqual(this DbFunctions _, EDBInet inet, EDBInet other)
    ...
    /// <summary>
    ///     Determines whether an <see cref="EDBInet" /> is greater than or equal to another <see cref="EDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    /// <returns>
    ///     True if the <see cref="EDBInet" /> is greater than or equal to the other <see cref="EDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool GreaterThanOrEqual(this DbFunctions _, EDBInet inet, EDBInet other)
    ...
    /// <summary>
    ///     Determines whether an <see cref="EDBInet" /> is greater than another <see cref="EDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    /// <returns>
    ///     True if the <see cref="EDBInet" /> is greater than the other <see cref="EDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool GreaterThan(this DbFunctions _, EDBInet inet, EDBInet other)
    ...
    /// <summary>
    ///     Determines whether an <see cref="EDBInet" /> is contained within another <see cref="EDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The inet to locate.</param>
    /// <param name="other">The inet to search.</param>
    /// <returns>
    ///     True if the <see cref="EDBInet" /> is contained within the other <see cref="EDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool ContainedBy(this DbFunctions _, EDBInet inet, EDBInet other)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(ContainedBy)));

    /// <summary>
    ///     Determines whether an <see cref="EDBInet" /> is contained within or equal to another <see cref="EDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The inet to locate.</param>
    /// <param name="other">The inet to search.</param>
    /// <returns>
    ///     True if the <see cref="EDBInet" /> is contained within or equal to the other <see cref="EDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool ContainedByOrEqual(this DbFunctions _, EDBInet inet, EDBInet other)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(ContainedByOrEqual)));

    /// <summary>
    ///     Determines whether an <see cref="EDBInet" /> contains another <see cref="EDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The IP address to search.</param>
    /// <param name="other">The IP address to locate.</param>
    /// <returns>
    ///     True if the <see cref="EDBInet" /> contains the other <see cref="EDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool Contains(this DbFunctions _, EDBInet inet, EDBInet other)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(Contains)));

    /// <summary>
    ///     Determines whether an <see cref="EDBInet" /> contains or is equal to another <see cref="EDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The IP address to search.</param>
    /// <param name="other">The IP address to locate.</param>
    /// <returns>
    ///     True if the <see cref="EDBInet" /> contains or is equal to the other <see cref="EDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool ContainsOrEqual(this DbFunctions _, EDBInet inet, EDBInet other)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(ContainsOrEqual)));

    /// <summary>
    ///     Determines whether an <see cref="EDBInet" /> contains or is contained by another <see cref="EDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The IP address to search.</param>
    /// <param name="other">The IP address to locate.</param>
    /// <returns>
    ///     True if the <see cref="EDBInet" /> contains or is contained by the other <see cref="EDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool ContainsOrContainedBy(this DbFunctions _, EDBInet inet, EDBInet other)
    ...
    /// <summary>
    ///     Computes the bitwise NOT operation on an <see cref="EDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static EDBInet BitwiseNot(this DbFunctions _, EDBInet inet)
    ...
    /// <summary>
    ///     Computes the bitwise AND of two <see cref="EDBInet" /> instances.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static EDBInet BitwiseAnd(this DbFunctions _, EDBInet inet, EDBInet other)
    ...
    /// <summary>
    ///     Computes the bitwise OR of two <see cref="EDBInet" /> instances.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static EDBInet BitwiseOr(this DbFunctions _, EDBInet inet, EDBInet other)
    ...
    /// <summary>
    ///     Adds the <paramref name="value" /> to the <see cref="EDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The inet.</param>
    /// <param name="value">The value to add.</param>
    /// <returns>
    ///     The <see cref="EDBInet" /> augmented by the <paramref name="value" />.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static EDBInet Add(this DbFunctions _, EDBInet inet, int value)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(Add)));

    /// <summary>
    ///     Subtracts the <paramref name="value" /> from the <see cref="EDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The inet.</param>
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static EDBInet Subtract(this DbFunctions _, EDBInet inet, long value)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(Subtract)));

    /// <summary>
    ///     Subtracts one <see cref="EDBInet" /> from another <see cref="EDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static int Subtract(this DbFunctions _, EDBInet inet, EDBInet other)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(Subtract)));
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static string Abbreviate(this DbFunctions _, EDBInet inet)
...
#pragma warning disable CS0618 // NpgsqlCidr is obsolete, replaced by .NET IPNetwork
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static string Abbreviate(this DbFunctions _, EDBCidr cidr)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(Abbreviate)));
#pragma warning restore CS0618
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static EDBInet Broadcast(this DbFunctions _, EDBInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static int Family(this DbFunctions _, EDBInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static string Host(this DbFunctions _, EDBInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static EDBInet HostMask(this DbFunctions _, EDBInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static int MaskLength(this DbFunctions _, EDBInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static EDBInet Netmask(this DbFunctions _, EDBInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static IPNetwork Network(this DbFunctions _, EDBInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static EDBInet SetMaskLength(this DbFunctions _, EDBInet inet, int length)
...
#pragma warning disable CS0618 // NpgsqlCidr is obsolete, replaced by .NET IPNetwork
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static EDBCidr SetMaskLength(this DbFunctions _, EDBCidr cidr, int length)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(SetMaskLength)));
#pragma warning restore CS0618
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static string Text(this DbFunctions _, EDBInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool SameFamily(this DbFunctions _, EDBInet inet, EDBInet other)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static IPNetwork Merge(this DbFunctions _, EDBInet inet, EDBInet other)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    [Obsolete("Use the overload which accepts EDBCidr", error: true)]
