    ...
    : RelationalDbContextOptionsBuilder<NpgsqlDbContextOptionsBuilder, NpgsqlOptionsExtension>
{
    ...
    ///     will by default resolve the same <see cref="EDBDataSource" /> internally, disregarding differing configuration across calls
    ...
    /// </remarks>
    public virtual NpgsqlDbContextOptionsBuilder ConfigureDataSource(Action<EDBDataSourceBuilder> dataSourceBuilderAction)
