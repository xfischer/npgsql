    ...
    protected override string GetOperator(SqlBinaryExpression e)
        => e.OperatorType switch
        {
            ...
            ExpressionType.Add when
                ...
                || e.Type == typeof(EDBTsVector)
                || e.Left.TypeMapping?.ClrType == typeof(EDBTsVector)
                || e.Right.TypeMapping?.ClrType == typeof(EDBTsVector)
            ...
            .Append(
                binaryExpression.OperatorType switch
                {
                    PgExpressionType.Contains
                        when binaryExpression.Left.TypeMapping is EDBInetTypeMapping or EDBCidrTypeMapping or EDBLegacyCidrTypeMapping
                        => ">>",
