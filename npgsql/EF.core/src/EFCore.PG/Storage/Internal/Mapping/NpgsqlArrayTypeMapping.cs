...
#pragma warning restore EF1001
        ...
        : base(parameters)
    {
        ...
        EDBDbType = EDBTypes.EDBDbType.Array
            | (ElementTypeMapping is INpgsqlTypeMapping  { EDBDbType: not EDBTypes.EDBDbType.Unknown } elementNpgsqlTypeMapping
        ...
        ParameterDirection direction = ParameterDirection.Input)
    {
        ...
        if (param is not EDBParameter npgsqlParameter)
        {
            throw new InvalidOperationException(
