...
/// </remarks>
public class EDBLegacyCidrTypeMapping : NpgsqlTypeMapping
{
    /// <summary>
    ...
    /// </summary>
    public static EDBLegacyCidrTypeMapping Default { get; } = new();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public EDBLegacyCidrTypeMapping()
        : base("cidr", typeof(EDBCidr), EDBDbType.Cidr, JsonCidrLegacyReaderWriter.Instance)
    {
    }
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected EDBLegacyCidrTypeMapping(RelationalTypeMappingParameters parameters)
    ...
    protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
        => new EDBLegacyCidrTypeMapping(parameters);
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public sealed class JsonCidrLegacyReaderWriter : JsonValueReaderWriter<EDBCidr>
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public override EDBCidr FromJsonTyped(ref Utf8JsonReaderManager manager, object? existingObject = null)
