...
public class NpgsqlMacaddrTypeMapping : NpgsqlTypeMapping
{
    ...
    /// </summary>
    public static NpgsqlMacaddrTypeMapping Default { get; } = new();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public NpgsqlMacaddrTypeMapping()
        : base("macaddr", typeof(PhysicalAddress), EDBDbType.MacAddr, jsonValueReaderWriter: JsonMacaddrReaderWriter.Instance)
    {
    }
