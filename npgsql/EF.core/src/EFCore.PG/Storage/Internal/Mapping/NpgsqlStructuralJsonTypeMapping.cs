...
{
    /// <summary>
    ///     The database type used by Npgsql (<see cref="EDBDbType.Json" /> or <see cref="EDBDbType.Jsonb" />.
    /// </summary>
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected NpgsqlStructuralJsonTypeMapping(RelationalTypeMappingParameters parameters, EDBDbType npgsqlDbType)
        : base(parameters)
    {
    ...
    protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
        => new NpgsqlStructuralJsonTypeMapping(parameters, EDBDbType);
}
