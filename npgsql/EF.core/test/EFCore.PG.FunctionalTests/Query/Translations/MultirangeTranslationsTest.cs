...
""");
    ...
    public void Contains()
    {
        ...
        var id = context.TestEntities
            .Single(x => x.IntMultirange.Contains(new EDBRange<int>(0, 5)))
            .Id;
        Assert.Equal(1, id);
...
""");
    ...
    public void Skip_Contains()
    {
        ...
        var id = context.TestEntities
            .Single(x => x.IntMultirange.Skip(1).Contains(new EDBRange<int>(7, 10)))
            .Id;
        Assert.Equal(1, id);
...
""");
    ...
    public class MultirangeTestEntity
    {
        ...
        public EDBRange<int>[] IntMultirange { get; set; } = null!;
        public EDBRange<long>[] LongMultirange { get; set; } = null!;
        public EDBRange<decimal>[] DecimalMultirange { get; set; } = null!;
        public EDBRange<DateOnly>[] DateOnlyDateMultirange { get; set; } = null!;

        [Column(TypeName = "datemultirange")]
        public EDBRange<DateTime>[] DateTimeDateMultirange { get; set; } = null!;
    }
