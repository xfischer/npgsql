...
""");
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    [EDBNotEPASRedwoodCompatible("NodaTime")]
...
""");
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    [EDBNotEPASRedwoodCompatible("NodaTime")] // left part is timestamp and cannot equal LocalDate
        ...
        public static IReadOnlyList<NodaTimeTypes> CreateNodaTimeTypes()
        {
            ...
            return new List<NodaTimeTypes>
            {
                new()
                {
                    ...
                    InstantRange = new EDBRange<Instant>(instant, true, instant + Duration.FromDays(5), false),
                    Long = 1,
