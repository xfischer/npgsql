...
sealed class EDBInetConverter : PgBufferedConverter<EDBInet>
{
    const byte IPv4 = 2;
    const byte IPv6 = 3;
    ...
    public override Size GetSize(SizeContext context, EDBInet value, ref object? writeState)
    ...
    protected override EDBInet ReadCore(PgReader reader)
    {
    ...
    protected override void WriteCore(PgWriter writer, EDBInet value)
