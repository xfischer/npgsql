...
/// </summary>
public sealed class EDBDataSourceBuilder : IEDBTypeMapper
{
    static UnsupportedTypeInfoResolver<EDBDataSourceBuilder> UnsupportedTypeInfoResolver { get; } = new();

    readonly EDBSlimDataSourceBuilder _internalBuilder;
    ...
    /// </summary>
    public EDBConnectionStringBuilder ConnectionStringBuilder => _internalBuilder.ConnectionStringBuilder;
    ...
    public EDBDataSourceBuilder EnableRecordsAsTuples()
    {
    ...
    public EDBDataSourceBuilder EnableUnmappedTypes()
    {
    ...
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public EDBDataSourceBuilder UseRootCertificate(X509Certificate2? rootCertificate)
    {
    ...
    /// </para>
    /// </remarks>
    public EDBDataSourceBuilder UsePasswordProvider(
