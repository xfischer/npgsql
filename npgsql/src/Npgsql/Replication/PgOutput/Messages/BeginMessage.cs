...
public sealed class BeginMessage : TransactionControlMessage
{
    ...
    /// </summary>
    public EDBLogSequenceNumber TransactionFinalLsn { get; private set; }
    ...
    internal BeginMessage Populate(EDBLogSequenceNumber walStart, EDBLogSequenceNumber walEnd, DateTime serverClock,
        EDBLogSequenceNumber transactionFinalLsn, DateTime transactionCommitTimestamp, uint transactionXid)
    {
