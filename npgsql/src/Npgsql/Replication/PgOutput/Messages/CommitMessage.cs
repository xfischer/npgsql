...
public sealed class CommitMessage : PgOutputReplicationMessage
{
    ...
    internal CommitMessage Populate(EDBLogSequenceNumber walStart, EDBLogSequenceNumber walEnd, DateTime serverClock,
        CommitFlags flags, EDBLogSequenceNumber commitLsn, EDBLogSequenceNumber transactionEndLsn,
