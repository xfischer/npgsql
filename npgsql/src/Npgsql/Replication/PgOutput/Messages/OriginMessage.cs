...
public sealed class OriginMessage : PgOutputReplicationMessage
{
    ...
    /// </summary>
    public EDBLogSequenceNumber OriginCommitLsn { get; private set; }
    ...
    internal OriginMessage Populate(
        EDBLogSequenceNumber walStart, EDBLogSequenceNumber walEnd, DateTime serverClock, EDBLogSequenceNumber originCommitLsn,
        string originName)
    {
