...
/// </summary>
/// <remarks>
/// Note that a connection may be closed before its TransactionScope completes. In this case we close the EDBConnection
...
sealed class VolatileResourceManager : ISinglePhaseNotification
{
    ...
    internal VolatileResourceManager(EDBConnection connection, Transaction transaction)
    {
        ...
        _dataSource = connection.EDBDataSource;
