...
public class Insert
{
    ...
    public void GlobalSetup()
    {
        ...
        _conn = new EDBConnection(connString);
        _conn.Open();

        using (var cmd = new EDBCommand("CREATE TEMP TABLE data (int1 INT4, text1 TEXT, int2 INT4, text2 TEXT)", _conn))
            cmd.ExecuteNonQuery();
    ...
    {
        var cmd = new EDBCommand("INSERT INTO data VALUES (@p0, @p1, @p2, @p3)", _conn);
    ...
    public void Batched()
    {
        var cmd = new EDBCommand { Connection = _conn };
