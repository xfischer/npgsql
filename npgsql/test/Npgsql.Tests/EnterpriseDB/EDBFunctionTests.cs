...
public class EDBFunctionTests : EPASTestBase
{
    ...
    public void Testemptyfunction()
    {
        ...
        command.Prepare();
        command.ExecuteNonQuery();
        Assert.That(command.Parameters[0].Value.ToString(), Is.EqualTo("EnterpriseDB"));
    ...
    public void TestThreeInArg()
    {
        ...
        Assert.That(command.Parameters[3].Value.ToString(), Is.EqualTo("EnterpriseDB"));
    ...
    public void TestThreeInArg_SELECT()
    {
        ...
        Assert.That(result[0].ToString(), Is.EqualTo("EnterpriseDB"));
    ...
    public void TestThreeInArg_SELECT_Scalar()
    {
        ...
        Assert.That(result.ToString(), Is.EqualTo("EnterpriseDB"));
    ...
    public void TestmixArgRetValFunc()
    {
        ...
        Assert.That(command.Parameters["paramInOut"].Value, Is.EqualTo(20m));
        Assert.That(command.Parameters["paramOut"].Value, Is.EqualTo(25m));
        Assert.That(command.Parameters["paramRetVal"].Value, Is.EqualTo(24));
        ...
        Assert.That(int.Parse(command.Parameters["paramInOut"].Value.ToString()), Is.EqualTo(20));
        Assert.That(int.Parse(command.Parameters["paramOut"].Value.ToString()), Is.EqualTo(25));
        Assert.That(int.Parse(command.Parameters["paramRetVal"].Value.ToString()), Is.EqualTo(24));
    ...
    public void TestInMemoryDataReader()
    {
        ...
        var reader = command.ExecuteReader();
        Assert.That(reader.HasRows);
        Assert.That(command.Parameters["paramInOut"].Value, Is.EqualTo(DBNull.Value));
        Assert.That(command.Parameters["paramOut"].Value, Is.EqualTo(25m));
        Assert.That(command.Parameters["paramRetVal"].Value, Is.EqualTo(24));
        ...
        Assert.That(reader.IsDBNull("paramInOut"));
    ...
    public async Task TestInMemoryDataReaderAsync()
    {
        ...
        Assert.That(await reader.IsDBNullAsync(0));
#if !NETFRAMEWORK
        Assert.That(await reader.IsDBNullAsync("paramInOut"));
#endif
    ...
    public void TestretValFunc_test()
    {
        ...
        var reader = command.ExecuteReader();
        Assert.That(reader.HasRows);
        Assert.That(int.Parse(command.Parameters["paramRetVal"].Value.ToString()), Is.EqualTo(10));
    ...
    public void TestFunctionWithINTAsInInoutOut()
    {
        ...
        Assert.That(int.Parse(command.Parameters[3].Value.ToString()), Is.EqualTo(12000));

        //////////tear down
        command.Dispose();
        command = new EDBCommand("", con)
        {
            CommandText = "DROP Function FunctionWithINT( in int, inout int,out int) "
        };
        command.ExecuteNonQuery();
    ...
    public void TestFunctionWithINT4AsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithInt4(in int4, inout int4, out int4);"
        };
        command.ExecuteNonQuery();
    }
    ...
    public void TestFunctionWithINT8AsInInoutOut()
    {
        ...
        Assert.That(int.Parse(command.Parameters[3].Value.ToString()), Is.EqualTo(1010));

        //////////tear down
        command.Dispose();
        command = new EDBCommand("", con)
        {
            CommandText = "DROP Function FunctionWithInt8( in int8, inout int8, out int8);"
        };
        command.ExecuteNonQuery();
    ...
    public void TestFunctionWithINTEGERAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP Function FunctionWithInteger( in Integer, inout Integer, out Integer);"
        };
        command.ExecuteNonQuery();
    ...
    public void TestFunctionWithSmallINTAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP Function FunctionWithSmallInt( in SmallInt, inout SmallInt, out SmallInt)"
        };
        command.ExecuteNonQuery();
    ...
    public void TestFunctionWithBigIntAsInInoutOut()
    {
        ...
        Assert.That(int.Parse(command.Parameters[0].Value.ToString()), Is.EqualTo(100906));
        Assert.That(int.Parse(command.Parameters[1].Value.ToString()), Is.EqualTo(200906));
        Assert.That(int.Parse(command.Parameters[2].Value.ToString()), Is.EqualTo(220905));
        Assert.That(int.Parse(command.Parameters[3].Value.ToString()), Is.EqualTo(180902));

        //////////tear down
        command.Dispose();
        command = new EDBCommand("", con)
        {
            CommandText = "DROP Function FunctionWithBigInt( in Bigint, inout Bigint, out Bigint);"
        };
        command.ExecuteNonQuery();
    ...
    public void TestFunctionWithNUMERICASInInoutOut()
    {
        ...
        Assert.That(int.Parse(command.Parameters[3].Value.ToString()), Is.EqualTo(1234));

        //////////tear down
        command.Dispose();
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithNumeric( in NUMERIC, inout NUMERIC, out NUMERIC) ;"
        };
        command.ExecuteNonQuery();
    ...
    public void TestFunctionWithNUMBERASInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithNumber( in NUMBER, inout NUMBER, out NUMBER);"
        };
        command.ExecuteNonQuery();
    ...
    public void TestFunctionWithDecASInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithDec( in Dec, inout Dec, out Dec);"
        };
        command.ExecuteNonQuery();
    ...
    public void TestFunctionWithDecimalASInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION  FunctionWithDecimal( in Decimal, inout Decimal, out Decimal);"
        };
        command.ExecuteNonQuery();
    ...
    public void TestFunctionWithFLOATAsInInoutOut()
    {
        ...
        Assert.That(float.Parse(command.Parameters[0].Value.ToString()), Is.EqualTo(1.10001f));
        Assert.That(float.Parse(command.Parameters[1].Value.ToString()), Is.EqualTo(1.10001f));
        Assert.That(float.Parse(command.Parameters[2].Value.ToString()), Is.EqualTo(-2.2131f));
        Assert.That(float.Parse(command.Parameters[3].Value.ToString()), Is.EqualTo(-0.999f));

        //////////tear down
        command.Dispose();
        command = new EDBCommand("", con)
        {
            CommandText = "DROP Function FunctionWithFloat( in FLOAT, inout FLOAT, out FLOAT);"
        };
        command.ExecuteNonQuery();
        command.Dispose();
    }
    ...
    public void TestFunctionWithDoublePrecisionAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP Function FunctionWithDoublePrecision( in Double Precision, inout Double Precision, out Double Precision) ;"
        };
        command.ExecuteNonQuery();
        command.Dispose();
    }
    ...
    public void TestFunctionWithREALAsInInoutOut()
    {
        ...
        Assert.That(float.Parse(command.Parameters[3].Value.ToString()), Is.EqualTo(10.1111f));

        //////////tear down
        command.Dispose();
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithReal( in REAL, inout REAL, out REAL);"
        };
        command.ExecuteNonQuery();
    }
    ...
    public void TestFunctionWithCHARAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithChar( in CHAR(30), inout CHAR(30), out CHAR(30));"
        };
        command.ExecuteNonQuery();
    }
    ...
    public void TestFunctionWithCHARACTERAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithCharacter( in CHARACTER(30), inout CHARACTER(30), out CHARACTER(30));"
        };
        command.ExecuteNonQuery();
    }
    ...
    public void TestFunctionWithCHARACTERVARYINGAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithCharacterVarying( in CHARACTER Varying, inout CHARACTER Varying, out CHARACTER Varying);"
        };
        command.ExecuteNonQuery();
    }
    ...
    public void TestFunctionWithCHARVARYINGAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithCharVarying( in CHAR Varying, inout CHAR Varying, out CHAR Varying);"
        };
        command.ExecuteNonQuery();
    }
    ...
    public void TestFunctionWithCLOBAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithClob( in CLOB, inout CLOB, out CLOB);"
        };
        command.ExecuteNonQuery();
    }
    ...
    public void TestFunctionWithLongTextAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION  FunctionWithLongText1( in LongText, inout LongText, out LongText)"
        };
        command.ExecuteNonQuery();
    ...
    public void TestFunctionWithLongAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithLong( in Long, inout Long, out Long);"
        };
        command.ExecuteNonQuery();
    }
    ...
    public void TestFunctionWithTextAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION  FunctionWithText( in Text, inout Text, out Text) ;"
        };
        command.ExecuteNonQuery();
    }
    ...
    public void TestFunctionWithLongVarcharAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithLongVarchar( in Long Varchar, inout Long Varchar, out Long Varchar);"
        };
        command.ExecuteNonQuery();
    ...
    public void TestFunctionWithLVarcharAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithLVarchar( in LVarchar, inout LVarchar, out LVarchar)"
        };
        command.ExecuteNonQuery();
    }
    ...
    public void TestFunctionWithMediumTextAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION  FunctionWithMediumText( in MediumText, inout MediumText, out MediumText) ;"
        };
        command.ExecuteNonQuery();
    ...
    public void TestFunctionWithTinyTextAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithtinyText( in TinyText, inout TinyText, out TinyText);"
        };
        command.ExecuteNonQuery();
    ...
    public void TestFunctionWithMONEYASInInoutOut()
    {
        ...
        Assert.That((int)(float.Parse(command.Parameters[0].Value.ToString())), Is.EqualTo(10000));
        Console.WriteLine(command.Parameters[0].Value.ToString());

        Assert.That((int)(float.Parse(command.Parameters[1].Value.ToString())), Is.EqualTo(10000));
        ...
        Assert.That((int)(float.Parse(val)), Is.EqualTo(expected));
        Console.WriteLine(command.Parameters[2].Value.ToString());
        Assert.That((int)(float.Parse(command.Parameters[3].Value.ToString())), Is.EqualTo(1234));
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithMONEY( in MONEY, inout MONEY, out MONEY);"
        };
        command.ExecuteNonQuery();
    }
    ...
    public void TestFunctionWithSmallMoneyASInInoutOut()
    {
        ...
        Assert.That(command.Parameters[0].Value.ToString(), Is.EqualTo("10000"));
        Assert.That(command.Parameters[1].Value.ToString(), Is.EqualTo("10000"));
        Assert.That(command.Parameters[2].Value.ToString(), Is.EqualTo("-2"));
        Assert.That(command.Parameters[3].Value.ToString(), Is.EqualTo("1234"));

        //////////tear down
        command.Dispose();
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithSmallMoney( in SmallMoney, inout SmallMoney, out SmallMoney);"
        };
        command.ExecuteNonQuery();
    ...
    public void TestFunctionWithVarcharAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithVarchar( in Varchar, inout Varchar, out Varchar);"
        };
        command.ExecuteNonQuery();
    ...
    public void TestFunctionWithVarchar2AsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithVarchar2( in Varchar2, inout Varchar2, out Varchar2)"
        };
        command.ExecuteNonQuery();
    }
    ...
    public void TestFunctionWithBooleanAsInInoutOut()
    {
        ...
        Assert.That((bool)command.Parameters["v_in"].Value);
        Assert.That((bool)command.Parameters["v_inout"].Value);
        Assert.That((bool)command.Parameters["v_out"].Value, Is.False);
        Assert.That((bool)command.Parameters["v_ret"].Value);

        //////////tear down
        command.Dispose();
        command = new EDBCommand("", con)
        {
            CommandText = "DROP Function FunctionWithBoolean( in Boolean, inout Boolean, out Boolean);"
        };
        command.ExecuteNonQuery();
    }
    ...
    public void TestFunctionWithBitAsInInoutOut()
    {
        ...
        Assert.That(bool.Parse(command.Parameters[0].Value.ToString()));
        Assert.That(command.Parameters[1].Value.ToString(), Is.EqualTo("True"));
        var p_out = false;
        Assert.That(command.Parameters[2].Value, Is.EqualTo(p_out));
        Assert.That(command.Parameters[3].Value.ToString(), Is.EqualTo("True"));

        //////////tear down
        command.Dispose();
        command = new EDBCommand("", con)
        {
            CommandText = "DROP Function FunctionWithBit( in Bit, inout Bit, out Bit);"
        };
        command.ExecuteNonQuery();
    ...
    public void TestFunctionWithSMALLFLOATAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP FUNCTION FunctionWithSmallFloat( in Float, inout Float, out Float);"
        };
        command.ExecuteNonQuery();
    }
    ...
    public void TestFunctionWithTinyIntAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP Function FunctionWithTinyInt( in TinyInt, inout TinyInt, out TinyInt) ;"
        };
        command.ExecuteNonQuery();
...
*/
    ...
    public void TestMaxParametersSupportInFunctionWithNumericAsOut()
    {
        ...
        Assert.That(command.Parameters[128].Value.ToString(), Is.EqualTo("203"));
    ...
    public void TestMaxParametersSupportInFunctionWithNumericAsInAndOut()
    {
        ...
        Assert.That(command.Parameters[128].Value.ToString(), Is.EqualTo("300"));
...
*/
    ...
    public void TestMaxParametersSupportInFunctionsWithTextAsOut()
    {
        ...
        for (var i = 0; i < 128; i++)
            Assert.That(command.Parameters[i].Value.ToString(), Is.EqualTo((i + 1).ToString()));
        Assert.That(command.Parameters[128].Value.ToString(), Is.EqualTo("Hashim"));
    ...
    public void TERSE_FUNC_CURSOR_TYPES()
    {
        ...
        Assert.That(cur.GetString(13), Is.EqualTo("Great"));
    ...
    public void TERSE_FUNC_MIXED_NATIVE_CURSOR_TYPES()
    {
        ...
        Assert.That(Convert.ToString(command.Parameters[3].Value.ToString()), Is.EqualTo("100"));
