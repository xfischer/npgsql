...
public class EDBProcedureTest : EPASTestBase
{
    ...
    public void TestEmptyArg()
    {
        Assert.DoesNotThrowAsync(async () =>
        {
            ...
            var com2 = new EDBCommand("", con)
            {
                ...
                CommandText = "DROP PROCEDURE emptyArg_test"
            };
    ...
    public void TestOneInArg()
    {
        Assert.DoesNotThrowAsync(async () =>
        {
            ...
            var com = new EDBCommand("", con)
            {
                ...
                CommandText = "DROP PROCEDURE oneInArg_test"
            };
            await com.ExecuteNonQueryAsync();
            TestUtil.closeDB(con);
    ...
    public void TestThreeInArg()
    {
        Assert.DoesNotThrowAsync(async () =>
        {
            ...
            var com = new EDBCommand("", con)
            {
                ...
                CommandText = "DROP PROCEDURE threeInArg_test"
            };
            await com.ExecuteNonQueryAsync();
            TestUtil.closeDB(con);
    ...
    public void TestOneOutArg()
    {
        Assert.DoesNotThrowAsync(async () =>
        {
            ...
            var com = new EDBCommand("", con)
            {
                ...
                CommandText = "DROP PROCEDURE oneOutArg_test"
            };
            await com.ExecuteNonQueryAsync();
            TestUtil.closeDB(con);
    ...
    public async Task TestThreeOutArg()
    {
        try
        {
            ...
            {
                CommandType = CommandType.Text,
                CommandText = "DROP PROCEDURE threeOutArg_test"
            };
            await com.ExecuteNonQueryAsync();
            TestUtil.closeDB(con);
    ...
    public async Task TestSingleInOutArg()
    {
        try
        {
            ...
            var com = new EDBCommand("", con)
            {
                ...
                CommandText = "DROP PROCEDURE singleInOutArg_test"
            };
            await com.ExecuteNonQueryAsync();
            TestUtil.closeDB(con);
    ...
    public async Task TestMultipleInOutArg()
    {
        try
        {
            ...
            {
                CommandType = CommandType.Text,
                CommandText = "DROP PROCEDURE multipleInOutArg_test"
            };
            await com.ExecuteNonQueryAsync();
            TestUtil.closeDB(con);
    ...
    public async Task TestOneProcCallingOtherProc()
    {
        ...
        {
            CommandText = "DROP Procedure check_proc;"
        };
        await command.ExecuteNonQueryAsync();
    ...
    public async Task TestProcedureWithINTAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP PROCEDURE ProcedureWithINT;"
        };
        await command.ExecuteNonQueryAsync();
        TestUtil.closeDB(con);
    ...
    public async Task TestProcedureWithINT4AsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP procedure ProcedureWithInt4;"
        };
        await command.ExecuteNonQueryAsync();
        TestUtil.closeDB(con);
    ...
    public async Task TestProcedureWithINT8AsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP Procedure ProcedureWithInt8;"
        };
        await command.ExecuteNonQueryAsync();
        TestUtil.closeDB(con);
    ...
    public async Task TestProcedureWithNUMERICASInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP procedure ProcedureWithNumeric;"
        };
        await command.ExecuteNonQueryAsync();
        TestUtil.closeDB(con);
    ...
    public async Task TestProcedureWithFLOATAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP Procedure ProcedureWithFloat;"
        };
        await command.ExecuteNonQueryAsync();
        TestUtil.closeDB(con);
    ...
    public async Task TestProcedureWithREALAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP PROCEDURE procedureWithReal;"
        };
        await command.ExecuteNonQueryAsync();
        TestUtil.closeDB(con);
    ...
    public async Task TestProcedureWithCHARAsInInoutOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP PROCEDURE ProcedureWithChar;"
        };
        await command.ExecuteNonQueryAsync();
        TestUtil.closeDB(con);
    ...
    */
    ...
    public async Task TestMaxParametersSupportInProcedureWithNumericAsOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP PROCEDURE MaxProcNumeric;"
        };
        await command.ExecuteNonQueryAsync();
        TestUtil.closeDB(con);
    ...
    public async Task TestMaxParametersSupportInProcedureWithNumericAsInAndOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP PROCEDURE MaxProcNumericInOut;"
        };
        await command.ExecuteNonQueryAsync();
        TestUtil.closeDB(con);
...
*/
    ...
    public async Task TestMaxParametersSupportInProcedureWithTextAsOut()
    {
        ...
        command = new EDBCommand("", con)
        {
            CommandText = "DROP PROCEDURE MaxProcText;"
        };
        await command.ExecuteNonQueryAsync();
    ...
    public async Task TestMultipleInOutParameters()
    {
        try
        {
            ...
            await com1.ExecuteNonQueryAsync();
            await com1.DisposeAsync();

            var command = new EDBCommand("multipleInOutParameters(:a,:b,:c,:d)", con)
            {
                CommandType = CommandType.StoredProcedure
            };
            ...
            {
                CommandType = CommandType.Text,
                CommandText = "DROP PROCEDURE multipleInOutParameters"
            };
            await com.ExecuteNonQueryAsync();
    ...
    public async Task TERSE_PROC_NATIVE_INPUT_TYPES()
    {
        try
        {
            ...
            var command = new EDBCommand("set edb_stmt_level_tx to on;", con);
            await command.ExecuteNonQueryAsync();
            await command.DisposeAsync();
    ...
    [Test, EDBExplicit("Causes 'EDBException : Unknown message code: 0' when run with other tests")]
...

    {
        try
        {
            ...
            var rst = await command.ExecuteReaderAsync(CommandBehavior.SequentialAccess);
            ...
            command.CommandType = CommandType.Text;
            rst = await command.ExecuteReaderAsync(CommandBehavior.SequentialAccess);
    ...
    public async Task TestProcWithNumericOutputParamOnly_ShouldBeClrType()
    {
        ...
        try
        {
            ...
            command = new EDBCommand("", con)
            {
                CommandText = "DROP procedure TestProcWithNumericOutputParamOnly_ShouldBeClrType;"
            };
            await command.ExecuteNonQueryAsync();
            TestUtil.closeDB(con);
    ...
    public async Task TestProcWithNumericOutputParamAndOther_ShouldBeClrType()
    {
        ...
        try
        {
            ...
            command = new EDBCommand("", con)
            {
                CommandText = "DROP procedure TestProcWithNumericOutputParamAndOther_ShouldBeClrType;"
            };
            await command.ExecuteNonQueryAsync();
            TestUtil.closeDB(con);
