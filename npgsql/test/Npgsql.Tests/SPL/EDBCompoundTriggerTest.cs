...
internal class EDBCompoundTriggerTest : EPASTestBase
{
    ...
    private static readonly string[] FIRST_TRIGGER_RESULT = [
        "Before Statement: 11000",
        "Before Each Row: 12000",
        "After Each Row: 13000",
        "After Statement: 14000"
        ];
    private static readonly string[] TRUNCATE_TRIGGER_RESULT = [
        "Before Statement: 11000",
        "After Statement: 12000"
        ];
    private static readonly string[] CONDITIONAL_TRIGGER_INSERT_RESULT = [
        "Before Statement",
        "Before Each Row:  1600",
        "After Each Row:  1600",
        "After Statement"
        ];
    private static readonly string[] CONDITIONAL_TRIGGER_UPDATE_RESULT = [
        "Before Statement",
        "Before Each Row: 1600 7500",
        "After Each Row: 1600 7500",
        "After Statement"
        ];
    private static readonly string[] CONDITIONAL_TRIGGER_DELETE_RESULT = [
        "Before Statement",
