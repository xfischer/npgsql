...
public class JsonDynamicTests : MultiplexingTestBase
{
    ...
    public async Task Poco_does_not_stomp_GetValue_string()
    {
        ...
        await using var cmd = new EDBCommand($"SELECT '{sqlLiteral}'::{(IsJsonb ? "jsonb" : "json")}", conn);
    ...
    public async Task Poco_polymorphic_mapping()
    {
        ...
        await AssertTypeWrite(dataSource, value, sql, PostgresType, EDBDbType, isEDBDbTypeInferredFromClrType: false);
    ...
    public async Task Poco_polymorphic_mapping_read_parents()
    {
        ...
        await AssertTypeWrite<WeatherForecast>(dataSource, value, sql, PostgresType, EDBDbType,
            isEDBDbTypeInferredFromClrType: false);
    ...
    public async Task Poco_unspecified_polymorphic_mapping()
    {
        ...
        await AssertTypeWrite(dataSource, value, sql, PostgresType, EDBDbType, isDefault: false);
    ...
    public JsonDynamicTests(MultiplexingMode multiplexingMode, EDBDbType npgsqlDbType)
