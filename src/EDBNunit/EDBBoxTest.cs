...
namespace DOTNET
{
	...
	public class EDBBoxTest
	{
		...
		private void Check(EDBBox box, double uX, double uY, double lX, double lY)
		{
			Assert.AreEqual(uX, box.UpperRight.X);
			Assert.AreEqual(uY, box.UpperRight.Y);
			Assert.AreEqual(lX, box.LowerLeft.X);
			Assert.AreEqual(lY, box.LowerLeft.Y);
		}
		...
		public void CreateFromTwoPoint()
		{
			...
			Assert.AreEqual(3, box.Top);
			Assert.AreEqual(4, box.Right);
			Assert.AreEqual(13, box.Bottom);
		...
		public void CreateFromFourPoint()
		{
			...
			Assert.AreEqual(3, box.Right);
			Assert.AreEqual(4, box.Bottom);
			Assert.AreEqual(13, box.Left);
