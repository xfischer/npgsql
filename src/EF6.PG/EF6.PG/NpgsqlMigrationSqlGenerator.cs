...
namespace EnterpriseDB.EDBClient
{
    ...
    public class EDBMigrationSqlGenerator : MigrationSqlGenerator
    {
        ...
        protected virtual void Convert(HistoryOperation historyOperation)
        {
            ...
            {
                var edbCommand = new EDBCommand();
                EDBServices.Instance.TranslateCommandTree(_serverVersion, command, edbCommand, false);
                AddStatment(edbCommand.CommandText);
            }
        }
        ...
        {
            sql.Append("'");
            sql.Append(new EDBTypes.EDBTimeSpan(value));
            sql.Append("'");
        }
