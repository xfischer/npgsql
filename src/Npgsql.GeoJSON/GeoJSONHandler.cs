...
namespace EnterpriseDB.EDBClient.GeoJSON
{
        ...
        IEDBTypeHandler<IGeometryObject>
    {
        ...
        async ValueTask<GeoJSONObject> ReadGeometryCore(EDBReadBuffer buf, bool async, BoundingBoxBuilder? boundingBox)
        {
            ...
            default:
                throw new EDBSafeReadException(UnknownPostGisType());
            }
        ...
        NamedCRS? GetCrs(int srid)
        {
            ...
            if (authority == null)
                throw new EDBSafeReadException(new InvalidOperationException($"SRID {srid} unknown in spatial_ref_sys table"));
