...
{
    class NetTopologySuiteHandler : EDBTypeHandler<Geometry>,
        ...
        IEDBTypeHandler<GeometryCollection>
    {
        ...
        public override Task Write(Geometry value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async)
            => WriteCore(value, buf);
