...
namespace EnterpriseDB.EDBClient.NetTopologySuite
{
    ...
    class EDBPostGisWriter : IBinaryGeometryWriter
    {
        /// <summary>
		...
		public EDBPostGisWriter(ByteOrder encodingType)
        {
        ...
        private static Ordinates CheckOrdinates(ICoordinateSequence sequence)
        {
            ...
            {
                // Fixed in EDB, see https://github.com/NetTopologySuite/NetTopologySuite.IO.PostGis/pull/4
        ...
        public Ordinates HandleOrdinates
        {
            ...
            // Fixed in EDB, see https://github.com/NetTopologySuite/NetTopologySuite.IO.PostGis/pull/5
