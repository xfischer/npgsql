...
namespace EnterpriseDB.EDBClient.Logging
{
    ...
    public class ConsoleLoggingProvider : IEDBLoggingProvider
    {
        ...
        public ConsoleLoggingProvider(EDBLogLevel minLevel=EDBLogLevel.Info, bool printLevel=false, bool printConnectorId=false)
        {
            _minLevel = minLevel;
    ...
    class ConsoleLogger : EDBLogger
    {
        readonly EDBLogLevel _minLevel;
        readonly bool _printLevel;
        readonly bool _printConnectorId;

        internal ConsoleLogger(EDBLogLevel minLevel, bool printLevel, bool printConnectorId)
        {
            _minLevel = minLevel;
            _printLevel = printLevel;
            _printConnectorId = printConnectorId;
