...
namespace EnterpriseDB.EDBClient{
    ...
    public sealed class EDBConnection : DbConnection, ICloneable
    {
        ...
        /// </summary>
        public IEDBTypeMapper TypeMapper => CheckReadyAndGetConnector().TypeMapper;
        ...
        void GetPoolAndSettings()
        {
            ...
            Settings = new EDBConnectionStringBuilder(_connectionString);
...
#nullable restore
        ...
        /// </remarks>
        public new EDBTransaction BeginTransaction() => BeginTransaction(IsolationLevel.Unspecified);
...
#nullable restore
        ...
        EDBConnector CheckConnectionOpen()
        {
            CheckDisposed();
        ...
        public override DataTable GetSchema(string? collectionName, string?[]? restrictions)
            => EDBSchema.GetSchema(this, collectionName, restrictions);
        ...
        public void ReloadTypes()
        {
            ...
            EDBDatabaseInfo.Cache.TryRemove(_connectionString, out var _);
            conn.LoadDatabaseInfo(EDBTimeout.Infinite, false).GetAwaiter().GetResult();
