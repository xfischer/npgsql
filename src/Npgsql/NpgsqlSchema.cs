...
namespace EnterpriseDB.EDBClient
{
    ...
    {
        public static DataTable GetSchema(EDBConnection conn, string? collectionName, string?[]? restrictions)
        {
        ...
        static DataTable GetDatabases(EDBConnection conn, string?[]? restrictions)
        {
        ...
        static DataTable GetSchemata(EDBConnection conn, string?[]? restrictions)
        {
...
@"select * from(
    ...
    from
        ...
        static DataTable GetTables(EDBConnection conn, string?[]? restrictions)
        {
...
WHERE table_type IN ('BASE TABLE', 'FOREIGN', 'FOREIGN TABLE') AND table_schema NOT IN ('pg_catalog', 'information_schema')");
        ...
        static DataTable GetColumns(EDBConnection conn, string?[]? restrictions)
        {
        ...
        static DataTable GetViews(EDBConnection conn, string?[]? restrictions)
        {
...
WHERE table_schema NOT IN ('pg_catalog', 'information_schema')");
        ...
        static DataTable GetUsers(EDBConnection conn, string?[]? restrictions)
        {
        ...
        static DataTable GetIndexes(EDBConnection conn, string?[]? restrictions)
        {
...
where
    ...
    and t.relkind = 'r'");
        ...
        static DataTable GetIndexColumns(EDBConnection conn, string?[]? restrictions)
        {
...
where
    ...
    and t.relkind = 'r'");
        ...
        static DataTable GetConstraints(EDBConnection conn, string?[]? restrictions, string? constraintType)
        {
...
select 'UNIQUE KEY' as ""CONSTRAINT_TYPE"", 'u' as ""contype""
        ...
        static DataTable GetConstraintColumns(EDBConnection conn, string?[]? restrictions)
        {
