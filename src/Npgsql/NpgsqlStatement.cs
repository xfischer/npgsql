...
namespace  EnterpriseDB.EDBClient
{
    ...
    /// </summary>
    public class EDBStatement
    {
        internal EDBStatement(string sql, List<EDBParameter> inputParameters, string preparedStatementName = null)
        {
            SQL = sql;
        ...
        internal readonly List<EDBParameter> InputParameters;
