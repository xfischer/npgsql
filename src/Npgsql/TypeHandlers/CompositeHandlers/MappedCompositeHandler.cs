...
{
    class MappedCompositeHandler<T> : EDBTypeHandler<T>, IMappedCompositeHandler
    {
        ...
        public MappedCompositeHandler(PostgresCompositeType postgresType, ConnectorTypeMapper typeMapper, IEDBNameTranslator nameTranslator)
            : base(postgresType)
        {
        ...
        public override async Task Write(T value, EDBWriteBuffer buffer, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async)
        {
            Initialize();
