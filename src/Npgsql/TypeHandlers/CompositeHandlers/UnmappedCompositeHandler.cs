...
namespace EnterpriseDB.EDBClient.TypeHandlers.CompositeHandlers
{
    ...
    /// </remarks>
    class UnmappedCompositeHandler : EDBTypeHandler<object>
    {
        ...
        internal UnmappedCompositeHandler(PostgresType postgresType, IEDBNameTranslator nameTranslator, ConnectorTypeMapper typeMapper)
            : base(postgresType)
        {
        ...
        internal override ValueTask<object> ReadAsObject(EDBReadBuffer buf, int len, bool async, FieldDescription fieldDescription = null)
        ...
        public override async Task Write(object value, EDBWriteBuffer buf, EDBLengthCache lengthCache, EDBParameter parameter, bool async)
        {
        ...
        class MemberDescriptor
        {
            ...
            internal uint OID;
            internal EDBTypeHandler Handler;
