...
namespace EnterpriseDB.EDBClient.TypeHandlers
{
    ...
    /// </remarks>
    [TypeMapping("jsonb", EDBDbType.Jsonb, typeof(JsonDocument))]
    ...
    /// Use it at your own risk.
    /// </remarks>
    [TypeMapping("json", EDBDbType.Json)]
    ...
    public class JsonHandler : EDBTypeHandler<string>, ITextReaderHandler
    {
        ...
        /// <inheritdoc />
        protected internal JsonHandler(PostgresType postgresType, EDBConnection connection, bool isJsonb, JsonSerializerOptions? serializerOptions = null)
            : base(postgresType)
        {
        ...
        /// <inheritdoc />
        protected override async Task WriteWithLength<TAny>(TAny value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async)
        {
        ...
        /// <inheritdoc />
        protected internal override async Task WriteObjectWithLength(object value, EDBWriteBuffer buf, EDBLengthCache? lengthCache, EDBParameter? parameter, bool async)
        {
        ...
        /// <inheritdoc />
        protected internal override async ValueTask<T> Read<T>(EDBReadBuffer buf, int byteLen, bool async, FieldDescription? fieldDescription = null)
        {
            if (_isJsonb)
            {
