...
namespace EnterpriseDB.EDBClient.TypeHandlers.NumericHandlers
{
    ...
    public class Int64Handler : EDBSimpleTypeHandler<long>,
    ...
    {
        /// <inheritdoc />
        public Int64Handler(PostgresType postgresType) : base(postgresType) {}
        ...
        /// <inheritdoc />
        public void Write(float value, EDBWriteBuffer buf, EDBParameter? parameter)         => buf.WriteInt64(checked((long)value));
        /// <inheritdoc />
        public void Write(double value, EDBWriteBuffer buf, EDBParameter? parameter)        => buf.WriteInt64(checked((long)value));
        /// <inheritdoc />
