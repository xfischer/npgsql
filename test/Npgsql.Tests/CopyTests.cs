    ...
    public class CopyTests : TestBase
    {
        ...
        public void RawBinaryRoundtrip()
        {
            using (var conn = OpenConnection())
            {
                ...
                using (var cmd = new EDBCommand("INSERT INTO data (field_text, field_int4) VALUES (@p1, @p2)", conn))
                {
        ...
        public void ImportLargeValueRaw()
        {
            using (var conn = OpenConnection())
            {
                ...
                using (var cmd = new EDBCommand("INSERT INTO data (blob) VALUES (@p)", conn))
                {
        ...
        public void ExportLongString()
        {
            ...
            using (var conn = OpenConnection())
            {
                ...
                using (var cmd = new EDBCommand("INSERT INTO data VALUES (@p, @p, @p, @p, @p)", conn))
                {
        ...
        public void CancelTextImport()
        {
            using (var conn = OpenConnection())
            {
                ...
                var writer = (EDBCopyTextWriter)conn.BeginTextImport("COPY data (field_text, field_int4) FROM STDIN");
